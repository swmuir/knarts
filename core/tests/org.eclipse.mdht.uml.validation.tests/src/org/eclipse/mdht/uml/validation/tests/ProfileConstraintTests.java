 ...
 *     
 *******************************************************************************/
package org.eclipse.mdht.uml.validation.tests;
...
public class ProfileConstraintTests {
	...
	public void loadTestModel() {
		testModel = UML2Util.load(
			rset,
			URI.createPlatformPluginURI("/org.eclipse.mdht.uml.validation.tests/models/TestModel.uml", true),
		...
		return new BaseMatcher<IStatus>() {
			...
			public boolean matches(Object item) {
				...
				if (result) {
					...
					result = "org.eclipse.mdht.uml.validation.tests".equals(desc.getPluginId()) &&
