 ...
 * @author NEHTA
 *
 * @see org.eclipse.mdht.uml.cda.ui.editors.MDHTPreferences
 *
 */
public class PdfPreferenceTester extends PropertyTester {
	...
	/*
	 * Plugin key is a soft reference to org.eclipse.mdht so as not to create
	 * cyclic dependencies.
	 */
	private static final String MDHT_PLUGIN_ID = "org.eclipse.mdht.uml.cda.ui";

	/* preference key from org.eclipse.mdht.uml.cda.ui.editors.MDHTPreferences */
