...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Overlaps</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.OverlapsImpl#getPrecision <em>Precision</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OverlapsImpl extends BinaryExpressionImpl implements Overlaps {
	/**
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getOverlaps();
	}
	...
	public void setPrecision(DateTimePrecision newPrecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.OVERLAPS__PRECISION, oldPrecision, precision, !oldPrecisionESet));
	}
	...
	public void unsetPrecision() {
		...
		precisionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R1Package.OVERLAPS__PRECISION, oldPrecision, PRECISION_EDEFAULT, oldPrecisionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.OVERLAPS__PRECISION:
				return getPrecision();
		}
