...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Same Or After</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.SameOrAfterImpl#getPrecision <em>Precision</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SameOrAfterImpl extends BinaryExpressionImpl implements SameOrAfter {
	/**
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getSameOrAfter();
	}
	...
	public void setPrecision(DateTimePrecision newPrecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.SAME_OR_AFTER__PRECISION, oldPrecision, precision, !oldPrecisionESet));
	}
	...
	public void unsetPrecision() {
		...
		precisionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R1Package.SAME_OR_AFTER__PRECISION, oldPrecision, PRECISION_EDEFAULT, oldPrecisionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.SAME_OR_AFTER__PRECISION:
				return getPrecision();
		}
