 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.BinaryExpressionImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BinaryExpressionImpl extends ExpressionImpl implements BinaryExpression {
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getBinaryExpression();
	}
	...
	public EList<Expression> getOperand() {
		if (operand == null) {
			operand = new EObjectContainmentEList<Expression>(Expression.class, this, R1Package.BINARY_EXPRESSION__OPERAND);
		}
		return operand;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.BINARY_EXPRESSION__OPERAND:
