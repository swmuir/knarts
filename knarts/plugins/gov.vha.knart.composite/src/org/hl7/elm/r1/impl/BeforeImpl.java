 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.BeforeImpl#getPrecision <em>Precision</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BeforeImpl extends BinaryExpressionImpl implements Before {
	/**
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getBefore();
	}
	...
	public void setPrecision(DateTimePrecision newPrecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.BEFORE__PRECISION, oldPrecision, precision, !oldPrecisionESet));
	}
	...
	public void unsetPrecision() {
		...
		precisionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R1Package.BEFORE__PRECISION, oldPrecision, PRECISION_EDEFAULT, oldPrecisionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.BEFORE__PRECISION:
				return getPrecision();
		}
