...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Date Time Component From</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.DateTimeComponentFromImpl#getPrecision <em>Precision</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateTimeComponentFromImpl extends UnaryExpressionImpl implements DateTimeComponentFrom {
	/**
	 ...
	 * @generated
	 */
	protected DateTimeComponentFromImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getDateTimeComponentFrom();
	}
	...
	public void setPrecision(DateTimePrecision newPrecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.DATE_TIME_COMPONENT_FROM__PRECISION, oldPrecision, precision, !oldPrecisionESet));
	}
	...
	public void unsetPrecision() {
		...
		precisionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R1Package.DATE_TIME_COMPONENT_FROM__PRECISION, oldPrecision, PRECISION_EDEFAULT, oldPrecisionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.DATE_TIME_COMPONENT_FROM__PRECISION:
				return getPrecision();
		}
