 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.NullImpl#getValueType <em>Value Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NullImpl extends ExpressionImpl implements Null {
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getNull();
	}
	...
	public void setValueType(QName newValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.NULL__VALUE_TYPE, oldValueType, valueType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.NULL__VALUE_TYPE:
				return getValueType();
		}
