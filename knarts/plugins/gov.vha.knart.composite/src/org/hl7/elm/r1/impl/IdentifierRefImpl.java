 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.IdentifierRefImpl#getLibraryName <em>Library Name</em>}</li>
 *   <li>{@link org.hl7.elm.r1.impl.IdentifierRefImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifierRefImpl extends ExpressionImpl implements IdentifierRef {
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getIdentifierRef();
	}
	...
	public void setLibraryName(String newLibraryName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.IDENTIFIER_REF__LIBRARY_NAME, oldLibraryName, libraryName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.IDENTIFIER_REF__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.IDENTIFIER_REF__LIBRARY_NAME:
				return getLibraryName();
			case R1Package.IDENTIFIER_REF__NAME:
				return getName();
		}
