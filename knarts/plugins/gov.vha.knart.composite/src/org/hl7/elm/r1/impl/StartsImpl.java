 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.StartsImpl#getPrecision <em>Precision</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StartsImpl extends BinaryExpressionImpl implements Starts {
	/**
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getStarts();
	}
	...
	public void setPrecision(DateTimePrecision newPrecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.STARTS__PRECISION, oldPrecision, precision, !oldPrecisionESet));
	}
	...
	public void unsetPrecision() {
		...
		precisionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R1Package.STARTS__PRECISION, oldPrecision, PRECISION_EDEFAULT, oldPrecisionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.STARTS__PRECISION:
				return getPrecision();
		}
