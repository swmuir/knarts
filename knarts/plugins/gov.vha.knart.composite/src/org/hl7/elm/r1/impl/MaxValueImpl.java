...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Max Value</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.MaxValueImpl#getValueType <em>Value Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MaxValueImpl extends ExpressionImpl implements MaxValue {
	/**
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getMaxValue();
	}
	...
	public void setValueType(QName newValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.MAX_VALUE__VALUE_TYPE, oldValueType, valueType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.MAX_VALUE__VALUE_TYPE:
				return getValueType();
		}
