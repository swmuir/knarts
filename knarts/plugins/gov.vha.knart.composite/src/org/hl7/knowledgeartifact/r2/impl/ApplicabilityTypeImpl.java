 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.ApplicabilityTypeImpl#getCoverage <em>Coverage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicabilityTypeImpl extends MinimalEObjectImpl.Container implements ApplicabilityType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getApplicabilityType();
	}
	...
	public EList<Coverage> getCoverage() {
		if (coverage == null) {
			coverage = new EObjectContainmentEList<Coverage>(Coverage.class, this, R2Package.APPLICABILITY_TYPE__COVERAGE);
		}
		return coverage;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.APPLICABILITY_TYPE__COVERAGE:
