 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.NameTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NameTypeImpl extends MinimalEObjectImpl.Container implements NameType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getNameType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.NAME_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R2Package.NAME_TYPE__VALUE:
				return getValue();
		}
