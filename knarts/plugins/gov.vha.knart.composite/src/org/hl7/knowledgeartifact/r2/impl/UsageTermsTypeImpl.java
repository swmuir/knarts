 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.UsageTermsTypeImpl#getRightsDeclaration <em>Rights Declaration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UsageTermsTypeImpl extends MinimalEObjectImpl.Container implements UsageTermsType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getUsageTermsType();
	}
	...
	public EList<RightsDeclaration> getRightsDeclaration() {
		if (rightsDeclaration == null) {
			rightsDeclaration = new EObjectContainmentEList<RightsDeclaration>(RightsDeclaration.class, this, R2Package.USAGE_TERMS_TYPE__RIGHTS_DECLARATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.USAGE_TERMS_TYPE__RIGHTS_DECLARATION:
