...
import org.hl7.knowledgeartifact.r2.EnumerationConstraint;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.EnumerationConstraintImpl#getItem <em>Item</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.EnumerationConstraintImpl#isStrictSelection <em>Strict Selection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationConstraintImpl extends RangeConstraintImpl implements EnumerationConstraint {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getEnumerationConstraint();
	}
	...
	public EList<EnumerationItem> getItem() {
		if (item == null) {
			item = new EObjectContainmentEList<EnumerationItem>(EnumerationItem.class, this, R2Package.ENUMERATION_CONSTRAINT__ITEM);
		}
		return item;
	}
	...
	public void setStrictSelection(boolean newStrictSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.ENUMERATION_CONSTRAINT__STRICT_SELECTION, oldStrictSelection, strictSelection, !oldStrictSelectionESet));
	}
	...
	public void unsetStrictSelection() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R2Package.ENUMERATION_CONSTRAINT__STRICT_SELECTION, oldStrictSelection, STRICT_SELECTION_EDEFAULT, oldStrictSelectionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.ENUMERATION_CONSTRAINT__ITEM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R2Package.ENUMERATION_CONSTRAINT__ITEM:
				return getItem();
			case R2Package.ENUMERATION_CONSTRAINT__STRICT_SELECTION:
