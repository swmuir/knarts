...
import org.hl7.knowledgeartifact.r2.RightsDeclaration;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.RightsDeclarationImpl#getAssertedRights <em>Asserted Rights</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.RightsDeclarationImpl#getRightsHolder <em>Rights Holder</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.RightsDeclarationImpl#getPermissions <em>Permissions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RightsDeclarationImpl extends MinimalEObjectImpl.Container implements RightsDeclaration {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getRightsDeclaration();
	}
	...
	public NotificationChain basicSetAssertedRights(ST newAssertedRights, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R2Package.RIGHTS_DECLARATION__ASSERTED_RIGHTS, oldAssertedRights, newAssertedRights);
	...
	public void setAssertedRights(ST newAssertedRights) {
		if (newAssertedRights != assertedRights) {
			...
			if (assertedRights != null)
				msgs = ((InternalEObject)assertedRights).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R2Package.RIGHTS_DECLARATION__ASSERTED_RIGHTS, null, msgs);
			if (newAssertedRights != null)
				msgs = ((InternalEObject)newAssertedRights).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R2Package.RIGHTS_DECLARATION__ASSERTED_RIGHTS, null, msgs);
			msgs = basicSetAssertedRights(newAssertedRights, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.RIGHTS_DECLARATION__ASSERTED_RIGHTS, newAssertedRights, newAssertedRights));
	}
	...
	public NotificationChain basicSetRightsHolder(Party newRightsHolder, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R2Package.RIGHTS_DECLARATION__RIGHTS_HOLDER, oldRightsHolder, newRightsHolder);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRightsHolder(Party newRightsHolder) {
		if (newRightsHolder != rightsHolder) {
			...
			if (rightsHolder != null)
				msgs = ((InternalEObject)rightsHolder).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R2Package.RIGHTS_DECLARATION__RIGHTS_HOLDER, null, msgs);
			if (newRightsHolder != null)
				msgs = ((InternalEObject)newRightsHolder).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R2Package.RIGHTS_DECLARATION__RIGHTS_HOLDER, null, msgs);
			msgs = basicSetRightsHolder(newRightsHolder, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.RIGHTS_DECLARATION__RIGHTS_HOLDER, newRightsHolder, newRightsHolder));
	}
	...
	public NotificationChain basicSetPermissions(PermissionsType newPermissions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R2Package.RIGHTS_DECLARATION__PERMISSIONS, oldPermissions, newPermissions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPermissions(PermissionsType newPermissions) {
		if (newPermissions != permissions) {
			NotificationChain msgs = null;
			if (permissions != null)
				msgs = ((InternalEObject)permissions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R2Package.RIGHTS_DECLARATION__PERMISSIONS, null, msgs);
			if (newPermissions != null)
				msgs = ((InternalEObject)newPermissions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R2Package.RIGHTS_DECLARATION__PERMISSIONS, null, msgs);
			msgs = basicSetPermissions(newPermissions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.RIGHTS_DECLARATION__PERMISSIONS, newPermissions, newPermissions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.RIGHTS_DECLARATION__ASSERTED_RIGHTS:
				return basicSetAssertedRights(null, msgs);
			case R2Package.RIGHTS_DECLARATION__RIGHTS_HOLDER:
				return basicSetRightsHolder(null, msgs);
			case R2Package.RIGHTS_DECLARATION__PERMISSIONS:
