...
import org.hl7.knowledgeartifact.r2.ArtifactStatusType;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.StatusTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatusTypeImpl extends MinimalEObjectImpl.Container implements StatusType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getStatusType();
	}
	...
	public void setValue(ArtifactStatusType newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.STATUS_TYPE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R2Package.STATUS_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R2Package.STATUS_TYPE__VALUE:
				return getValue();
		}
