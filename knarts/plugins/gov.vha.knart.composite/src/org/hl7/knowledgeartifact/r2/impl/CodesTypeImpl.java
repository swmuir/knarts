 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.CodesTypeImpl#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CodesTypeImpl extends MinimalEObjectImpl.Container implements CodesType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getCodesType();
	}
	...
	public EList<CD> getCode() {
		if (code == null) {
			code = new EObjectContainmentEList<CD>(CD.class, this, R2Package.CODES_TYPE__CODE);
		}
		return code;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.CODES_TYPE__CODE:
