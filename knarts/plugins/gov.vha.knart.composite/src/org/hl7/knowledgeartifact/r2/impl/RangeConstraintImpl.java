...
import org.hl7.knowledgeartifact.r2.ConstraintTypeType;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.RangeConstraintImpl#getConstraintType <em>Constraint Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RangeConstraintImpl extends MinimalEObjectImpl.Container implements RangeConstraint {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getRangeConstraint();
	}
	...
	public NotificationChain basicSetConstraintType(ConstraintTypeType newConstraintType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R2Package.RANGE_CONSTRAINT__CONSTRAINT_TYPE, oldConstraintType, newConstraintType);
	...
	public void setConstraintType(ConstraintTypeType newConstraintType) {
		if (newConstraintType != constraintType) {
			...
			if (constraintType != null)
				msgs = ((InternalEObject)constraintType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R2Package.RANGE_CONSTRAINT__CONSTRAINT_TYPE, null, msgs);
			if (newConstraintType != null)
				msgs = ((InternalEObject)newConstraintType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R2Package.RANGE_CONSTRAINT__CONSTRAINT_TYPE, null, msgs);
			msgs = basicSetConstraintType(newConstraintType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.RANGE_CONSTRAINT__CONSTRAINT_TYPE, newConstraintType, newConstraintType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.RANGE_CONSTRAINT__CONSTRAINT_TYPE:
