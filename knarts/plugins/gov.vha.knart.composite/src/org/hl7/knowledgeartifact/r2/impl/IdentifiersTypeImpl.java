 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.IdentifiersTypeImpl#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifiersTypeImpl extends MinimalEObjectImpl.Container implements IdentifiersType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getIdentifiersType();
	}
	...
	public EList<VersionedIdentifier> getIdentifier() {
		if (identifier == null) {
			identifier = new EObjectContainmentEList<VersionedIdentifier>(VersionedIdentifier.class, this, R2Package.IDENTIFIERS_TYPE__IDENTIFIER);
		}
		return identifier;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.IDENTIFIERS_TYPE__IDENTIFIER:
