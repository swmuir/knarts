 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.AddressesTypeImpl#getAddress <em>Address</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddressesTypeImpl extends MinimalEObjectImpl.Container implements AddressesType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getAddressesType();
	}
	...
	public EList<AD> getAddress() {
		if (address == null) {
			address = new EObjectContainmentEList<AD>(AD.class, this, R2Package.ADDRESSES_TYPE__ADDRESS);
		}
		return address;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.ADDRESSES_TYPE__ADDRESS:
