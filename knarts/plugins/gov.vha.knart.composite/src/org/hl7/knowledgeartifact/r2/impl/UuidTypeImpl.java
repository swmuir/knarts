 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.UuidTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UuidTypeImpl extends MinimalEObjectImpl.Container implements UuidType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getUuidType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.UUID_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R2Package.UUID_TYPE__VALUE:
				return getValue();
		}
