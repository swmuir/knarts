 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.RelatedResourcesTypeImpl#getRelatedResource <em>Related Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelatedResourcesTypeImpl extends MinimalEObjectImpl.Container implements RelatedResourcesType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getRelatedResourcesType();
	}
	...
	public EList<ResourceRelationshipReference> getRelatedResource() {
		if (relatedResource == null) {
			relatedResource = new EObjectContainmentEList<ResourceRelationshipReference>(ResourceRelationshipReference.class, this, R2Package.RELATED_RESOURCES_TYPE__RELATED_RESOURCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.RELATED_RESOURCES_TYPE__RELATED_RESOURCE:
