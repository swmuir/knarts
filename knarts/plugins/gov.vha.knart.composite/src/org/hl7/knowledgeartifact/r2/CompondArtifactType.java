...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Compond Artifact Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.knowledgeartifact.r2.R2Package#getCompondArtifactType()
 * @model extendedMetaData="name='CompondArtifactType'"
 * @generated
 */
public enum CompondArtifactType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Compond Artifact Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CompondArtifactType[] VALUES_ARRAY =
		new CompondArtifactType[] {
			RULE,
			ORDER_SET,
	...
	/**
	 * A public read-only list of all the '<em><b>Compond Artifact Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CompondArtifactType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Compond Artifact Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CompondArtifactType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CompondArtifactType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Compond Artifact Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static CompondArtifactType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CompondArtifactType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Compond Artifact Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CompondArtifactType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private CompondArtifactType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
