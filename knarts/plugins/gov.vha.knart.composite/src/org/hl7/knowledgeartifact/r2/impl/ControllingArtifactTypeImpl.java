...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Controlling Artifact Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.ControllingArtifactTypeImpl#getBindingName <em>Binding Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControllingArtifactTypeImpl extends MinimalEObjectImpl.Container implements ControllingArtifactType {
	/**
	 ...
	 * @generated
	 */
	protected ControllingArtifactTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getControllingArtifactType();
	}
	...
	public void setBindingName(String newBindingName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.CONTROLLING_ARTIFACT_TYPE__BINDING_NAME, oldBindingName, bindingName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R2Package.CONTROLLING_ARTIFACT_TYPE__BINDING_NAME:
