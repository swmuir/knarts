 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.DataModelsTypeImpl#getModelReference <em>Model Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataModelsTypeImpl extends MinimalEObjectImpl.Container implements DataModelsType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getDataModelsType();
	}
	...
	public EList<ModelReference> getModelReference() {
		if (modelReference == null) {
			modelReference = new EObjectContainmentEList<ModelReference>(ModelReference.class, this, R2Package.DATA_MODELS_TYPE__MODEL_REFERENCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.DATA_MODELS_TYPE__MODEL_REFERENCE:
