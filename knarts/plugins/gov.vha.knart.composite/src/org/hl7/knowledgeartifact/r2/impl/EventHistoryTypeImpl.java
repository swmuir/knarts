 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.EventHistoryTypeImpl#getArtifactLifeCycleEvent <em>Artifact Life Cycle Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventHistoryTypeImpl extends MinimalEObjectImpl.Container implements EventHistoryType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getEventHistoryType();
	}
	...
	public EList<ArtifactLifeCycleEvent> getArtifactLifeCycleEvent() {
		if (artifactLifeCycleEvent == null) {
			artifactLifeCycleEvent = new EObjectContainmentEList<ArtifactLifeCycleEvent>(ArtifactLifeCycleEvent.class, this, R2Package.EVENT_HISTORY_TYPE__ARTIFACT_LIFE_CYCLE_EVENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.EVENT_HISTORY_TYPE__ARTIFACT_LIFE_CYCLE_EVENT:
