 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.UrlTypeImpl#getAddress <em>Address</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UrlTypeImpl extends MinimalEObjectImpl.Container implements UrlType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getUrlType();
	}
	...
	public void setAddress(String newAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.URL_TYPE__ADDRESS, oldAddress, address));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R2Package.URL_TYPE__ADDRESS:
				return getAddress();
		}
