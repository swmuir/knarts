 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.ResponseBindingImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.ResponseBindingImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponseBindingImpl extends MinimalEObjectImpl.Container implements ResponseBinding {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getResponseBinding();
	}
	...
	public void setContainer(String newContainer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.RESPONSE_BINDING__CONTAINER, oldContainer, container, !oldContainerESet));
	}
	...
	public void unsetContainer() {
		...
		containerESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R2Package.RESPONSE_BINDING__CONTAINER, oldContainer, CONTAINER_EDEFAULT, oldContainerESet));
	}
	...
	public void setProperty(String newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.RESPONSE_BINDING__PROPERTY, oldProperty, property));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R2Package.RESPONSE_BINDING__CONTAINER:
				return getContainer();
			case R2Package.RESPONSE_BINDING__PROPERTY:
				return getProperty();
		}
