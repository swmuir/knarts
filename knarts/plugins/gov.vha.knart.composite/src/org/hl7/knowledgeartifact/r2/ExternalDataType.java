 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.ExternalDataType#getCodesystem <em>Codesystem</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r2.ExternalDataType#getValueset <em>Valueset</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r2.ExternalDataType#getParameter <em>Parameter</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r2.ExternalDataType#getDef <em>Def</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r2.ExternalDataType#getTrigger <em>Trigger</em>}</li>
 * </ul>
 *
 * @see org.hl7.knowledgeartifact.r2.R2Package#getExternalDataType()
...
public interface ExternalDataType extends EObject {
	 ...
	 * @see org.hl7.knowledgeartifact.r2.R2Package#getExternalDataType_Codesystem()
	 ...
	 * @see org.hl7.knowledgeartifact.r2.R2Package#getExternalDataType_Valueset()
	 * @model containment="true"
	 ...
	 * @see org.hl7.knowledgeartifact.r2.R2Package#getExternalDataType_Parameter()
	 * @model containment="true"
	 ...
	 * @see org.hl7.knowledgeartifact.r2.R2Package#getExternalDataType_Def()
	 * @model containment="true"
	 ...
	 * @see org.hl7.knowledgeartifact.r2.R2Package#getExternalDataType_Trigger()
	 * @model containment="true"
