...
import org.hl7.knowledgeartifact.r2.UpdateAction;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.UpdateActionImpl#getActionSentence <em>Action Sentence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateActionImpl extends AtomicActionImpl implements UpdateAction {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getUpdateAction();
	}
	...
	public NotificationChain basicSetActionSentence(Expression newActionSentence, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R2Package.UPDATE_ACTION__ACTION_SENTENCE, oldActionSentence, newActionSentence);
	...
	public void setActionSentence(Expression newActionSentence) {
		if (newActionSentence != actionSentence) {
			...
			if (actionSentence != null)
				msgs = ((InternalEObject)actionSentence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R2Package.UPDATE_ACTION__ACTION_SENTENCE, null, msgs);
			if (newActionSentence != null)
				msgs = ((InternalEObject)newActionSentence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R2Package.UPDATE_ACTION__ACTION_SENTENCE, null, msgs);
			msgs = basicSetActionSentence(newActionSentence, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.UPDATE_ACTION__ACTION_SENTENCE, newActionSentence, newActionSentence));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.UPDATE_ACTION__ACTION_SENTENCE:
