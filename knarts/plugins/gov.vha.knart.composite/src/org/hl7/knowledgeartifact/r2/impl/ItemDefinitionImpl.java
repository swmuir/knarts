...
import org.hl7.knowledgeartifact.r2.ItemDefinition;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.ItemDefinitionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.ItemDefinitionImpl#getScopedIdentifier <em>Scoped Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ItemDefinitionImpl extends MinimalEObjectImpl.Container implements ItemDefinition {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getItemDefinition();
	}
	...
	public NotificationChain basicSetIdentifier(VersionedIdentifier newIdentifier, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R2Package.ITEM_DEFINITION__IDENTIFIER, oldIdentifier, newIdentifier);
	...
	public void setIdentifier(VersionedIdentifier newIdentifier) {
		if (newIdentifier != identifier) {
			...
			if (identifier != null)
				msgs = ((InternalEObject)identifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R2Package.ITEM_DEFINITION__IDENTIFIER, null, msgs);
			if (newIdentifier != null)
				msgs = ((InternalEObject)newIdentifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R2Package.ITEM_DEFINITION__IDENTIFIER, null, msgs);
			msgs = basicSetIdentifier(newIdentifier, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.ITEM_DEFINITION__IDENTIFIER, newIdentifier, newIdentifier));
	}
	...
	public NotificationChain basicSetScopedIdentifier(VersionedIdentifier newScopedIdentifier, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R2Package.ITEM_DEFINITION__SCOPED_IDENTIFIER, oldScopedIdentifier, newScopedIdentifier);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setScopedIdentifier(VersionedIdentifier newScopedIdentifier) {
		if (newScopedIdentifier != scopedIdentifier) {
			...
			if (scopedIdentifier != null)
				msgs = ((InternalEObject)scopedIdentifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R2Package.ITEM_DEFINITION__SCOPED_IDENTIFIER, null, msgs);
			if (newScopedIdentifier != null)
				msgs = ((InternalEObject)newScopedIdentifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R2Package.ITEM_DEFINITION__SCOPED_IDENTIFIER, null, msgs);
			msgs = basicSetScopedIdentifier(newScopedIdentifier, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R2Package.ITEM_DEFINITION__SCOPED_IDENTIFIER, newScopedIdentifier, newScopedIdentifier));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.ITEM_DEFINITION__IDENTIFIER:
				return basicSetIdentifier(null, msgs);
			case R2Package.ITEM_DEFINITION__SCOPED_IDENTIFIER:
