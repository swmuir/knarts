 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.ContactsTypeImpl#getContact <em>Contact</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContactsTypeImpl extends MinimalEObjectImpl.Container implements ContactsType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getContactsType();
	}
	...
	public EList<TEL> getContact() {
		if (contact == null) {
			contact = new EObjectContainmentEList<TEL>(TEL.class, this, R2Package.CONTACTS_TYPE__CONTACT);
		}
		return contact;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.CONTACTS_TYPE__CONTACT:
