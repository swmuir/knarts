 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r2.impl.ItemCodesTypeImpl#getItemCode <em>Item Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ItemCodesTypeImpl extends MinimalEObjectImpl.Container implements ItemCodesType {
	...
	protected EClass eStaticClass() {
		return R2Package.eINSTANCE.getItemCodesType();
	}
	...
	public EList<CD> getItemCode() {
		if (itemCode == null) {
			itemCode = new EObjectContainmentEList<CD>(CD.class, this, R2Package.ITEM_CODES_TYPE__ITEM_CODE);
		}
		return itemCode;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R2Package.ITEM_CODES_TYPE__ITEM_CODE:
