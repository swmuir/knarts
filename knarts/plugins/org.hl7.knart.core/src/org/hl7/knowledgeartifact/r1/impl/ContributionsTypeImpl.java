 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ContributionsTypeImpl#getContribution <em>Contribution</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContributionsTypeImpl extends MinimalEObjectImpl.Container implements ContributionsType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.CONTRIBUTIONS_TYPE;
	}
	...
	public EList<Contribution> getContribution() {
		if (contribution == null) {
			contribution = new EObjectContainmentEList<Contribution>(Contribution.class, this, R1Package.CONTRIBUTIONS_TYPE__CONTRIBUTION);
		}
		return contribution;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.CONTRIBUTIONS_TYPE__CONTRIBUTION:
