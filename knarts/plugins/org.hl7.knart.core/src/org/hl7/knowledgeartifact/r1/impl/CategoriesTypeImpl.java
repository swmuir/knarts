 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.CategoriesTypeImpl#getCategory <em>Category</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoriesTypeImpl extends MinimalEObjectImpl.Container implements CategoriesType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.CATEGORIES_TYPE;
	}
	...
	public EList<CD> getCategory() {
		if (category == null) {
			category = new EObjectContainmentEList<CD>(CD.class, this, R1Package.CATEGORIES_TYPE__CATEGORY);
		}
		return category;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.CATEGORIES_TYPE__CATEGORY:
