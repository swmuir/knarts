 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.MaskConstraintImpl#getMaskExpression <em>Mask Expression</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.MaskConstraintImpl#getMaskHelp <em>Mask Help</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MaskConstraintImpl extends RangeConstraintImpl implements MaskConstraint {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.MASK_CONSTRAINT;
	}
	...
	public NotificationChain basicSetMaskExpression(ST newMaskExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.MASK_CONSTRAINT__MASK_EXPRESSION, oldMaskExpression, newMaskExpression);
	...
	public void setMaskExpression(ST newMaskExpression) {
		if (newMaskExpression != maskExpression) {
			...
			if (maskExpression != null)
				msgs = ((InternalEObject)maskExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.MASK_CONSTRAINT__MASK_EXPRESSION, null, msgs);
			if (newMaskExpression != null)
				msgs = ((InternalEObject)newMaskExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.MASK_CONSTRAINT__MASK_EXPRESSION, null, msgs);
			msgs = basicSetMaskExpression(newMaskExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.MASK_CONSTRAINT__MASK_EXPRESSION, newMaskExpression, newMaskExpression));
	}
	...
	public NotificationChain basicSetMaskHelp(ST newMaskHelp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.MASK_CONSTRAINT__MASK_HELP, oldMaskHelp, newMaskHelp);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMaskHelp(ST newMaskHelp) {
		if (newMaskHelp != maskHelp) {
			NotificationChain msgs = null;
			if (maskHelp != null)
				msgs = ((InternalEObject)maskHelp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.MASK_CONSTRAINT__MASK_HELP, null, msgs);
			if (newMaskHelp != null)
				msgs = ((InternalEObject)newMaskHelp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.MASK_CONSTRAINT__MASK_HELP, null, msgs);
			msgs = basicSetMaskHelp(newMaskHelp, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.MASK_CONSTRAINT__MASK_HELP, newMaskHelp, newMaskHelp));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.MASK_CONSTRAINT__MASK_EXPRESSION:
				return basicSetMaskExpression(null, msgs);
			case R1Package.MASK_CONSTRAINT__MASK_HELP:
