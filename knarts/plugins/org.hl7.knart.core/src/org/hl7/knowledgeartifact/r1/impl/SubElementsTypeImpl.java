 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.SubElementsTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.SubElementsTypeImpl#getSimpleAction <em>Simple Action</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.SubElementsTypeImpl#getActionGroup <em>Action Group</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.SubElementsTypeImpl#getActionRef <em>Action Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubElementsTypeImpl extends MinimalEObjectImpl.Container implements SubElementsType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.SUB_ELEMENTS_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, R1Package.SUB_ELEMENTS_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<AtomicAction> getSimpleAction() {
		return getGroup().list(R1Package.Literals.SUB_ELEMENTS_TYPE__SIMPLE_ACTION);
	}
	...
	public EList<ActionGroup> getActionGroup() {
		return getGroup().list(R1Package.Literals.SUB_ELEMENTS_TYPE__ACTION_GROUP);
	}
	...
	public EList<ActionRef> getActionRef() {
		return getGroup().list(R1Package.Literals.SUB_ELEMENTS_TYPE__ACTION_REF);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.SUB_ELEMENTS_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case R1Package.SUB_ELEMENTS_TYPE__SIMPLE_ACTION:
				return ((InternalEList<?>)getSimpleAction()).basicRemove(otherEnd, msgs);
			case R1Package.SUB_ELEMENTS_TYPE__ACTION_GROUP:
				return ((InternalEList<?>)getActionGroup()).basicRemove(otherEnd, msgs);
			case R1Package.SUB_ELEMENTS_TYPE__ACTION_REF:
