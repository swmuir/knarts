 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ExternalDataTypeImpl#getCodesystem <em>Codesystem</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ExternalDataTypeImpl#getValueset <em>Valueset</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ExternalDataTypeImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ExternalDataTypeImpl#getDef <em>Def</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ExternalDataTypeImpl#getTrigger <em>Trigger</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalDataTypeImpl extends MinimalEObjectImpl.Container implements ExternalDataType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.EXTERNAL_DATA_TYPE;
	}
	...
	public EList<CodeSystemDef> getCodesystem() {
		if (codesystem == null) {
			codesystem = new EObjectContainmentEList<CodeSystemDef>(CodeSystemDef.class, this, R1Package.EXTERNAL_DATA_TYPE__CODESYSTEM);
		}
		return codesystem;
	}
	...
	public EList<ValueSetDef> getValueset() {
		if (valueset == null) {
			valueset = new EObjectContainmentEList<ValueSetDef>(ValueSetDef.class, this, R1Package.EXTERNAL_DATA_TYPE__VALUESET);
		}
		return valueset;
	}
	...
	public EList<ParameterDef> getParameter() {
		if (parameter == null) {
			parameter = new EObjectContainmentEList<ParameterDef>(ParameterDef.class, this, R1Package.EXTERNAL_DATA_TYPE__PARAMETER);
		}
		return parameter;
	}
	...
	public EList<ExpressionDef> getDef() {
		if (def == null) {
			def = new EObjectContainmentEList<ExpressionDef>(ExpressionDef.class, this, R1Package.EXTERNAL_DATA_TYPE__DEF);
		}
		return def;
	}
	...
	public EList<Trigger> getTrigger() {
		if (trigger == null) {
			trigger = new EObjectContainmentEList<Trigger>(Trigger.class, this, R1Package.EXTERNAL_DATA_TYPE__TRIGGER);
		}
		return trigger;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.EXTERNAL_DATA_TYPE__CODESYSTEM:
				return ((InternalEList<?>)getCodesystem()).basicRemove(otherEnd, msgs);
			case R1Package.EXTERNAL_DATA_TYPE__VALUESET:
				return ((InternalEList<?>)getValueset()).basicRemove(otherEnd, msgs);
			case R1Package.EXTERNAL_DATA_TYPE__PARAMETER:
				return ((InternalEList<?>)getParameter()).basicRemove(otherEnd, msgs);
			case R1Package.EXTERNAL_DATA_TYPE__DEF:
				return ((InternalEList<?>)getDef()).basicRemove(otherEnd, msgs);
			case R1Package.EXTERNAL_DATA_TYPE__TRIGGER:
