 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ConditionImpl#getLogic <em>Logic</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ConditionImpl#getConditionRole <em>Condition Role</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionImpl extends MinimalEObjectImpl.Container implements Condition {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.CONDITION;
	}
	...
	public NotificationChain basicSetLogic(Expression newLogic, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.CONDITION__LOGIC, oldLogic, newLogic);
	...
	public void setLogic(Expression newLogic) {
		if (newLogic != logic) {
			...
			if (logic != null)
				msgs = ((InternalEObject)logic).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.CONDITION__LOGIC, null, msgs);
			if (newLogic != null)
				msgs = ((InternalEObject)newLogic).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.CONDITION__LOGIC, null, msgs);
			msgs = basicSetLogic(newLogic, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.CONDITION__LOGIC, newLogic, newLogic));
	}
	...
	public NotificationChain basicSetConditionRole(ConditionRoleType1 newConditionRole, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.CONDITION__CONDITION_ROLE, oldConditionRole, newConditionRole);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConditionRole(ConditionRoleType1 newConditionRole) {
		if (newConditionRole != conditionRole) {
			...
			if (conditionRole != null)
				msgs = ((InternalEObject)conditionRole).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.CONDITION__CONDITION_ROLE, null, msgs);
			if (newConditionRole != null)
				msgs = ((InternalEObject)newConditionRole).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.CONDITION__CONDITION_ROLE, null, msgs);
			msgs = basicSetConditionRole(newConditionRole, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.CONDITION__CONDITION_ROLE, newConditionRole, newConditionRole));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.CONDITION__LOGIC:
				return basicSetLogic(null, msgs);
			case R1Package.CONDITION__CONDITION_ROLE:
