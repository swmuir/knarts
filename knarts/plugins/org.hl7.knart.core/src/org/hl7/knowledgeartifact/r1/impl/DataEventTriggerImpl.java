 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.DataEventTriggerImpl#getTriggerType <em>Trigger Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataEventTriggerImpl extends TriggerImpl implements DataEventTrigger {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.DATA_EVENT_TRIGGER;
	}
	...
	public void setTriggerType(DataEventType newTriggerType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.DATA_EVENT_TRIGGER__TRIGGER_TYPE, oldTriggerType, triggerType, !oldTriggerTypeESet));
	}
	...
	public void unsetTriggerType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R1Package.DATA_EVENT_TRIGGER__TRIGGER_TYPE, oldTriggerType, TRIGGER_TYPE_EDEFAULT, oldTriggerTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.DATA_EVENT_TRIGGER__TRIGGER_TYPE:
