 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ExpressionsTypeImpl#getDef <em>Def</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionsTypeImpl extends MinimalEObjectImpl.Container implements ExpressionsType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.EXPRESSIONS_TYPE;
	}
	...
	public EList<ExpressionDef> getDef() {
		if (def == null) {
			def = new EObjectContainmentEList<ExpressionDef>(ExpressionDef.class, this, R1Package.EXPRESSIONS_TYPE__DEF);
		}
		return def;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.EXPRESSIONS_TYPE__DEF:
