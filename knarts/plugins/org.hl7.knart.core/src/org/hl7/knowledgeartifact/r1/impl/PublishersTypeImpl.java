 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.PublishersTypeImpl#getPublisher <em>Publisher</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PublishersTypeImpl extends MinimalEObjectImpl.Container implements PublishersType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.PUBLISHERS_TYPE;
	}
	...
	public EList<Party> getPublisher() {
		if (publisher == null) {
			publisher = new EObjectContainmentEList<Party>(Party.class, this, R1Package.PUBLISHERS_TYPE__PUBLISHER);
		}
		return publisher;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.PUBLISHERS_TYPE__PUBLISHER:
