 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.EvidenceImpl#getQualityOfEvidence <em>Quality Of Evidence</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.EvidenceImpl#getStrengthOfRecommendation <em>Strength Of Recommendation</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.EvidenceImpl#getResources <em>Resources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvidenceImpl extends MinimalEObjectImpl.Container implements Evidence {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.EVIDENCE;
	}
	...
	public NotificationChain basicSetQualityOfEvidence(CD newQualityOfEvidence, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.EVIDENCE__QUALITY_OF_EVIDENCE, oldQualityOfEvidence, newQualityOfEvidence);
	...
	public void setQualityOfEvidence(CD newQualityOfEvidence) {
		if (newQualityOfEvidence != qualityOfEvidence) {
			...
			if (qualityOfEvidence != null)
				msgs = ((InternalEObject)qualityOfEvidence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.EVIDENCE__QUALITY_OF_EVIDENCE, null, msgs);
			if (newQualityOfEvidence != null)
				msgs = ((InternalEObject)newQualityOfEvidence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.EVIDENCE__QUALITY_OF_EVIDENCE, null, msgs);
			msgs = basicSetQualityOfEvidence(newQualityOfEvidence, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.EVIDENCE__QUALITY_OF_EVIDENCE, newQualityOfEvidence, newQualityOfEvidence));
	}
	...
	public NotificationChain basicSetStrengthOfRecommendation(CD newStrengthOfRecommendation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.EVIDENCE__STRENGTH_OF_RECOMMENDATION, oldStrengthOfRecommendation, newStrengthOfRecommendation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStrengthOfRecommendation(CD newStrengthOfRecommendation) {
		if (newStrengthOfRecommendation != strengthOfRecommendation) {
			...
			if (strengthOfRecommendation != null)
				msgs = ((InternalEObject)strengthOfRecommendation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.EVIDENCE__STRENGTH_OF_RECOMMENDATION, null, msgs);
			if (newStrengthOfRecommendation != null)
				msgs = ((InternalEObject)newStrengthOfRecommendation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.EVIDENCE__STRENGTH_OF_RECOMMENDATION, null, msgs);
			msgs = basicSetStrengthOfRecommendation(newStrengthOfRecommendation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.EVIDENCE__STRENGTH_OF_RECOMMENDATION, newStrengthOfRecommendation, newStrengthOfRecommendation));
	}
	...
	public NotificationChain basicSetResources(SupportingResource newResources, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.EVIDENCE__RESOURCES, oldResources, newResources);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setResources(SupportingResource newResources) {
		if (newResources != resources) {
			NotificationChain msgs = null;
			if (resources != null)
				msgs = ((InternalEObject)resources).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.EVIDENCE__RESOURCES, null, msgs);
			if (newResources != null)
				msgs = ((InternalEObject)newResources).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.EVIDENCE__RESOURCES, null, msgs);
			msgs = basicSetResources(newResources, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.EVIDENCE__RESOURCES, newResources, newResources));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.EVIDENCE__QUALITY_OF_EVIDENCE:
				return basicSetQualityOfEvidence(null, msgs);
			case R1Package.EVIDENCE__STRENGTH_OF_RECOMMENDATION:
				return basicSetStrengthOfRecommendation(null, msgs);
			case R1Package.EVIDENCE__RESOURCES:
