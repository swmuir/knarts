 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.RepresentedConceptsTypeImpl#getConcept <em>Concept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RepresentedConceptsTypeImpl extends MinimalEObjectImpl.Container implements RepresentedConceptsType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.REPRESENTED_CONCEPTS_TYPE;
	}
	...
	public EList<CD> getConcept() {
		if (concept == null) {
			concept = new EObjectContainmentEList<CD>(CD.class, this, R1Package.REPRESENTED_CONCEPTS_TYPE__CONCEPT);
		}
		return concept;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.REPRESENTED_CONCEPTS_TYPE__CONCEPT:
