 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.TemplateIdsType1Impl#getTemplateId <em>Template Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TemplateIdsType1Impl extends MinimalEObjectImpl.Container implements TemplateIdsType1 {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.TEMPLATE_IDS_TYPE1;
	}
	...
	public EList<VersionedIdentifier> getTemplateId() {
		if (templateId == null) {
			templateId = new EObjectContainmentEList<VersionedIdentifier>(VersionedIdentifier.class, this, R1Package.TEMPLATE_IDS_TYPE1__TEMPLATE_ID);
		}
		return templateId;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.TEMPLATE_IDS_TYPE1__TEMPLATE_ID:
