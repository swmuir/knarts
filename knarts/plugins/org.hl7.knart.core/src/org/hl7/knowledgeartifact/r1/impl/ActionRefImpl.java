 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ActionRefImpl#getLibraryName <em>Library Name</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ActionRefImpl#getReferencedActionId <em>Referenced Action Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionRefImpl extends ActionBaseImpl implements ActionRef {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.ACTION_REF;
	}
	...
	public void setLibraryName(String newLibraryName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.ACTION_REF__LIBRARY_NAME, oldLibraryName, libraryName));
	}
	...
	public void setReferencedActionId(String newReferencedActionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.ACTION_REF__REFERENCED_ACTION_ID, oldReferencedActionId, referencedActionId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.ACTION_REF__LIBRARY_NAME:
				return getLibraryName();
			case R1Package.ACTION_REF__REFERENCED_ACTION_ID:
