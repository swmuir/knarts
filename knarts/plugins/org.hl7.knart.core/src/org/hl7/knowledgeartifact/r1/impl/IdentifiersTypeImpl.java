 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.IdentifiersTypeImpl#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifiersTypeImpl extends MinimalEObjectImpl.Container implements IdentifiersType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.IDENTIFIERS_TYPE;
	}
	...
	public EList<VersionedIdentifier> getIdentifier() {
		if (identifier == null) {
			identifier = new EObjectContainmentEList<VersionedIdentifier>(VersionedIdentifier.class, this, R1Package.IDENTIFIERS_TYPE__IDENTIFIER);
		}
		return identifier;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.IDENTIFIERS_TYPE__IDENTIFIER:
