 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.LibrariesTypeImpl#getLibraryReference <em>Library Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LibrariesTypeImpl extends MinimalEObjectImpl.Container implements LibrariesType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.LIBRARIES_TYPE;
	}
	...
	public EList<LibraryReference> getLibraryReference() {
		if (libraryReference == null) {
			libraryReference = new EObjectContainmentEList<LibraryReference>(LibraryReference.class, this, R1Package.LIBRARIES_TYPE__LIBRARY_REFERENCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.LIBRARIES_TYPE__LIBRARY_REFERENCE:
