 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.NamedEventTriggerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedEventTriggerImpl extends TriggerImpl implements NamedEventTrigger {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.NAMED_EVENT_TRIGGER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.NAMED_EVENT_TRIGGER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.NAMED_EVENT_TRIGGER__NAME:
				return getName();
		}
