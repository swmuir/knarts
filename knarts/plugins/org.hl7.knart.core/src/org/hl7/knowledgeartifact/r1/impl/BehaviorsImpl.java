 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.BehaviorsImpl#getBehavior <em>Behavior</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorsImpl extends MinimalEObjectImpl.Container implements Behaviors {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.BEHAVIORS;
	}
	...
	public EList<Behavior> getBehavior() {
		if (behavior == null) {
			behavior = new EObjectContainmentEList<Behavior>(Behavior.class, this, R1Package.BEHAVIORS__BEHAVIOR);
		}
		return behavior;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.BEHAVIORS__BEHAVIOR:
