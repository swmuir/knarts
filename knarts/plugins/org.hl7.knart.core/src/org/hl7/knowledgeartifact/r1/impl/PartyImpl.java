 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.PartyImpl#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.PartyImpl#getContacts <em>Contacts</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PartyImpl extends MinimalEObjectImpl.Container implements Party {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.PARTY;
	}
	...
	public NotificationChain basicSetAddresses(AddressesType newAddresses, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.PARTY__ADDRESSES, oldAddresses, newAddresses);
	...
	public void setAddresses(AddressesType newAddresses) {
		if (newAddresses != addresses) {
			...
			if (addresses != null)
				msgs = ((InternalEObject)addresses).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.PARTY__ADDRESSES, null, msgs);
			if (newAddresses != null)
				msgs = ((InternalEObject)newAddresses).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.PARTY__ADDRESSES, null, msgs);
			msgs = basicSetAddresses(newAddresses, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.PARTY__ADDRESSES, newAddresses, newAddresses));
	}
	...
	public NotificationChain basicSetContacts(ContactsType newContacts, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.PARTY__CONTACTS, oldContacts, newContacts);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContacts(ContactsType newContacts) {
		if (newContacts != contacts) {
			NotificationChain msgs = null;
			if (contacts != null)
				msgs = ((InternalEObject)contacts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.PARTY__CONTACTS, null, msgs);
			if (newContacts != null)
				msgs = ((InternalEObject)newContacts).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.PARTY__CONTACTS, null, msgs);
			msgs = basicSetContacts(newContacts, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.PARTY__CONTACTS, newContacts, newContacts));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.PARTY__ADDRESSES:
				return basicSetAddresses(null, msgs);
			case R1Package.PARTY__CONTACTS:
