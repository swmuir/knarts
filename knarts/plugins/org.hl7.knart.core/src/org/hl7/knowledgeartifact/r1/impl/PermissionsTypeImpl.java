 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.PermissionsTypeImpl#getPermissions <em>Permissions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PermissionsTypeImpl extends MinimalEObjectImpl.Container implements PermissionsType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.PERMISSIONS_TYPE;
	}
	...
	public EList<ST> getPermissions() {
		if (permissions == null) {
			permissions = new EObjectContainmentEList<ST>(ST.class, this, R1Package.PERMISSIONS_TYPE__PERMISSIONS);
		}
		return permissions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.PERMISSIONS_TYPE__PERMISSIONS:
