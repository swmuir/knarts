 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.LookupConstraintImpl#getItems <em>Items</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.LookupConstraintImpl#getDisplayField <em>Display Field</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.LookupConstraintImpl#isStrictSelection <em>Strict Selection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LookupConstraintImpl extends RangeConstraintImpl implements LookupConstraint {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.LOOKUP_CONSTRAINT;
	}
	...
	public NotificationChain basicSetItems(Expression newItems, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.LOOKUP_CONSTRAINT__ITEMS, oldItems, newItems);
	...
	public void setItems(Expression newItems) {
		if (newItems != items) {
			...
			if (items != null)
				msgs = ((InternalEObject)items).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.LOOKUP_CONSTRAINT__ITEMS, null, msgs);
			if (newItems != null)
				msgs = ((InternalEObject)newItems).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.LOOKUP_CONSTRAINT__ITEMS, null, msgs);
			msgs = basicSetItems(newItems, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.LOOKUP_CONSTRAINT__ITEMS, newItems, newItems));
	}
	...
	public void setDisplayField(String newDisplayField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.LOOKUP_CONSTRAINT__DISPLAY_FIELD, oldDisplayField, displayField));
	}
	...
	public void setStrictSelection(boolean newStrictSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.LOOKUP_CONSTRAINT__STRICT_SELECTION, oldStrictSelection, strictSelection, !oldStrictSelectionESet));
	}
	...
	public void unsetStrictSelection() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R1Package.LOOKUP_CONSTRAINT__STRICT_SELECTION, oldStrictSelection, STRICT_SELECTION_EDEFAULT, oldStrictSelectionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.LOOKUP_CONSTRAINT__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.LOOKUP_CONSTRAINT__ITEMS:
				return getItems();
			case R1Package.LOOKUP_CONSTRAINT__DISPLAY_FIELD:
				return getDisplayField();
			case R1Package.LOOKUP_CONSTRAINT__STRICT_SELECTION:
