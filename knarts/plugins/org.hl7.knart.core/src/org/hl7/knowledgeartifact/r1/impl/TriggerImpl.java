 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.TriggerImpl#getDef <em>Def</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.TriggerImpl#getIdentifiers <em>Identifiers</em>}</li>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.TriggerImpl#getTextEquivalent <em>Text Equivalent</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TriggerImpl extends MinimalEObjectImpl.Container implements Trigger {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.TRIGGER;
	}
	...
	public NotificationChain basicSetDef(ExpressionDef newDef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.TRIGGER__DEF, oldDef, newDef);
	...
	public void setDef(ExpressionDef newDef) {
		if (newDef != def) {
			...
			if (def != null)
				msgs = ((InternalEObject)def).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.TRIGGER__DEF, null, msgs);
			if (newDef != null)
				msgs = ((InternalEObject)newDef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.TRIGGER__DEF, null, msgs);
			msgs = basicSetDef(newDef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.TRIGGER__DEF, newDef, newDef));
	}
	...
	public EList<VersionedIdentifier> getIdentifiers() {
		if (identifiers == null) {
			identifiers = new EObjectContainmentEList<VersionedIdentifier>(VersionedIdentifier.class, this, R1Package.TRIGGER__IDENTIFIERS);
		}
		return identifiers;
	}
	...
	public NotificationChain basicSetTextEquivalent(EObject newTextEquivalent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R1Package.TRIGGER__TEXT_EQUIVALENT, oldTextEquivalent, newTextEquivalent);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTextEquivalent(EObject newTextEquivalent) {
		if (newTextEquivalent != textEquivalent) {
			...
			if (textEquivalent != null)
				msgs = ((InternalEObject)textEquivalent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R1Package.TRIGGER__TEXT_EQUIVALENT, null, msgs);
			if (newTextEquivalent != null)
				msgs = ((InternalEObject)newTextEquivalent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R1Package.TRIGGER__TEXT_EQUIVALENT, null, msgs);
			msgs = basicSetTextEquivalent(newTextEquivalent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.TRIGGER__TEXT_EQUIVALENT, newTextEquivalent, newTextEquivalent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.TRIGGER__DEF:
				return basicSetDef(null, msgs);
			case R1Package.TRIGGER__IDENTIFIERS:
				return ((InternalEList<?>)getIdentifiers()).basicRemove(otherEnd, msgs);
			case R1Package.TRIGGER__TEXT_EQUIVALENT:
