 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.TriggersImpl#getTrigger <em>Trigger</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TriggersImpl extends MinimalEObjectImpl.Container implements Triggers {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.TRIGGERS;
	}
	...
	public EList<Trigger> getTrigger() {
		if (trigger == null) {
			trigger = new EObjectContainmentEList<Trigger>(Trigger.class, this, R1Package.TRIGGERS__TRIGGER);
		}
		return trigger;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.TRIGGERS__TRIGGER:
