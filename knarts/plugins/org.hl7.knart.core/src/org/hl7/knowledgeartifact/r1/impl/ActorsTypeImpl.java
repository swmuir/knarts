 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.knowledgeartifact.r1.impl.ActorsTypeImpl#getActor <em>Actor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActorsTypeImpl extends MinimalEObjectImpl.Container implements ActorsType {
	...
	protected EClass eStaticClass() {
		return R1Package.Literals.ACTORS_TYPE;
	}
	...
	public EList<Actor> getActor() {
		if (actor == null) {
			actor = new EObjectContainmentEList<Actor>(Actor.class, this, R1Package.ACTORS_TYPE__ACTOR);
		}
		return actor;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.ACTORS_TYPE__ACTOR:
