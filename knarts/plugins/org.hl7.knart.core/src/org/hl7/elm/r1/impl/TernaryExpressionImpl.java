 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.TernaryExpressionImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TernaryExpressionImpl extends ExpressionImpl implements TernaryExpression {
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getTernaryExpression();
	}
	...
	public EList<Expression> getOperand() {
		if (operand == null) {
			operand = new EObjectContainmentEList<Expression>(Expression.class, this, R1Package.TERNARY_EXPRESSION__OPERAND);
		}
		return operand;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case R1Package.TERNARY_EXPRESSION__OPERAND:
