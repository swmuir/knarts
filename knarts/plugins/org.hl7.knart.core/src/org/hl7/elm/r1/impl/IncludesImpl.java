 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.IncludesImpl#getPrecision <em>Precision</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IncludesImpl extends BinaryExpressionImpl implements Includes {
	/**
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getIncludes();
	}
	...
	public void setPrecision(DateTimePrecision newPrecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.INCLUDES__PRECISION, oldPrecision, precision, !oldPrecisionESet));
	}
	...
	public void unsetPrecision() {
		...
		precisionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R1Package.INCLUDES__PRECISION, oldPrecision, PRECISION_EDEFAULT, oldPrecisionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.INCLUDES__PRECISION:
				return getPrecision();
		}
