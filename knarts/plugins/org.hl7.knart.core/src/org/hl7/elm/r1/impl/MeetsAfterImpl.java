...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Meets After</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.elm.r1.impl.MeetsAfterImpl#getPrecision <em>Precision</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeetsAfterImpl extends BinaryExpressionImpl implements MeetsAfter {
	/**
	...
	protected EClass eStaticClass() {
		return R1Package.eINSTANCE.getMeetsAfter();
	}
	...
	public void setPrecision(DateTimePrecision newPrecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, R1Package.MEETS_AFTER__PRECISION, oldPrecision, precision, !oldPrecisionESet));
	}
	...
	public void unsetPrecision() {
		...
		precisionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, R1Package.MEETS_AFTER__PRECISION, oldPrecision, PRECISION_EDEFAULT, oldPrecisionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case R1Package.MEETS_AFTER__PRECISION:
				return getPrecision();
		}
