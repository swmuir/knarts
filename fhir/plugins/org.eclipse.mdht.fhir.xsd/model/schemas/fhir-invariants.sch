...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="//f:OrderSet/f:item/f:identifier/f:period">
      <sch:assert test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)">per-1: If present, start SHALL have a lower value than end</sch:assert>
    </sch:rule>
    <sch:rule context="//f:OrderSet/f:item/f:identifier/f:assigner">
      <sch:assert test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])">ref-1: SHALL have a local reference if the resource is provided inline</sch:assert>
    </sch:rule>
    <sch:rule context="//f:OrderSet/f:item/f:supportingEvidence">
      <sch:assert test="not(exists(f:data)) or exists(f:contentType)">att-1: It the Attachment has data, it SHALL have a contentType</sch:assert>
    </sch:rule>
    <sch:rule context="//f:OrderSet/f:item/f:documentation">
      <sch:assert test="not(exists(f:data)) or exists(f:contentType)">att-1: It the Attachment has data, it SHALL have a contentType</sch:assert>
    </sch:rule>
    <sch:rule context="//f:OrderSet/f:item/f:resource">
      <sch:assert test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])">ref-1: SHALL have a local reference if the resource is provided inline</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="//f:Claim/f:relatedClaim">
      <sch:assert test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])">ref-1: SHALL have a local reference if the resource is provided inline</sch:assert>
    </sch:rule>
    ...
    <sch:rule context="//f:Claim/f:onsetPeriod">
      <sch:assert test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)">per-1: If present, start SHALL have a lower value than end</sch:assert>
    </sch:rule>
  ...
  <sch:pattern>
    <sch:title>Extension: Initial presumed answer for question</sch:title>
    <sch:rule context="//f:extension[@url='http://hl7.org/fhir/StructureDefinition/questionnaire-defaultValue']">
      <sch:assert test="not(parent::*/f:type/@value=('group', 'display'))">inv-7: Default values can't be specified for groups or display items</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>Extension: Only allow data when:</sch:title>
    <sch:rule context="//f:extension[@url='http://hl7.org/fhir/StructureDefinition/questionnaire-enableWhen']">
      <sch:assert test="f:extension[@url=('answered', 'answer')]">inv-5: enableWhen must contain either an 'answer' or an 'answered' element</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Extension: No more than this many characters</sch:title>
    <sch:rule context="//f:extension[@url='http://hl7.org/fhir/StructureDefinition/questionnaire-maxLength']">
      <sch:assert test="parent::*/f:type/@value=('boolean', 'decimal', 'integer', 'open-choice', 'string', 'text', 'url')">inv-12: Maximum length can only be declared for simple question types</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>Extension: Don't allow human editing</sch:title>
    <sch:rule context="//f:extension[@url='http://hl7.org/fhir/StructureDefinition/questionnaire-readOnly']">
      <sch:assert test="not(parent::*/f:type/@value='display')">inv-8: Read-only can't be specified for &quot;display&quot; items</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
