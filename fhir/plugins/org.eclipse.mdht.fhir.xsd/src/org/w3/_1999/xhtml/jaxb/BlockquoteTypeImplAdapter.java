...
public class BlockquoteTypeImplAdapter extends XmlAdapter<String, BlockquoteType> {

	@Override
	public BlockquoteType unmarshal(String v) throws Exception {
		...
		while (it.hasNext()) {
			EObject o = it.next();
			if (o instanceof BlockquoteType) {
				return (BlockquoteType) o;
			}
		}
		return null;
	}
	...
	@Override
	public String marshal(BlockquoteType v) throws Exception {
