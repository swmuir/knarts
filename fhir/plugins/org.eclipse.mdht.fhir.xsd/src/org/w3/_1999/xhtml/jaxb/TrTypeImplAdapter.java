...
public class TrTypeImplAdapter extends XmlAdapter<String, TrType> {

	@Override
	public TrType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(TrType v) throws Exception {
