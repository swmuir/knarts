...
public class ThTypeImplAdapter extends XmlAdapter<String, ThType> {

	@Override
	public ThType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(ThType v) throws Exception {
