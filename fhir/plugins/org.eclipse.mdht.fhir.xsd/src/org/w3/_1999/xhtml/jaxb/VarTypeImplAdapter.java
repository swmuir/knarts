...
public class VarTypeImplAdapter extends XmlAdapter<String, VarType> {

	@Override
	public VarType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(VarType v) throws Exception {
