...
public class StrongTypeImplAdapter extends XmlAdapter<String, StrongType> {

	@Override
	public StrongType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(StrongType v) throws Exception {
