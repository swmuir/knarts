...
public class H1TypeImplAdapter extends XmlAdapter<String, H1Type> {

	@Override
	public H1Type unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(H1Type v) throws Exception {
