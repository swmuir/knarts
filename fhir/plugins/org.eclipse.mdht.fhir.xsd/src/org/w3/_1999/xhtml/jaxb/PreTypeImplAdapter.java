...
public class PreTypeImplAdapter extends XmlAdapter<String, PreType> {

	@Override
	public PreType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(PreType v) throws Exception {
