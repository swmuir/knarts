...
public class DfnTypeImplAdapter extends XmlAdapter<String, DfnType> {

	@Override
	public DfnType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(DfnType v) throws Exception {
