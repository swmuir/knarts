...
public class LiTypeImplAdapter extends XmlAdapter<String, LiType> {

	@Override
	public LiType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(LiType v) throws Exception {
