...
public class InlineImplAdapter extends XmlAdapter<String, Inline> {

	@Override
	public Inline unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(Inline v) throws Exception {
