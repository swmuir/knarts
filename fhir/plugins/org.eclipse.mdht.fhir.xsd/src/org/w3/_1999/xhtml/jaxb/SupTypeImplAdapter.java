...
public class SupTypeImplAdapter extends XmlAdapter<String, SupType> {

	@Override
	public SupType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(SupType v) throws Exception {
