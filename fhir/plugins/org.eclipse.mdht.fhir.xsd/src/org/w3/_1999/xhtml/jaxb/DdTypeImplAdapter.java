...
public class DdTypeImplAdapter extends XmlAdapter<String, DdType> {

	@Override
	public DdType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(DdType v) throws Exception {
