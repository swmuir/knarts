...
public class BdoTypeImplAdapter extends XmlAdapter<String, BdoType> {

	@Override
	public BdoType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(BdoType v) throws Exception {
