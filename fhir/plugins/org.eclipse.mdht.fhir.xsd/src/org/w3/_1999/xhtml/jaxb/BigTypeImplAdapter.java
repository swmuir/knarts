...
public class BigTypeImplAdapter extends XmlAdapter<String, BigType> {

	@Override
	public BigType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(BigType v) throws Exception {
