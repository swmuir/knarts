...
public class FlowImplAdapter extends XmlAdapter<String, Flow> {

	@Override
	public Flow unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(Flow v) throws Exception {
