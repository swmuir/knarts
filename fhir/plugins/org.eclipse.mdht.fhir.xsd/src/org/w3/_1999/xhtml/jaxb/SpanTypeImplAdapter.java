...
public class SpanTypeImplAdapter extends XmlAdapter<String, SpanType> {

	@Override
	public SpanType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(SpanType v) throws Exception {
