...
public class H3TypeImplAdapter extends XmlAdapter<String, H3Type> {

	@Override
	public H3Type unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(H3Type v) throws Exception {
