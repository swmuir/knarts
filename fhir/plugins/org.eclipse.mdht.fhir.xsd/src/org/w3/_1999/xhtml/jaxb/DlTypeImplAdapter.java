...
public class DlTypeImplAdapter extends XmlAdapter<String, DlType> {

	@Override
	public DlType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(DlType v) throws Exception {
