...
public class ITypeImplAdapter extends XmlAdapter<String, IType> {

	@Override
	public IType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(IType v) throws Exception {
