...
public class CiteTypeImplAdapter extends XmlAdapter<String, CiteType> {

	@Override
	public CiteType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(CiteType v) throws Exception {
