...
public class PreContentImplAdapter extends XmlAdapter<String, PreContent> {

	@Override
	public PreContent unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(PreContent v) throws Exception {
