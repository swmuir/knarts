...
public class H4TypeImplAdapter extends XmlAdapter<String, H4Type> {

	@Override
	public H4Type unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(H4Type v) throws Exception {
