...
public class H6TypeImplAdapter extends XmlAdapter<String, H6Type> {

	@Override
	public H6Type unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(H6Type v) throws Exception {
