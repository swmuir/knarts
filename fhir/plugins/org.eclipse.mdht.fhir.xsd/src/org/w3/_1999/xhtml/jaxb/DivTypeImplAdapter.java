...
public class DivTypeImplAdapter extends XmlAdapter<String, DivType> {

	@Override
	public DivType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(DivType v) throws Exception {
