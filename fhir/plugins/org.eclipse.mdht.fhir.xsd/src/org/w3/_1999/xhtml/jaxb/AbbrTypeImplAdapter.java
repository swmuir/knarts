...
public class AbbrTypeImplAdapter extends XmlAdapter<String, AbbrType> {

	@Override
	public AbbrType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(AbbrType v) throws Exception {
