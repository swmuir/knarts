...
public class H2TypeImplAdapter extends XmlAdapter<String, H2Type> {

	@Override
	public H2Type unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(H2Type v) throws Exception {
