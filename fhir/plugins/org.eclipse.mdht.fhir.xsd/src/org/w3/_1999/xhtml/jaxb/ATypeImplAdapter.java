...
public class ATypeImplAdapter extends XmlAdapter<String, AType> {

	@Override
	public AType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(AType v) throws Exception {
