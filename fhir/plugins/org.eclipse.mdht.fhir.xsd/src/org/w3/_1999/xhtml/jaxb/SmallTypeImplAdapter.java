...
public class SmallTypeImplAdapter extends XmlAdapter<String, SmallType> {

	@Override
	public SmallType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(SmallType v) throws Exception {
