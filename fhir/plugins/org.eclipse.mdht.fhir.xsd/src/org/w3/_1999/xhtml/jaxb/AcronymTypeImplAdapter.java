...
public class AcronymTypeImplAdapter extends XmlAdapter<String, AcronymType> {

	@Override
	public AcronymType unmarshal(String v) throws Exception {
		...
		while (it.hasNext()) {
			EObject o = it.next();
			if (o instanceof AcronymType) {
				return (AcronymType) o;
			}
		}
		return null;
	}
	...
	@Override
	public String marshal(AcronymType v) throws Exception {
