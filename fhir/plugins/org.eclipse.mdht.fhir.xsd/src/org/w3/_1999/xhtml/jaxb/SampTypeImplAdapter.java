...
public class SampTypeImplAdapter extends XmlAdapter<String, SampType> {

	@Override
	public SampType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(SampType v) throws Exception {
