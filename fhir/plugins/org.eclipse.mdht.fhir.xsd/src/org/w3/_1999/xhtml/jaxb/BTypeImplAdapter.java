...
public class BTypeImplAdapter extends XmlAdapter<String, BType> {

	@Override
	public BType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(BType v) throws Exception {
