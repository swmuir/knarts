...
public class H5TypeImplAdapter extends XmlAdapter<String, H5Type> {

	@Override
	public H5Type unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(H5Type v) throws Exception {
