...
public class DtTypeImplAdapter extends XmlAdapter<String, DtType> {

	@Override
	public DtType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(DtType v) throws Exception {
