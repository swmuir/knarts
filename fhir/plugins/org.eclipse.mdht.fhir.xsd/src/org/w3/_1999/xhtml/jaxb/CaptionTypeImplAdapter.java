...
public class CaptionTypeImplAdapter extends XmlAdapter<String, CaptionType> {

	@Override
	public CaptionType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(CaptionType v) throws Exception {
