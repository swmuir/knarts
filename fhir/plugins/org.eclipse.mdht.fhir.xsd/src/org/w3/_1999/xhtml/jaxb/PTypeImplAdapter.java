...
public class PTypeImplAdapter extends XmlAdapter<String, PType> {

	@Override
	public PType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(PType v) throws Exception {
