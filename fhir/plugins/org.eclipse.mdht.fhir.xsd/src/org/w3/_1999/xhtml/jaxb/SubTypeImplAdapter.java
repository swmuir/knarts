...
public class SubTypeImplAdapter extends XmlAdapter<String, SubType> {

	@Override
	public SubType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(SubType v) throws Exception {
