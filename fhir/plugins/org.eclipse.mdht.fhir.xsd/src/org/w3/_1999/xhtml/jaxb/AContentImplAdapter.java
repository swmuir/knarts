...
public class AContentImplAdapter extends XmlAdapter<String, AContent> {

	@Override
	public AContent unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(AContent v) throws Exception {
