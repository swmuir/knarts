...
public class QTypeImplAdapter extends XmlAdapter<String, QType> {

	@Override
	public QType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(QType v) throws Exception {
