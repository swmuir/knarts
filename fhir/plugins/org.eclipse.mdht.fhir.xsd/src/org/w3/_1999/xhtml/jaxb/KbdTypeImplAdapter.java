...
public class KbdTypeImplAdapter extends XmlAdapter<String, KbdType> {

	@Override
	public KbdType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(KbdType v) throws Exception {
