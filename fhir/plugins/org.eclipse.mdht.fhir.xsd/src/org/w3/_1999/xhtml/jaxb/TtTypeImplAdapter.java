...
public class TtTypeImplAdapter extends XmlAdapter<String, TtType> {

	@Override
	public TtType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(TtType v) throws Exception {
