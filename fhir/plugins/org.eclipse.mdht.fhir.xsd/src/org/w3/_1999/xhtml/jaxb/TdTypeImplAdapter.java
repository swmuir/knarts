...
public class TdTypeImplAdapter extends XmlAdapter<String, TdType> {

	@Override
	public TdType unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(TdType v) throws Exception {
