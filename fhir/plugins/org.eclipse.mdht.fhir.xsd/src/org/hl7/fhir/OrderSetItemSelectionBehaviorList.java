...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Order Set Item Selection Behavior List</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getOrderSetItemSelectionBehaviorList()
 * @model extendedMetaData="name='OrderSetItemSelectionBehavior-list'"
 * @generated
 */
public enum OrderSetItemSelectionBehaviorList implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Order Set Item Selection Behavior List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final OrderSetItemSelectionBehaviorList[] VALUES_ARRAY =
		new OrderSetItemSelectionBehaviorList[] {
			ANY,
			ALL,
			ALL_OR_NONE,
			EXACTLY_ONE,
	...
	/**
	 * A public read-only list of all the '<em><b>Order Set Item Selection Behavior List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<OrderSetItemSelectionBehaviorList> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Order Set Item Selection Behavior List</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static OrderSetItemSelectionBehaviorList get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			OrderSetItemSelectionBehaviorList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Order Set Item Selection Behavior List</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static OrderSetItemSelectionBehaviorList getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			OrderSetItemSelectionBehaviorList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Order Set Item Selection Behavior List</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static OrderSetItemSelectionBehaviorList get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private OrderSetItemSelectionBehaviorList(int value, String name, String literal) {
		this.value = value;
		this.name = name;
...
} //OrderSetItemSelectionBehaviorList
