 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.TaskOutputImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link org.hl7.fhir.impl.TaskOutputImpl#getValueElementDefinition <em>Value Element Definition</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.TaskOutputImpl#getValueModuleMetadata <em>Value Module Metadata</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.TaskOutputImpl#getValueDataRequirement <em>Value Data Requirement</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.TaskOutputImpl#getValueActionDefinition <em>Value Action Definition</em>}</li>
...
public class TaskOutputImpl extends BackboneElementImpl implements TaskOutput {
	...
	public NotificationChain basicSetName(org.hl7.fhir.String newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__NAME, oldName, newName);
	...
	public void setName(org.hl7.fhir.String newName) {
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__NAME, null, msgs);
			if (newName != null)
				msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__NAME, null, msgs);
			msgs = basicSetName(newName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__NAME, newName, newName));
	}
	...
	public NotificationChain basicSetValueElementDefinition(ElementDefinition newValueElementDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_ELEMENT_DEFINITION, oldValueElementDefinition, newValueElementDefinition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueElementDefinition(ElementDefinition newValueElementDefinition) {
		if (newValueElementDefinition != valueElementDefinition) {
			...
			if (valueElementDefinition != null)
				msgs = ((InternalEObject)valueElementDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_ELEMENT_DEFINITION, null, msgs);
			if (newValueElementDefinition != null)
				msgs = ((InternalEObject)newValueElementDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_ELEMENT_DEFINITION, null, msgs);
			msgs = basicSetValueElementDefinition(newValueElementDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_ELEMENT_DEFINITION, newValueElementDefinition, newValueElementDefinition));
	}
	...
	public NotificationChain basicSetValueModuleMetadata(ModuleMetadata newValueModuleMetadata, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_MODULE_METADATA, oldValueModuleMetadata, newValueModuleMetadata);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueModuleMetadata(ModuleMetadata newValueModuleMetadata) {
		if (newValueModuleMetadata != valueModuleMetadata) {
			...
			if (valueModuleMetadata != null)
				msgs = ((InternalEObject)valueModuleMetadata).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_MODULE_METADATA, null, msgs);
			if (newValueModuleMetadata != null)
				msgs = ((InternalEObject)newValueModuleMetadata).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_MODULE_METADATA, null, msgs);
			msgs = basicSetValueModuleMetadata(newValueModuleMetadata, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_MODULE_METADATA, newValueModuleMetadata, newValueModuleMetadata));
	}
	...
	public NotificationChain basicSetValueActionDefinition(ActionDefinition newValueActionDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_ACTION_DEFINITION, oldValueActionDefinition, newValueActionDefinition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueActionDefinition(ActionDefinition newValueActionDefinition) {
		if (newValueActionDefinition != valueActionDefinition) {
			...
			if (valueActionDefinition != null)
				msgs = ((InternalEObject)valueActionDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_ACTION_DEFINITION, null, msgs);
			if (newValueActionDefinition != null)
				msgs = ((InternalEObject)newValueActionDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_ACTION_DEFINITION, null, msgs);
			msgs = basicSetValueActionDefinition(newValueActionDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_ACTION_DEFINITION, newValueActionDefinition, newValueActionDefinition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.TASK_OUTPUT__NAME:
			...
			case FhirPackage.TASK_OUTPUT__VALUE_ELEMENT_DEFINITION:
				return basicSetValueElementDefinition(null, msgs);
			case FhirPackage.TASK_OUTPUT__VALUE_MODULE_METADATA:
			...
			case FhirPackage.TASK_OUTPUT__VALUE_ACTION_DEFINITION:
