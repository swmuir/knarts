 ...
 *   <li>{@link org.hl7.fhir.impl.ExplanationOfBenefitAddItemImpl#getNoteNumberLinkId <em>Note Number Link Id</em>}</li>
...
public class ExplanationOfBenefitAddItemImpl extends BackboneElementImpl implements ExplanationOfBenefitAddItem {
	 ...
	 * @ordered
	 */
	protected EList<ExplanationOfBenefitAdjudication3> adjudication;
	...
	public EList<PositiveInt> getNoteNumberLinkId() {
		if (noteNumberLinkId == null) {
			noteNumberLinkId = new EObjectContainmentEList<PositiveInt>(PositiveInt.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__NOTE_NUMBER_LINK_ID);
		}
	 ...
	 * @generated
	 */
	public EList<ExplanationOfBenefitAdjudication3> getAdjudication() {
		if (adjudication == null) {
			adjudication = new EObjectContainmentEList<ExplanationOfBenefitAdjudication3>(ExplanationOfBenefitAdjudication3.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__ADJUDICATION);
		}
		return adjudication;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__NOTE_NUMBER_LINK_ID:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__ADJUDICATION:
				...
				getAdjudication().addAll((Collection<? extends ExplanationOfBenefitAdjudication3>)newValue);
				return;
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__DETAIL:
				getDetail().clear();
