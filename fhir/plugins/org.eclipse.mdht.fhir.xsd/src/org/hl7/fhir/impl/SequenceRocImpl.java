...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sequence Roc</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.SequenceRocImpl#getScore <em>Score</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.SequenceRocImpl#getNumTP <em>Num TP</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.SequenceRocImpl#getNumFP <em>Num FP</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.SequenceRocImpl#getNumFN <em>Num FN</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.SequenceRocImpl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.SequenceRocImpl#getSensitivity <em>Sensitivity</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.SequenceRocImpl#getFMeasure <em>FMeasure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceRocImpl extends BackboneElementImpl implements SequenceRoc {
	/**
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getSequenceRoc();
	}
	...
	public EList<org.hl7.fhir.Integer> getScore() {
		if (score == null) {
			score = new EObjectContainmentEList<org.hl7.fhir.Integer>(org.hl7.fhir.Integer.class, this, FhirPackage.SEQUENCE_ROC__SCORE);
		}
		return score;
	}
	...
	public EList<org.hl7.fhir.Integer> getNumTP() {
		if (numTP == null) {
			numTP = new EObjectContainmentEList<org.hl7.fhir.Integer>(org.hl7.fhir.Integer.class, this, FhirPackage.SEQUENCE_ROC__NUM_TP);
		}
		return numTP;
	}
	...
	public EList<org.hl7.fhir.Integer> getNumFP() {
		if (numFP == null) {
			numFP = new EObjectContainmentEList<org.hl7.fhir.Integer>(org.hl7.fhir.Integer.class, this, FhirPackage.SEQUENCE_ROC__NUM_FP);
		}
		return numFP;
	}
	...
	public EList<org.hl7.fhir.Integer> getNumFN() {
		if (numFN == null) {
			numFN = new EObjectContainmentEList<org.hl7.fhir.Integer>(org.hl7.fhir.Integer.class, this, FhirPackage.SEQUENCE_ROC__NUM_FN);
		}
		return numFN;
	}
	...
	public EList<Decimal> getPrecision() {
		if (precision == null) {
			precision = new EObjectContainmentEList<Decimal>(Decimal.class, this, FhirPackage.SEQUENCE_ROC__PRECISION);
		}
		return precision;
	}
	...
	public EList<Decimal> getSensitivity() {
		if (sensitivity == null) {
			sensitivity = new EObjectContainmentEList<Decimal>(Decimal.class, this, FhirPackage.SEQUENCE_ROC__SENSITIVITY);
		}
		return sensitivity;
	}
	...
	public EList<Decimal> getFMeasure() {
		if (fMeasure == null) {
			fMeasure = new EObjectContainmentEList<Decimal>(Decimal.class, this, FhirPackage.SEQUENCE_ROC__FMEASURE);
		}
		return fMeasure;
	}
