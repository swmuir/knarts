 ...
 *   <li>{@link org.hl7.fhir.impl.GuidanceResponseRelatedActionImpl#getOffsetQuantity <em>Offset Quantity</em>}</li>
...
public class GuidanceResponseRelatedActionImpl extends BackboneElementImpl implements GuidanceResponseRelatedAction {
	...
	public NotificationChain basicSetOffsetQuantity(Duration newOffsetQuantity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.GUIDANCE_RESPONSE_RELATED_ACTION__OFFSET_QUANTITY, oldOffsetQuantity, newOffsetQuantity);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOffsetQuantity(Duration newOffsetQuantity) {
		if (newOffsetQuantity != offsetQuantity) {
			...
			if (offsetQuantity != null)
				msgs = ((InternalEObject)offsetQuantity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.GUIDANCE_RESPONSE_RELATED_ACTION__OFFSET_QUANTITY, null, msgs);
			if (newOffsetQuantity != null)
				msgs = ((InternalEObject)newOffsetQuantity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.GUIDANCE_RESPONSE_RELATED_ACTION__OFFSET_QUANTITY, null, msgs);
			msgs = basicSetOffsetQuantity(newOffsetQuantity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.GUIDANCE_RESPONSE_RELATED_ACTION__OFFSET_QUANTITY, newOffsetQuantity, newOffsetQuantity));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.GUIDANCE_RESPONSE_RELATED_ACTION__OFFSET_QUANTITY:
