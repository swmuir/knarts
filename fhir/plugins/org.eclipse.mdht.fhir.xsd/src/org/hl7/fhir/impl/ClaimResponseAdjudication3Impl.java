 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.ClaimResponseAdjudication3Impl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.ClaimResponseAdjudication3Impl#getReason <em>Reason</em>}</li>
...
public class ClaimResponseAdjudication3Impl extends BackboneElementImpl implements ClaimResponseAdjudication3 {
	...
	public NotificationChain basicSetCategory(Coding newCategory, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__CATEGORY, oldCategory, newCategory);
	...
	public void setCategory(Coding newCategory) {
		if (newCategory != category) {
			...
			if (category != null)
				msgs = ((InternalEObject)category).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__CATEGORY, null, msgs);
			if (newCategory != null)
				msgs = ((InternalEObject)newCategory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__CATEGORY, null, msgs);
			msgs = basicSetCategory(newCategory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__CATEGORY, newCategory, newCategory));
	}
	...
	public NotificationChain basicSetReason(Coding newReason, NotificationChain msgs) {
		...
		reason = newReason;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__REASON, oldReason, newReason);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReason(Coding newReason) {
		if (newReason != reason) {
			NotificationChain msgs = null;
			if (reason != null)
				msgs = ((InternalEObject)reason).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__REASON, null, msgs);
			if (newReason != null)
				msgs = ((InternalEObject)newReason).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__REASON, null, msgs);
			msgs = basicSetReason(newReason, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__REASON, newReason, newReason));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__CATEGORY:
				return basicSetCategory(null, msgs);
			case FhirPackage.CLAIM_RESPONSE_ADJUDICATION3__REASON:
