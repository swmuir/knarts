...
public class DocumentRootImplAdapter extends XmlAdapter<String, DocumentRoot> {

	@Override
	public DocumentRoot unmarshal(String v) throws Exception {
	...
	@Override
	public String marshal(DocumentRoot v) throws Exception {
