...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Claim Type2 List</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getClaimType2List()
 * @model extendedMetaData="name='ClaimType2-list'"
 * @generated
 */
public enum ClaimType2List implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Claim Type2 List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ClaimType2List[] VALUES_ARRAY =
		new ClaimType2List[] {
			INSTITUTIONAL,
			ORAL,
			PHARMACY,
	...
	/**
	 * A public read-only list of all the '<em><b>Claim Type2 List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ClaimType2List> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Claim Type2 List</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ClaimType2List get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ClaimType2List result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Claim Type2 List</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ClaimType2List getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ClaimType2List result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Claim Type2 List</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ClaimType2List get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ClaimType2List(int value, String name, String literal) {
		this.value = value;
		this.name = name;
