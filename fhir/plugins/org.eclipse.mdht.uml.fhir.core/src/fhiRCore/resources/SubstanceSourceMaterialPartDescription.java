 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.SubstanceSourceMaterialPartDescription#getPart <em>Part</em>}</li>
 *   <li>{@link fhiRCore.resources.SubstanceSourceMaterialPartDescription#getPartLocation <em>Part Location</em>}</li>
 * </ul>
 *
 * @see fhiRCore.resources.ResourcesPackage#getSubstanceSourceMaterialPartDescription()
...
public interface SubstanceSourceMaterialPartDescription extends BackboneElement {
	 ...
	 * @see fhiRCore.resources.ResourcesPackage#getSubstanceSourceMaterialPartDescription_Part()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.resources.SubstanceSourceMaterialPartDescription#getPart <em>Part</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.resources.ResourcesPackage#getSubstanceSourceMaterialPartDescription_PartLocation()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fhiRCore.resources.SubstanceSourceMaterialPartDescription#getPartLocation <em>Part Location</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
