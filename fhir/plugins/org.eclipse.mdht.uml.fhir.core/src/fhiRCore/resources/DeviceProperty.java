 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.DeviceProperty#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.DeviceProperty#getValueQuantities <em>Value Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.DeviceProperty#getValueCodes <em>Value Code</em>}</li>
 * </ul>
 *
 * @see fhiRCore.resources.ResourcesPackage#getDeviceProperty()
...
public interface DeviceProperty extends BackboneElement {
	 ...
	 * @see fhiRCore.resources.ResourcesPackage#getDeviceProperty_Type()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.resources.DeviceProperty#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.resources.ResourcesPackage#getDeviceProperty_ValueQuantity()
	 ...
	 * @see fhiRCore.resources.ResourcesPackage#getDeviceProperty_ValueCode()
	 * @model containment="true"
	 * @generated
	 */
