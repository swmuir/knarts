 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemAddedItemDetailImpl#getProductOrService <em>Product Or Service</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemAddedItemDetailImpl#getModifiers <em>Modifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemAddedItemDetailImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemAddedItemDetailImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemAddedItemDetailImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemAddedItemDetailImpl#getNet <em>Net</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemAddedItemDetailImpl#getNoteNumbers <em>Note Number</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemAddedItemDetailImpl#getAdjudications <em>Adjudication</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemAddedItemDetailImpl#getSubDetails <em>Sub Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
