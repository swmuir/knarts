 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.TestScriptDestinationImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.TestScriptDestinationImpl#getProfile <em>Profile</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestScriptDestinationImpl extends BackboneElementImpl implements TestScriptDestination {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Integer index;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Integer getIndex() {
		return index;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIndex(fhiRCore.dataTypes.Integer newIndex, NotificationChain msgs) {
		fhiRCore.dataTypes.Integer oldIndex = index;
		index = newIndex;
	 ...
	 * @generated
	 */
	public void setIndex(fhiRCore.dataTypes.Integer newIndex) {
		if (newIndex != index) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.TEST_SCRIPT_DESTINATION__INDEX:
				setIndex((fhiRCore.dataTypes.Integer)newValue);
				return;
			case ResourcesPackage.TEST_SCRIPT_DESTINATION__PROFILE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.TEST_SCRIPT_DESTINATION__INDEX:
				setIndex((fhiRCore.dataTypes.Integer)null);
				return;
			case ResourcesPackage.TEST_SCRIPT_DESTINATION__PROFILE:
