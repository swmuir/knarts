...
import fhiRCore.resources.MedicinalProductManufactured;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductManufacturedImpl#getManufacturedDoseForm <em>Manufactured Dose Form</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductManufacturedImpl#getUnitOfPresentation <em>Unit Of Presentation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductManufacturedImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductManufacturedImpl#getManufacturers <em>Manufacturer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductManufacturedImpl#getIngredients <em>Ingredient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductManufacturedImpl#getPhysicalCharacteristics <em>Physical Characteristics</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductManufacturedImpl#getOtherCharacteristics <em>Other Characteristics</em>}</li>
 * </ul>
 *
 * @generated
 */
