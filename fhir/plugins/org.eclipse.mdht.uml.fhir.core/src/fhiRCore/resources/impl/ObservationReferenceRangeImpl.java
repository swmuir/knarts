 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ObservationReferenceRangeImpl#getLow <em>Low</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationReferenceRangeImpl#getHigh <em>High</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationReferenceRangeImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationReferenceRangeImpl#getAppliesTos <em>Applies To</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationReferenceRangeImpl#getAge <em>Age</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationReferenceRangeImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
