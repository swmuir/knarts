...
import fhiRCore.resources.BodyStructure;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.BodyStructureImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BodyStructureImpl#getActive <em>Active</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BodyStructureImpl#getMorphology <em>Morphology</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BodyStructureImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BodyStructureImpl#getLocationQualifiers <em>Location Qualifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BodyStructureImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BodyStructureImpl#getImages <em>Image</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BodyStructureImpl#getPatient <em>Patient</em>}</li>
 * </ul>
 *
 * @generated
 */
