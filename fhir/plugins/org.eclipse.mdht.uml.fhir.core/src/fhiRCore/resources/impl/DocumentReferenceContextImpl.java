 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.DocumentReferenceContextImpl#getEncounters <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentReferenceContextImpl#getEvents <em>Event</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentReferenceContextImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentReferenceContextImpl#getFacilityType <em>Facility Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentReferenceContextImpl#getPracticeSetting <em>Practice Setting</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentReferenceContextImpl#getSourcePatientInfo <em>Source Patient Info</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentReferenceContextImpl#getRelateds <em>Related</em>}</li>
 * </ul>
 *
 * @generated
 */
