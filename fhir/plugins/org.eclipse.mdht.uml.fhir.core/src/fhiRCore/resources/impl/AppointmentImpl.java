...
import fhiRCore.resources.Appointment;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getCancelationReason <em>Cancelation Reason</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getServiceCategories <em>Service Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getServiceTypes <em>Service Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getSpecialties <em>Specialty</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getAppointmentType <em>Appointment Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getSupportingInformations <em>Supporting Information</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getStart <em>Start</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getEnd <em>End</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getMinutesDuration <em>Minutes Duration</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getSlots <em>Slot</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getPatientInstruction <em>Patient Instruction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getParticipants <em>Participant</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AppointmentImpl#getRequestedPeriods <em>Requested Period</em>}</li>
 * </ul>
 *
 * @generated
 */
