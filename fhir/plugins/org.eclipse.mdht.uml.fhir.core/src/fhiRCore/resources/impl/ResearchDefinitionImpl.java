...
import fhiRCore.resources.ResearchDefinition;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getShortTitle <em>Short Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getSubtitle <em>Subtitle</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getSubjectx <em>Subjectx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getComments <em>Comment</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getUsage <em>Usage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getApprovalDate <em>Approval Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getLastReviewDate <em>Last Review Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getTopics <em>Topic</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getEditors <em>Editor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getReviewers <em>Reviewer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getEndorsers <em>Endorser</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getRelatedArtifacts <em>Related Artifact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getLibraries <em>Library</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getPopulation <em>Population</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getExposure <em>Exposure</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getExposureAlternative <em>Exposure Alternative</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ResearchDefinitionImpl#getOutcome <em>Outcome</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResearchDefinitionImpl extends DomainResourceImpl implements ResearchDefinition {
	...
	public EList<fhiRCore.dataTypes.String> getComments() {
		if (comments == null) {
			comments = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.RESEARCH_DEFINITION__COMMENT);
		}
		return comments;
	}
