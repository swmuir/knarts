...
import fhiRCore.resources.SupplyRequest;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getItemx <em>Itemx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getParameters <em>Parameter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getOccurrencex <em>Occurrencex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getAuthoredOn <em>Authored On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getRequester <em>Requester</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getSuppliers <em>Supplier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getDeliverFrom <em>Deliver From</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyRequestImpl#getDeliverTo <em>Deliver To</em>}</li>
 * </ul>
 *
 * @generated
 */
