 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ContractComputableLanguageImpl#getContentx <em>Contentx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractComputableLanguageImpl extends BackboneElementImpl implements ContractComputableLanguage {
	...
	public NotificationChain basicSetContentx(DataType newContentx, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ResourcesPackage.CONTRACT_COMPUTABLE_LANGUAGE__CONTENTX, oldContentx, newContentx);
	...
	public void setContentx(DataType newContentx) {
		if (newContentx != contentx) {
			...
			if (contentx != null)
				msgs = ((InternalEObject)contentx).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ResourcesPackage.CONTRACT_COMPUTABLE_LANGUAGE__CONTENTX, null, msgs);
			if (newContentx != null)
				msgs = ((InternalEObject)newContentx).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ResourcesPackage.CONTRACT_COMPUTABLE_LANGUAGE__CONTENTX, null, msgs);
			msgs = basicSetContentx(newContentx, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.CONTRACT_COMPUTABLE_LANGUAGE__CONTENTX, newContentx, newContentx));
	}
