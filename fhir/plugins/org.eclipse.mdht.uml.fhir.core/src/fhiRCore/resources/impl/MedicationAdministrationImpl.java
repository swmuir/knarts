...
import fhiRCore.resources.MedicationAdministration;
import fhiRCore.resources.MedicationAdministrationDosage;
import fhiRCore.resources.MedicationAdministrationPerformer;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getInstantiates <em>Instantiates</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getPartOfs <em>Part Of</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getStatusReasons <em>Status Reason</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getMedicationx <em>Medicationx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getContext <em>Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getSupportingInformations <em>Supporting Information</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getEffectivex <em>Effectivex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getDevices <em>Device</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getDosage <em>Dosage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationAdministrationImpl#getEventHistories <em>Event History</em>}</li>
 * </ul>
 *
 * @generated
 */
