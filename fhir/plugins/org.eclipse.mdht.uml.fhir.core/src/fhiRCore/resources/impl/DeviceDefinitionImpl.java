...
import fhiRCore.resources.DeviceDefinition;
import fhiRCore.resources.DeviceDefinitionCapability;
import fhiRCore.resources.DeviceDefinitionDeviceName;
import fhiRCore.resources.DeviceDefinitionMaterial;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getUdiDeviceIdentifiers <em>Udi Device Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getManufacturerx <em>Manufacturerx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getDeviceNames <em>Device Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getModelNumber <em>Model Number</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getSpecializations <em>Specialization</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getVersions <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getSafeties <em>Safety</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getShelfLifeStorages <em>Shelf Life Storage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getPhysicalCharacteristics <em>Physical Characteristics</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getLanguageCodes <em>Language Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getCapabilities <em>Capability</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getProperties <em>Property</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getOnlineInformation <em>Online Information</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getParentDevice <em>Parent Device</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionImpl#getMaterials <em>Material</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceDefinitionImpl extends DomainResourceImpl implements DeviceDefinition {
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> versions;
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getVersions() {
		if (versions == null) {
			versions = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.DEVICE_DEFINITION__VERSION);
		}
		return versions;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.DEVICE_DEFINITION__VERSION:
				getVersions().clear();
				getVersions().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.DEVICE_DEFINITION__SAFETY:
				getSafeties().clear();
