...
import fhiRCore.resources.AllergyIntolerance;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getClinicalStatus <em>Clinical Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getVerificationStatus <em>Verification Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getCriticality <em>Criticality</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getOnsetx <em>Onsetx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getRecordedDate <em>Recorded Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getRecorder <em>Recorder</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getAsserter <em>Asserter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getLastOccurrence <em>Last Occurrence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AllergyIntoleranceImpl#getReactions <em>Reaction</em>}</li>
 * </ul>
 *
 * @generated
 */
