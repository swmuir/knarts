...
import fhiRCore.resources.DeviceMetric;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getOperationalStatus <em>Operational Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getColor <em>Color</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getMeasurementPeriod <em>Measurement Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceMetricImpl#getCalibrations <em>Calibration</em>}</li>
 * </ul>
 *
 * @generated
 */
