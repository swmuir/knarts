...
import fhiRCore.resources.MeasureSupplementalData;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getSubtitle <em>Subtitle</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getSubjectx <em>Subjectx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getUsage <em>Usage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getApprovalDate <em>Approval Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getLastReviewDate <em>Last Review Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getTopics <em>Topic</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getEditors <em>Editor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getReviewers <em>Reviewer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getEndorsers <em>Endorser</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getRelatedArtifacts <em>Related Artifact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getLibraries <em>Library</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getDisclaimer <em>Disclaimer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getScoring <em>Scoring</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getCompositeScoring <em>Composite Scoring</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getTypes <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getRiskAdjustment <em>Risk Adjustment</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getRateAggregation <em>Rate Aggregation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getRationale <em>Rationale</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getClinicalRecommendationStatement <em>Clinical Recommendation Statement</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getImprovementNotation <em>Improvement Notation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getDefinitions <em>Definition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getGuidance <em>Guidance</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getGroups <em>Group</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MeasureImpl#getSupplementalData <em>Supplemental Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasureImpl extends DomainResourceImpl implements Measure {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String riskAdjustment;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String rateAggregation;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getRiskAdjustment() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRiskAdjustment(fhiRCore.dataTypes.String newRiskAdjustment, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldRiskAdjustment = riskAdjustment;
	 ...
	 * @generated
	 */
	public void setRiskAdjustment(fhiRCore.dataTypes.String newRiskAdjustment) {
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getRateAggregation() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRateAggregation(fhiRCore.dataTypes.String newRateAggregation, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldRateAggregation = rateAggregation;
	 ...
	 * @generated
	 */
	public void setRateAggregation(fhiRCore.dataTypes.String newRateAggregation) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.MEASURE__TYPE:
				...
				return;
			case ResourcesPackage.MEASURE__RISK_ADJUSTMENT:
				setRiskAdjustment((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.MEASURE__RATE_AGGREGATION:
				setRateAggregation((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.MEASURE__RATIONALE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.MEASURE__TYPE:
				...
				return;
			case ResourcesPackage.MEASURE__RISK_ADJUSTMENT:
				setRiskAdjustment((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.MEASURE__RATE_AGGREGATION:
				setRateAggregation((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.MEASURE__RATIONALE:
