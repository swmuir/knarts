...
import fhiRCore.resources.ImplementationGuideGlobal;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getPackageId <em>Package Id</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getLicense <em>License</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getFhirVersions <em>Fhir Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getDependsOns <em>Depends On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getGlobals <em>Global</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getDefinition <em>Definition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImplementationGuideImpl#getManifest <em>Manifest</em>}</li>
 * </ul>
 *
 * @generated
 */
