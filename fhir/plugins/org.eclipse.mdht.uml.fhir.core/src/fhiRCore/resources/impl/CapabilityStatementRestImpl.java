 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CapabilityStatementRestImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CapabilityStatementRestImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CapabilityStatementRestImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CapabilityStatementRestImpl#getResources <em>Resource</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CapabilityStatementRestImpl#getInteractions <em>Interaction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CapabilityStatementRestImpl#getSearchParams <em>Search Param</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CapabilityStatementRestImpl#getOperations <em>Operation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CapabilityStatementRestImpl#getCompartments <em>Compartment</em>}</li>
 * </ul>
 *
 * @generated
 */
