 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.QuestionnaireItemEnableWhenImpl#getQuestion <em>Question</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.QuestionnaireItemEnableWhenImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.QuestionnaireItemEnableWhenImpl#getAnswerx <em>Answerx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QuestionnaireItemEnableWhenImpl extends BackboneElementImpl implements QuestionnaireItemEnableWhen {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String question;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getQuestion() {
		return question;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetQuestion(fhiRCore.dataTypes.String newQuestion, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldQuestion = question;
	 ...
	 * @generated
	 */
	public void setQuestion(fhiRCore.dataTypes.String newQuestion) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.QUESTIONNAIRE_ITEM_ENABLE_WHEN__QUESTION:
				setQuestion((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.QUESTIONNAIRE_ITEM_ENABLE_WHEN__OPERATOR:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.QUESTIONNAIRE_ITEM_ENABLE_WHEN__QUESTION:
				setQuestion((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.QUESTIONNAIRE_ITEM_ENABLE_WHEN__OPERATOR:
