 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.AuditEventAgentNetworkImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AuditEventAgentNetworkImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuditEventAgentNetworkImpl extends BackboneElementImpl implements AuditEventAgentNetwork {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String address;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getAddress() {
		return address;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAddress(fhiRCore.dataTypes.String newAddress, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldAddress = address;
		address = newAddress;
	 ...
	 * @generated
	 */
	public void setAddress(fhiRCore.dataTypes.String newAddress) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.AUDIT_EVENT_AGENT_NETWORK__ADDRESS:
				setAddress((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.AUDIT_EVENT_AGENT_NETWORK__TYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.AUDIT_EVENT_AGENT_NETWORK__ADDRESS:
				setAddress((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.AUDIT_EVENT_AGENT_NETWORK__TYPE:
				setType((Code)null);
				return;
