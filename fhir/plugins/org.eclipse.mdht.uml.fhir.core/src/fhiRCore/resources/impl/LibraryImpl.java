 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getSubtitle <em>Subtitle</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getSubjectx <em>Subjectx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getUsage <em>Usage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getApprovalDate <em>Approval Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getLastReviewDate <em>Last Review Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getTopics <em>Topic</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getEditors <em>Editor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getReviewers <em>Reviewer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getEndorsers <em>Endorser</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getRelatedArtifacts <em>Related Artifact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getParameters <em>Parameter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getDataRequirements <em>Data Requirement</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LibraryImpl#getContents <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
