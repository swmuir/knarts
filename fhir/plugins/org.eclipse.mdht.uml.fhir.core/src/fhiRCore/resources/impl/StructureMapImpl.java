...
import fhiRCore.resources.StructureMapStructure;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getStructures <em>Structure</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getImports <em>Import</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapImpl#getGroups <em>Group</em>}</li>
 * </ul>
 *
 * @generated
 */
