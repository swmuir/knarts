...
import fhiRCore.resources.Specimen;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getAccessionIdentifier <em>Accession Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getReceivedTime <em>Received Time</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getParents <em>Parent</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getRequests <em>Request</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getProcessings <em>Processing</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getContainers <em>Container</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getConditions <em>Condition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenImpl#getNotes <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
