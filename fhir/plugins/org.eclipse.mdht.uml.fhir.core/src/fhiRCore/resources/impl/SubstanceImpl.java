...
import fhiRCore.resources.Substance;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SubstanceImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceImpl#getInstances <em>Instance</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceImpl#getIngredients <em>Ingredient</em>}</li>
 * </ul>
 *
 * @generated
 */
