 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisRiskEstimateImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisRiskEstimateImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisRiskEstimateImpl#getValue <em>Value</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisRiskEstimateImpl#getUnitOfMeasure <em>Unit Of Measure</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisRiskEstimateImpl#getDenominatorCount <em>Denominator Count</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisRiskEstimateImpl#getNumeratorCount <em>Numerator Count</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisRiskEstimateImpl#getPrecisionEstimates <em>Precision Estimate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RiskEvidenceSynthesisRiskEstimateImpl extends BackboneElementImpl implements RiskEvidenceSynthesisRiskEstimate {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Integer denominatorCount;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Integer numeratorCount;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Integer getDenominatorCount() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDenominatorCount(fhiRCore.dataTypes.Integer newDenominatorCount, NotificationChain msgs) {
		fhiRCore.dataTypes.Integer oldDenominatorCount = denominatorCount;
	 ...
	 * @generated
	 */
	public void setDenominatorCount(fhiRCore.dataTypes.Integer newDenominatorCount) {
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Integer getNumeratorCount() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNumeratorCount(fhiRCore.dataTypes.Integer newNumeratorCount, NotificationChain msgs) {
		fhiRCore.dataTypes.Integer oldNumeratorCount = numeratorCount;
	 ...
	 * @generated
	 */
	public void setNumeratorCount(fhiRCore.dataTypes.Integer newNumeratorCount) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.RISK_EVIDENCE_SYNTHESIS_RISK_ESTIMATE__UNIT_OF_MEASURE:
				...
				return;
			case ResourcesPackage.RISK_EVIDENCE_SYNTHESIS_RISK_ESTIMATE__DENOMINATOR_COUNT:
				setDenominatorCount((fhiRCore.dataTypes.Integer)newValue);
				return;
			case ResourcesPackage.RISK_EVIDENCE_SYNTHESIS_RISK_ESTIMATE__NUMERATOR_COUNT:
				setNumeratorCount((fhiRCore.dataTypes.Integer)newValue);
				return;
			case ResourcesPackage.RISK_EVIDENCE_SYNTHESIS_RISK_ESTIMATE__PRECISION_ESTIMATE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.RISK_EVIDENCE_SYNTHESIS_RISK_ESTIMATE__UNIT_OF_MEASURE:
				...
				return;
			case ResourcesPackage.RISK_EVIDENCE_SYNTHESIS_RISK_ESTIMATE__DENOMINATOR_COUNT:
				setDenominatorCount((fhiRCore.dataTypes.Integer)null);
				return;
			case ResourcesPackage.RISK_EVIDENCE_SYNTHESIS_RISK_ESTIMATE__NUMERATOR_COUNT:
				setNumeratorCount((fhiRCore.dataTypes.Integer)null);
				return;
			case ResourcesPackage.RISK_EVIDENCE_SYNTHESIS_RISK_ESTIMATE__PRECISION_ESTIMATE:
				getPrecisionEstimates().clear();
				return;
