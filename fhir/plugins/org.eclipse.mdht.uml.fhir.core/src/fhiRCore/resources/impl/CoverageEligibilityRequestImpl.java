...
import fhiRCore.resources.CoverageEligibilityRequest;
import fhiRCore.resources.CoverageEligibilityRequestDetails;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getPurposes <em>Purpose</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getServicedx <em>Servicedx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getEnterer <em>Enterer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getInsurer <em>Insurer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getFacility <em>Facility</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getSupportingInfos <em>Supporting Info</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getInsurances <em>Insurance</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestImpl#getItems <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
