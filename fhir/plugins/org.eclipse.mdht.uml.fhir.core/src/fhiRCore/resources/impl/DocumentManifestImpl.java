...
import fhiRCore.resources.DocumentManifest;
import fhiRCore.resources.DocumentManifestRelated;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getMasterIdentifier <em>Master Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getRecipients <em>Recipient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getContents <em>Content</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DocumentManifestImpl#getRelateds <em>Related</em>}</li>
 * </ul>
 *
 * @generated
 */
