 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getKeywords <em>Keyword</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getFhirVersion <em>Fhir Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getMappings <em>Mapping</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getContexts <em>Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getContextInvariants <em>Context Invariant</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getBaseDefinition <em>Base Definition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getDerivation <em>Derivation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getSnapshot <em>Snapshot</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureDefinitionImpl#getDifferential <em>Differential</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureDefinitionImpl extends DomainResourceImpl implements StructureDefinition {
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> contextInvariants;
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getContextInvariants() {
		if (contextInvariants == null) {
			contextInvariants = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.STRUCTURE_DEFINITION__CONTEXT_INVARIANT);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.STRUCTURE_DEFINITION__CONTEXT_INVARIANT:
				...
				getContextInvariants().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.STRUCTURE_DEFINITION__TYPE:
