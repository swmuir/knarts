...
import fhiRCore.resources.SubstanceSourceMaterial;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getSourceMaterialClass <em>Source Material Class</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getSourceMaterialType <em>Source Material Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getSourceMaterialState <em>Source Material State</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getOrganismId <em>Organism Id</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getOrganismName <em>Organism Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getParentSubstanceIds <em>Parent Substance Id</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getParentSubstanceNames <em>Parent Substance Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getCountryOfOrigins <em>Country Of Origin</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getGeographicalLocations <em>Geographical Location</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getDevelopmentStage <em>Development Stage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getFractionDescriptions <em>Fraction Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getOrganism <em>Organism</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialImpl#getPartDescriptions <em>Part Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstanceSourceMaterialImpl extends DomainResourceImpl implements SubstanceSourceMaterial {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String organismName;
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> parentSubstanceNames;
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> geographicalLocations;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getOrganismName() {
		return organismName;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOrganismName(fhiRCore.dataTypes.String newOrganismName, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldOrganismName = organismName;
	 ...
	 * @generated
	 */
	public void setOrganismName(fhiRCore.dataTypes.String newOrganismName) {
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getParentSubstanceNames() {
		if (parentSubstanceNames == null) {
			parentSubstanceNames = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__PARENT_SUBSTANCE_NAME);
		}
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getGeographicalLocations() {
		if (geographicalLocations == null) {
			geographicalLocations = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__GEOGRAPHICAL_LOCATION);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__ORGANISM_ID:
				...
				return;
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__ORGANISM_NAME:
				setOrganismName((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__PARENT_SUBSTANCE_ID:
			...
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__PARENT_SUBSTANCE_NAME:
				...
				getParentSubstanceNames().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__COUNTRY_OF_ORIGIN:
			...
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__GEOGRAPHICAL_LOCATION:
				...
				getGeographicalLocations().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__DEVELOPMENT_STAGE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__ORGANISM_ID:
				...
				return;
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__ORGANISM_NAME:
				setOrganismName((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL__PARENT_SUBSTANCE_ID:
				getParentSubstanceIds().clear();
				return;
