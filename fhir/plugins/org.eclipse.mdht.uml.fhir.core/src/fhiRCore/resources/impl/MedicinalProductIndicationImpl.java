...
import fhiRCore.resources.MedicinalProductIndication;
import fhiRCore.resources.MedicinalProductIndicationOtherTherapy;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIndicationImpl#getSubjects <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIndicationImpl#getDiseaseSymptomProcedure <em>Disease Symptom Procedure</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIndicationImpl#getDiseaseStatus <em>Disease Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIndicationImpl#getComorbidities <em>Comorbidity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIndicationImpl#getIntendedEffect <em>Intended Effect</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIndicationImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIndicationImpl#getOtherTherapies <em>Other Therapy</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIndicationImpl#getUndesirableEffects <em>Undesirable Effect</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIndicationImpl#getPopulations <em>Population</em>}</li>
 * </ul>
 *
 * @generated
 */
