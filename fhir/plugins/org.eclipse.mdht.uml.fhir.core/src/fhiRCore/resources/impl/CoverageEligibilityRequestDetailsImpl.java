...
import fhiRCore.resources.CoverageEligibilityRequestDetailsDiagnosis;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getSupportingInfoSequences <em>Supporting Info Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getProductOrService <em>Product Or Service</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getModifiers <em>Modifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getFacility <em>Facility</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getDiagnosis <em>Diagnosis</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityRequestDetailsImpl#getDetails <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
