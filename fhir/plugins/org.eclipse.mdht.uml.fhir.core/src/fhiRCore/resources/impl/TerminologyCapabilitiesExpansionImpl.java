...
import fhiRCore.resources.TerminologyCapabilitiesExpansionParameter;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.TerminologyCapabilitiesExpansionImpl#getHierarchical <em>Hierarchical</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.TerminologyCapabilitiesExpansionImpl#getPaging <em>Paging</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.TerminologyCapabilitiesExpansionImpl#getIncomplete <em>Incomplete</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.TerminologyCapabilitiesExpansionImpl#getParameters <em>Parameter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.TerminologyCapabilitiesExpansionImpl#getTextFilter <em>Text Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TerminologyCapabilitiesExpansionImpl extends BackboneElementImpl implements TerminologyCapabilitiesExpansion {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean hierarchical;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean paging;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean incomplete;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getHierarchical() {
		return hierarchical;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetHierarchical(fhiRCore.dataTypes.Boolean newHierarchical, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldHierarchical = hierarchical;
	 ...
	 * @generated
	 */
	public void setHierarchical(fhiRCore.dataTypes.Boolean newHierarchical) {
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getPaging() {
		return paging;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPaging(fhiRCore.dataTypes.Boolean newPaging, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldPaging = paging;
		paging = newPaging;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setPaging(fhiRCore.dataTypes.Boolean newPaging) {
		if (newPaging != paging) {
			NotificationChain msgs = null;
			if (paging != null)
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getIncomplete() {
		return incomplete;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIncomplete(fhiRCore.dataTypes.Boolean newIncomplete, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldIncomplete = incomplete;
	 ...
	 * @generated
	 */
	public void setIncomplete(fhiRCore.dataTypes.Boolean newIncomplete) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__HIERARCHICAL:
				setHierarchical((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__PAGING:
				setPaging((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__INCOMPLETE:
				setIncomplete((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__PARAMETER:
				getParameters().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__HIERARCHICAL:
				setHierarchical((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__PAGING:
				setPaging((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__INCOMPLETE:
				setIncomplete((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__PARAMETER:
				getParameters().clear();
				return;
