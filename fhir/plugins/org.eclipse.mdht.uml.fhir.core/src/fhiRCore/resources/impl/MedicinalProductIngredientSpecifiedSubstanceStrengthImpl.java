 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIngredientSpecifiedSubstanceStrengthImpl#getPresentation <em>Presentation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIngredientSpecifiedSubstanceStrengthImpl#getPresentationLowLimit <em>Presentation Low Limit</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIngredientSpecifiedSubstanceStrengthImpl#getConcentration <em>Concentration</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIngredientSpecifiedSubstanceStrengthImpl#getConcentrationLowLimit <em>Concentration Low Limit</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIngredientSpecifiedSubstanceStrengthImpl#getMeasurementPoint <em>Measurement Point</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIngredientSpecifiedSubstanceStrengthImpl#getCountries <em>Country</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductIngredientSpecifiedSubstanceStrengthImpl#getReferenceStrengths <em>Reference Strength</em>}</li>
 * </ul>
 *
 * @generated
 */
