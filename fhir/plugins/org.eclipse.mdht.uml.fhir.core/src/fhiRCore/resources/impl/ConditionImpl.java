...
import fhiRCore.resources.Condition;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getClinicalStatus <em>Clinical Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getVerificationStatus <em>Verification Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getBodySites <em>Body Site</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getOnsetx <em>Onsetx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getAbatementx <em>Abatementx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getRecordedDate <em>Recorded Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getRecorder <em>Recorder</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getAsserter <em>Asserter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getStages <em>Stage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getEvidences <em>Evidence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConditionImpl#getNotes <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
