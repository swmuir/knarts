...
import fhiRCore.resources.RiskEvidenceSynthesis;
import fhiRCore.resources.RiskEvidenceSynthesisCertainty;
import fhiRCore.resources.RiskEvidenceSynthesisRiskEstimate;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getApprovalDate <em>Approval Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getLastReviewDate <em>Last Review Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getTopics <em>Topic</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getEditors <em>Editor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getReviewers <em>Reviewer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getEndorsers <em>Endorser</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getRelatedArtifacts <em>Related Artifact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getSynthesisType <em>Synthesis Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getStudyType <em>Study Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getPopulation <em>Population</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getExposure <em>Exposure</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getSampleSize <em>Sample Size</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getRiskEstimate <em>Risk Estimate</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RiskEvidenceSynthesisImpl#getCertainties <em>Certainty</em>}</li>
 * </ul>
 *
 * @generated
 */
