...
import fhiRCore.resources.Claim;
import fhiRCore.resources.ClaimAccident;
...
import fhiRCore.resources.ClaimPayee;
import fhiRCore.resources.ClaimProcedure;
import fhiRCore.resources.ClaimRelatedClaim;
import fhiRCore.resources.ClaimSupportingInformation;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getSubType <em>Sub Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getUse <em>Use</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getBillablePeriod <em>Billable Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getEnterer <em>Enterer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getInsurer <em>Insurer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getFundsReserve <em>Funds Reserve</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getRelateds <em>Related</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getPrescription <em>Prescription</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getOriginalPrescription <em>Original Prescription</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getPayee <em>Payee</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getReferral <em>Referral</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getFacility <em>Facility</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getCareTeams <em>Care Team</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getSupportingInfos <em>Supporting Info</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getDiagnosis <em>Diagnosis</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getProcedures <em>Procedure</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getInsurances <em>Insurance</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getAccident <em>Accident</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getItems <em>Item</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimImpl#getTotal <em>Total</em>}</li>
 * </ul>
 *
 * @generated
 */
