 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getRevenue <em>Revenue</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getProductOrService <em>Product Or Service</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getModifiers <em>Modifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getProgramCodes <em>Program Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getNet <em>Net</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimItemDetailSubDetailImpl#getUdis <em>Udi</em>}</li>
 * </ul>
 *
 * @generated
 */
