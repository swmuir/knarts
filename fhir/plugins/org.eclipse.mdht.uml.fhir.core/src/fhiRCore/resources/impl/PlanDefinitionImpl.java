...
import fhiRCore.resources.PlanDefinitionGoal;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getSubtitle <em>Subtitle</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getSubjectx <em>Subjectx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getUsage <em>Usage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getApprovalDate <em>Approval Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getLastReviewDate <em>Last Review Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getTopics <em>Topic</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getEditors <em>Editor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getReviewers <em>Reviewer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getEndorsers <em>Endorser</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getRelatedArtifacts <em>Related Artifact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getLibraries <em>Library</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getGoals <em>Goal</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionImpl#getActions <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
