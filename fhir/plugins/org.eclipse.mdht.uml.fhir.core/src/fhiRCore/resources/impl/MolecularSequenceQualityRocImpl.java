...
import fhiRCore.resources.MolecularSequenceQualityRoc;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityRocImpl#getScores <em>Score</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityRocImpl#getNumTps <em>Num Tp</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityRocImpl#getNumFps <em>Num Fp</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityRocImpl#getNumFns <em>Num Fn</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityRocImpl#getPrecisions <em>Precision</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityRocImpl#getSensitivities <em>Sensitivity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityRocImpl#getFMeasures <em>FMeasure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MolecularSequenceQualityRocImpl extends BackboneElementImpl implements MolecularSequenceQualityRoc {
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.Integer> scores;
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.Integer> numTps;
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.Integer> numFps;
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.Integer> numFns;
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.Integer> getScores() {
		if (scores == null) {
			scores = new EObjectContainmentEList<fhiRCore.dataTypes.Integer>(fhiRCore.dataTypes.Integer.class, this, ResourcesPackage.MOLECULAR_SEQUENCE_QUALITY_ROC__SCORE);
		}
		return scores;
	}
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.Integer> getNumTps() {
		if (numTps == null) {
			numTps = new EObjectContainmentEList<fhiRCore.dataTypes.Integer>(fhiRCore.dataTypes.Integer.class, this, ResourcesPackage.MOLECULAR_SEQUENCE_QUALITY_ROC__NUM_TP);
		}
		return numTps;
	}
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.Integer> getNumFps() {
		if (numFps == null) {
			numFps = new EObjectContainmentEList<fhiRCore.dataTypes.Integer>(fhiRCore.dataTypes.Integer.class, this, ResourcesPackage.MOLECULAR_SEQUENCE_QUALITY_ROC__NUM_FP);
		}
		return numFps;
	}
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.Integer> getNumFns() {
		if (numFns == null) {
			numFns = new EObjectContainmentEList<fhiRCore.dataTypes.Integer>(fhiRCore.dataTypes.Integer.class, this, ResourcesPackage.MOLECULAR_SEQUENCE_QUALITY_ROC__NUM_FN);
		}
		return numFns;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.MOLECULAR_SEQUENCE_QUALITY_ROC__SCORE:
				getScores().clear();
				getScores().addAll((Collection<? extends fhiRCore.dataTypes.Integer>)newValue);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE_QUALITY_ROC__NUM_TP:
				getNumTps().clear();
				getNumTps().addAll((Collection<? extends fhiRCore.dataTypes.Integer>)newValue);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE_QUALITY_ROC__NUM_FP:
				getNumFps().clear();
				getNumFps().addAll((Collection<? extends fhiRCore.dataTypes.Integer>)newValue);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE_QUALITY_ROC__NUM_FN:
				getNumFns().clear();
				getNumFns().addAll((Collection<? extends fhiRCore.dataTypes.Integer>)newValue);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE_QUALITY_ROC__PRECISION:
				getPrecisions().clear();
