 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityResponseInsuranceImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityResponseInsuranceImpl#getInforce <em>Inforce</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityResponseInsuranceImpl#getBenefitPeriod <em>Benefit Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CoverageEligibilityResponseInsuranceImpl#getItems <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CoverageEligibilityResponseInsuranceImpl extends BackboneElementImpl implements CoverageEligibilityResponseInsurance {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean inforce;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getInforce() {
		return inforce;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInforce(fhiRCore.dataTypes.Boolean newInforce, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldInforce = inforce;
		inforce = newInforce;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setInforce(fhiRCore.dataTypes.Boolean newInforce) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.COVERAGE_ELIGIBILITY_RESPONSE_INSURANCE__COVERAGE:
				...
				return;
			case ResourcesPackage.COVERAGE_ELIGIBILITY_RESPONSE_INSURANCE__INFORCE:
				setInforce((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.COVERAGE_ELIGIBILITY_RESPONSE_INSURANCE__BENEFIT_PERIOD:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.COVERAGE_ELIGIBILITY_RESPONSE_INSURANCE__COVERAGE:
				...
				return;
			case ResourcesPackage.COVERAGE_ELIGIBILITY_RESPONSE_INSURANCE__INFORCE:
				setInforce((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.COVERAGE_ELIGIBILITY_RESPONSE_INSURANCE__BENEFIT_PERIOD:
