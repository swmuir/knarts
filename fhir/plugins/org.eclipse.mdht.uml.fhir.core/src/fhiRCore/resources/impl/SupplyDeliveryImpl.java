...
import fhiRCore.resources.SupplyDelivery;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getPartOfs <em>Part Of</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getSuppliedItem <em>Supplied Item</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getOccurrencex <em>Occurrencex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SupplyDeliveryImpl#getReceivers <em>Receiver</em>}</li>
 * </ul>
 *
 * @generated
 */
