 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.NutritionOrderSupplementImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.NutritionOrderSupplementImpl#getProductName <em>Product Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.NutritionOrderSupplementImpl#getSchedules <em>Schedule</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.NutritionOrderSupplementImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.NutritionOrderSupplementImpl#getInstruction <em>Instruction</em>}</li>
 * </ul>
 *
 * @generated
 */
