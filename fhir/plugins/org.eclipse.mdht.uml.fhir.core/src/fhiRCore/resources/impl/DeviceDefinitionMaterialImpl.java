 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionMaterialImpl#getSubstance <em>Substance</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionMaterialImpl#getAlternate <em>Alternate</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DeviceDefinitionMaterialImpl#getAllergenicIndicator <em>Allergenic Indicator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceDefinitionMaterialImpl extends BackboneElementImpl implements DeviceDefinitionMaterial {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean alternate;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getAlternate() {
		return alternate;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAlternate(fhiRCore.dataTypes.Boolean newAlternate, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldAlternate = alternate;
	 ...
	 * @generated
	 */
	public void setAlternate(fhiRCore.dataTypes.Boolean newAlternate) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.DEVICE_DEFINITION_MATERIAL__SUBSTANCE:
				...
				return;
			case ResourcesPackage.DEVICE_DEFINITION_MATERIAL__ALTERNATE:
				setAlternate((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.DEVICE_DEFINITION_MATERIAL__ALLERGENIC_INDICATOR:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.DEVICE_DEFINITION_MATERIAL__SUBSTANCE:
				...
				return;
			case ResourcesPackage.DEVICE_DEFINITION_MATERIAL__ALTERNATE:
				setAlternate((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.DEVICE_DEFINITION_MATERIAL__ALLERGENIC_INDICATOR:
