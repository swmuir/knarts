...
import fhiRCore.resources.MedicinalProductInteraction;
import fhiRCore.resources.MedicinalProductInteractionInteractant;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductInteractionImpl#getSubjects <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductInteractionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductInteractionImpl#getInteractants <em>Interactant</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductInteractionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductInteractionImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductInteractionImpl#getIncidence <em>Incidence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductInteractionImpl#getManagement <em>Management</em>}</li>
 * </ul>
 *
 * @generated
 */
