...
import fhiRCore.resources.PlanDefinitionActionCondition;
import fhiRCore.resources.PlanDefinitionActionDynamicValue;
import fhiRCore.resources.PlanDefinitionActionParticipant;
import fhiRCore.resources.PlanDefinitionActionRelatedAction;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getTextEquivalent <em>Text Equivalent</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getCodes <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getReasons <em>Reason</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getDocumentations <em>Documentation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getGoalIds <em>Goal Id</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getSubjectx <em>Subjectx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getTriggers <em>Trigger</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getConditions <em>Condition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getInputs <em>Input</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getOutputs <em>Output</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getRelatedActions <em>Related Action</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getTimingx <em>Timingx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getParticipants <em>Participant</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getGroupingBehavior <em>Grouping Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getSelectionBehavior <em>Selection Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getRequiredBehavior <em>Required Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getPrecheckBehavior <em>Precheck Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getCardinalityBehavior <em>Cardinality Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getDefinitionCanonical <em>Definition Canonical</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getDynamicValues <em>Dynamic Value</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionActionImpl#getActions <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlanDefinitionActionImpl extends BackboneElementImpl implements PlanDefinitionAction {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String textEquivalent;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getTextEquivalent() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTextEquivalent(fhiRCore.dataTypes.String newTextEquivalent, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldTextEquivalent = textEquivalent;
	 ...
	 * @generated
	 */
	public void setTextEquivalent(fhiRCore.dataTypes.String newTextEquivalent) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.PLAN_DEFINITION_ACTION__DESCRIPTION:
				...
				return;
			case ResourcesPackage.PLAN_DEFINITION_ACTION__TEXT_EQUIVALENT:
				setTextEquivalent((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.PLAN_DEFINITION_ACTION__PRIORITY:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.PLAN_DEFINITION_ACTION__DESCRIPTION:
				...
				return;
			case ResourcesPackage.PLAN_DEFINITION_ACTION__TEXT_EQUIVALENT:
				setTextEquivalent((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.PLAN_DEFINITION_ACTION__PRIORITY:
