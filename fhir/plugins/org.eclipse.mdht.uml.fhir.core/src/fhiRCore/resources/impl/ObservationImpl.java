 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getPartOfs <em>Part Of</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getFoci <em>Focus</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getEffectivex <em>Effectivex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getValuex <em>Valuex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getDataAbsentReason <em>Data Absent Reason</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getInterpretations <em>Interpretation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getSpecimen <em>Specimen</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getHasMembers <em>Has Member</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getDerivedFroms <em>Derived From</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getComponents <em>Component</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ObservationImpl#getReferenceRanges <em>Reference Range</em>}</li>
 * </ul>
 *
 * @generated
 */
