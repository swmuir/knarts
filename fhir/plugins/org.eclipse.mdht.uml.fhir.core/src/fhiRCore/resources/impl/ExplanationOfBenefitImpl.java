...
import fhiRCore.resources.ExplanationOfBenefit;
import fhiRCore.resources.ExplanationOfBenefitAccident;
import fhiRCore.resources.ExplanationOfBenefitAddedItem;
import fhiRCore.resources.ExplanationOfBenefitBenefitBalance;
import fhiRCore.resources.ExplanationOfBenefitCareTeam;
import fhiRCore.resources.ExplanationOfBenefitDiagnosis;
import fhiRCore.resources.ExplanationOfBenefitInsurance;
import fhiRCore.resources.ExplanationOfBenefitItem;
import fhiRCore.resources.ExplanationOfBenefitItemAdjudication;
import fhiRCore.resources.ExplanationOfBenefitNote;
import fhiRCore.resources.ExplanationOfBenefitPayee;
import fhiRCore.resources.ExplanationOfBenefitPayment;
import fhiRCore.resources.ExplanationOfBenefitProcedure;
import fhiRCore.resources.ExplanationOfBenefitRelatedClaim;
import fhiRCore.resources.ExplanationOfBenefitSupportingInformation;
import fhiRCore.resources.ExplanationOfBenefitTotal;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getSubType <em>Sub Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getUse <em>Use</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getBillablePeriod <em>Billable Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getEnterer <em>Enterer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getInsurer <em>Insurer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getFundsReserveRequested <em>Funds Reserve Requested</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getFundsReserve <em>Funds Reserve</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getRelateds <em>Related</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getPrescription <em>Prescription</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getOriginalPrescription <em>Original Prescription</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getPayee <em>Payee</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getReferral <em>Referral</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getFacility <em>Facility</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getClaim <em>Claim</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getClaimResponse <em>Claim Response</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getPreAuthRefs <em>Pre Auth Ref</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getPreAuthRefPeriods <em>Pre Auth Ref Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getCareTeams <em>Care Team</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getSupportingInfos <em>Supporting Info</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getDiagnosis <em>Diagnosis</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getProcedures <em>Procedure</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getPrecedence <em>Precedence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getInsurances <em>Insurance</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getAccident <em>Accident</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getItems <em>Item</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getAddItems <em>Add Item</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getAdjudications <em>Adjudication</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getTotals <em>Total</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getPayment <em>Payment</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getFormCode <em>Form Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getForm <em>Form</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getProcessNotes <em>Process Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getBenefitPeriod <em>Benefit Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitImpl#getBenefitBalances <em>Benefit Balance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplanationOfBenefitImpl extends DomainResourceImpl implements ExplanationOfBenefit {
	...
	public EList<fhiRCore.dataTypes.String> getPreAuthRefs() {
		if (preAuthRefs == null) {
			preAuthRefs = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.EXPLANATION_OF_BENEFIT__PRE_AUTH_REF);
		}
		return preAuthRefs;
	}
