...
import fhiRCore.resources.MedicinalProductPharmaceutical;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalImpl#getSubjects <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalImpl#getAdministrableDoseForm <em>Administrable Dose Form</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalImpl#getUnitOfPresentation <em>Unit Of Presentation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalImpl#getIngredients <em>Ingredient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalImpl#getDevices <em>Device</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalImpl#getCharacteristics <em>Characteristics</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalImpl#getRouteOfAdministrations <em>Route Of Administration</em>}</li>
 * </ul>
 *
 * @generated
 */
