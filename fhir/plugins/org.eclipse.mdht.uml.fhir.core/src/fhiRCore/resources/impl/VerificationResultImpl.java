...
import fhiRCore.resources.VerificationResult;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getTargets <em>Target</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getTargetLocations <em>Target Location</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getNeed <em>Need</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getStatusDate <em>Status Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getValidationType <em>Validation Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getValidationProcesses <em>Validation Process</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getLastPerformed <em>Last Performed</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getNextScheduled <em>Next Scheduled</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getFailureAction <em>Failure Action</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getPrimarySources <em>Primary Source</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getAttestation <em>Attestation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.VerificationResultImpl#getValidators <em>Validator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VerificationResultImpl extends DomainResourceImpl implements VerificationResult {
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> targetLocations;
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getTargetLocations() {
		if (targetLocations == null) {
			targetLocations = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.VERIFICATION_RESULT__TARGET_LOCATION);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.VERIFICATION_RESULT__TARGET_LOCATION:
				...
				getTargetLocations().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.VERIFICATION_RESULT__NEED:
