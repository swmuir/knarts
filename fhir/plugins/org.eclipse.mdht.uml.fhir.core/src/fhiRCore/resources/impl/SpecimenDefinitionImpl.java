...
import fhiRCore.resources.SpecimenDefinition;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SpecimenDefinitionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenDefinitionImpl#getTypeCollected <em>Type Collected</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenDefinitionImpl#getPatientPreparations <em>Patient Preparation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenDefinitionImpl#getTimeAspect <em>Time Aspect</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenDefinitionImpl#getCollections <em>Collection</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SpecimenDefinitionImpl#getTypeTesteds <em>Type Tested</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecimenDefinitionImpl extends DomainResourceImpl implements SpecimenDefinition {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String timeAspect;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getTimeAspect() {
		return timeAspect;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTimeAspect(fhiRCore.dataTypes.String newTimeAspect, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldTimeAspect = timeAspect;
	 ...
	 * @generated
	 */
	public void setTimeAspect(fhiRCore.dataTypes.String newTimeAspect) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.SPECIMEN_DEFINITION__PATIENT_PREPARATION:
				...
				return;
			case ResourcesPackage.SPECIMEN_DEFINITION__TIME_ASPECT:
				setTimeAspect((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.SPECIMEN_DEFINITION__COLLECTION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.SPECIMEN_DEFINITION__PATIENT_PREPARATION:
				...
				return;
			case ResourcesPackage.SPECIMEN_DEFINITION__TIME_ASPECT:
				setTimeAspect((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.SPECIMEN_DEFINITION__COLLECTION:
				getCollections().clear();
				return;
