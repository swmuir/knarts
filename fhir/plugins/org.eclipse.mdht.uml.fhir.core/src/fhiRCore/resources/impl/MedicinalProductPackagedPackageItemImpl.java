...
import fhiRCore.resources.MedicinalProductPackagedPackageItem;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getMaterials <em>Material</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getAlternateMaterials <em>Alternate Material</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getDevices <em>Device</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getManufacturedItems <em>Manufactured Item</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getPackageItems <em>Package Item</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getPhysicalCharacteristics <em>Physical Characteristics</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getOtherCharacteristics <em>Other Characteristics</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getShelfLifeStorages <em>Shelf Life Storage</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedPackageItemImpl#getManufacturers <em>Manufacturer</em>}</li>
 * </ul>
 *
 * @generated
 */
