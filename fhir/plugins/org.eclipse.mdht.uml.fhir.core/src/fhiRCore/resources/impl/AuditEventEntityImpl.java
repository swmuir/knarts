 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.AuditEventEntityImpl#getWhat <em>What</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AuditEventEntityImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AuditEventEntityImpl#getRole <em>Role</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AuditEventEntityImpl#getLifecycle <em>Lifecycle</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AuditEventEntityImpl#getSecurityLabels <em>Security Label</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AuditEventEntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AuditEventEntityImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AuditEventEntityImpl#getQuery <em>Query</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.AuditEventEntityImpl#getDetails <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
