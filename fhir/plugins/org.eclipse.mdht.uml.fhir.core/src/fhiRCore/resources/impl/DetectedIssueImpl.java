...
import fhiRCore.resources.DetectedIssue;
import fhiRCore.resources.DetectedIssueEvidence;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getIdentifiedx <em>Identifiedx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getImplicateds <em>Implicated</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getEvidences <em>Evidence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getDetail <em>Detail</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DetectedIssueImpl#getMitigations <em>Mitigation</em>}</li>
 * </ul>
 *
 * @generated
 */
