 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.BundleLinkImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BundleLinkImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BundleLinkImpl extends BackboneElementImpl implements BundleLink {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String relation;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getRelation() {
		return relation;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRelation(fhiRCore.dataTypes.String newRelation, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldRelation = relation;
	 ...
	 * @generated
	 */
	public void setRelation(fhiRCore.dataTypes.String newRelation) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.BUNDLE_LINK__RELATION:
				setRelation((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.BUNDLE_LINK__URL:
				setUrl((Uri)newValue);
				return;
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.BUNDLE_LINK__RELATION:
				setRelation((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.BUNDLE_LINK__URL:
				setUrl((Uri)null);
				return;
