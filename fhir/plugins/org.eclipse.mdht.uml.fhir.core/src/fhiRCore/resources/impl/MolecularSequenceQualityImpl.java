 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getStandardSequence <em>Standard Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getStart <em>Start</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getEnd <em>End</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getScore <em>Score</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getTruthTp <em>Truth Tp</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getQueryTp <em>Query Tp</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getTruthFn <em>Truth Fn</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getQueryFp <em>Query Fp</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getGtFp <em>Gt Fp</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getRecall <em>Recall</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getFScore <em>FScore</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MolecularSequenceQualityImpl#getRoc <em>Roc</em>}</li>
 * </ul>
 *
 * @generated
 */
