...
import fhiRCore.resources.Patient;
import fhiRCore.resources.PatientCommunication;
import fhiRCore.resources.PatientContact;
import fhiRCore.resources.PatientLink;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getActive <em>Active</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getNames <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getTelecoms <em>Telecom</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getDeceasedx <em>Deceasedx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getAddresses <em>Address</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getMaritalStatus <em>Marital Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getMultipleBirthx <em>Multiple Birthx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getPhotos <em>Photo</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getCommunications <em>Communication</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getGeneralPractitioners <em>General Practitioner</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PatientImpl#getLinks <em>Link</em>}</li>
 * </ul>
 *
 * @generated
 */
