 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getPredecessor <em>Predecessor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getSubmitter <em>Submitter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getResponse <em>Response</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getResponsible <em>Responsible</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getPayee <em>Payee</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PaymentReconciliationDetailsImpl#getAmount <em>Amount</em>}</li>
 * </ul>
 *
 * @generated
 */
