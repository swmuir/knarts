...
import fhiRCore.resources.Consent;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getDateTime <em>Date Time</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getOrganizations <em>Organization</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getSourcex <em>Sourcex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getPolicies <em>Policy</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getPolicyRule <em>Policy Rule</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getVerifications <em>Verification</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConsentImpl#getProvision <em>Provision</em>}</li>
 * </ul>
 *
 * @generated
 */
