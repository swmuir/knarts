 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ClaimSupportingInformationImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimSupportingInformationImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimSupportingInformationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimSupportingInformationImpl#getTimingx <em>Timingx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimSupportingInformationImpl#getValuex <em>Valuex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ClaimSupportingInformationImpl#getReason <em>Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
