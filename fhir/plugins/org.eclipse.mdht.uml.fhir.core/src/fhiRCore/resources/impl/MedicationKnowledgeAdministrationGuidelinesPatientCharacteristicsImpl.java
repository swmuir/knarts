...
import fhiRCore.resources.MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicationKnowledgeAdministrationGuidelinesPatientCharacteristicsImpl#getCharacteristicx <em>Characteristicx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicationKnowledgeAdministrationGuidelinesPatientCharacteristicsImpl#getValues <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicationKnowledgeAdministrationGuidelinesPatientCharacteristicsImpl extends BackboneElementImpl implements MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics {
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> values;
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.MEDICATION_KNOWLEDGE_ADMINISTRATION_GUIDELINES_PATIENT_CHARACTERISTICS__VALUE);
		}
		return values;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.MEDICATION_KNOWLEDGE_ADMINISTRATION_GUIDELINES_PATIENT_CHARACTERISTICS__VALUE:
				getValues().clear();
				getValues().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
		}
