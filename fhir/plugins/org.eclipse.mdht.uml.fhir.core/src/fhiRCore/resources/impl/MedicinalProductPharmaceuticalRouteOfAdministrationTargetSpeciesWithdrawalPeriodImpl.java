...
import fhiRCore.resources.MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriodImpl#getTissue <em>Tissue</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriodImpl#getValue <em>Value</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriodImpl#getSupportingInformation <em>Supporting Information</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriodImpl extends BackboneElementImpl implements MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String supportingInformation;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getSupportingInformation() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSupportingInformation(fhiRCore.dataTypes.String newSupportingInformation, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldSupportingInformation = supportingInformation;
	 ...
	 * @generated
	 */
	public void setSupportingInformation(fhiRCore.dataTypes.String newSupportingInformation) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.MEDICINAL_PRODUCT_PHARMACEUTICAL_ROUTE_OF_ADMINISTRATION_TARGET_SPECIES_WITHDRAWAL_PERIOD__VALUE:
				...
				return;
			case ResourcesPackage.MEDICINAL_PRODUCT_PHARMACEUTICAL_ROUTE_OF_ADMINISTRATION_TARGET_SPECIES_WITHDRAWAL_PERIOD__SUPPORTING_INFORMATION:
				setSupportingInformation((fhiRCore.dataTypes.String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.MEDICINAL_PRODUCT_PHARMACEUTICAL_ROUTE_OF_ADMINISTRATION_TARGET_SPECIES_WITHDRAWAL_PERIOD__VALUE:
				...
				return;
			case ResourcesPackage.MEDICINAL_PRODUCT_PHARMACEUTICAL_ROUTE_OF_ADMINISTRATION_TARGET_SPECIES_WITHDRAWAL_PERIOD__SUPPORTING_INFORMATION:
				setSupportingInformation((fhiRCore.dataTypes.String)null);
				return;
		}
