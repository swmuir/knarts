...
import fhiRCore.resources.CatalogEntry;
import fhiRCore.resources.CatalogEntryRelatedEntry;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getOrderable <em>Orderable</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getReferencedItem <em>Referenced Item</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getAdditionalIdentifiers <em>Additional Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getClassifications <em>Classification</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getValidityPeriod <em>Validity Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getValidTo <em>Valid To</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getLastUpdated <em>Last Updated</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getAdditionalCharacteristics <em>Additional Characteristic</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getAdditionalClassifications <em>Additional Classification</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CatalogEntryImpl#getRelatedEntries <em>Related Entry</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CatalogEntryImpl extends DomainResourceImpl implements CatalogEntry {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean orderable;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getOrderable() {
		return orderable;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOrderable(fhiRCore.dataTypes.Boolean newOrderable, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldOrderable = orderable;
	 ...
	 * @generated
	 */
	public void setOrderable(fhiRCore.dataTypes.Boolean newOrderable) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.CATALOG_ENTRY__TYPE:
				...
				return;
			case ResourcesPackage.CATALOG_ENTRY__ORDERABLE:
				setOrderable((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.CATALOG_ENTRY__REFERENCED_ITEM:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.CATALOG_ENTRY__TYPE:
				...
				return;
			case ResourcesPackage.CATALOG_ENTRY__ORDERABLE:
				setOrderable((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.CATALOG_ENTRY__REFERENCED_ITEM:
