...
import fhiRCore.resources.MedicinalProductPackaged;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedImpl#getSubjects <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedImpl#getLegalStatusOfSupply <em>Legal Status Of Supply</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedImpl#getMarketingStati <em>Marketing Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedImpl#getMarketingAuthorization <em>Marketing Authorization</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedImpl#getManufacturers <em>Manufacturer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedImpl#getBatchIdentifiers <em>Batch Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductPackagedImpl#getPackageItems <em>Package Item</em>}</li>
 * </ul>
 *
 * @generated
 */
