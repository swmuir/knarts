...
import fhiRCore.resources.CodeSystemFilter;
import fhiRCore.resources.CodeSystemProperty;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getCaseSensitive <em>Case Sensitive</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getValueSet <em>Value Set</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getHierarchyMeaning <em>Hierarchy Meaning</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getCompositional <em>Compositional</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getVersionNeeded <em>Version Needed</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getContent <em>Content</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getSupplements <em>Supplements</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getCount <em>Count</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getFilters <em>Filter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getProperties <em>Property</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CodeSystemImpl#getConcepts <em>Concept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CodeSystemImpl extends DomainResourceImpl implements CodeSystem {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean caseSensitive;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean versionNeeded;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getCaseSensitive() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCaseSensitive(fhiRCore.dataTypes.Boolean newCaseSensitive, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldCaseSensitive = caseSensitive;
	 ...
	 * @generated
	 */
	public void setCaseSensitive(fhiRCore.dataTypes.Boolean newCaseSensitive) {
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getVersionNeeded() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetVersionNeeded(fhiRCore.dataTypes.Boolean newVersionNeeded, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldVersionNeeded = versionNeeded;
	 ...
	 * @generated
	 */
	public void setVersionNeeded(fhiRCore.dataTypes.Boolean newVersionNeeded) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.CODE_SYSTEM__COPYRIGHT:
				...
				return;
			case ResourcesPackage.CODE_SYSTEM__CASE_SENSITIVE:
				setCaseSensitive((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.CODE_SYSTEM__VALUE_SET:
			...
			case ResourcesPackage.CODE_SYSTEM__COMPOSITIONAL:
				...
				return;
			case ResourcesPackage.CODE_SYSTEM__VERSION_NEEDED:
				setVersionNeeded((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.CODE_SYSTEM__CONTENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.CODE_SYSTEM__COPYRIGHT:
				...
				return;
			case ResourcesPackage.CODE_SYSTEM__CASE_SENSITIVE:
				setCaseSensitive((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.CODE_SYSTEM__VALUE_SET:
			...
			case ResourcesPackage.CODE_SYSTEM__COMPOSITIONAL:
				...
				return;
			case ResourcesPackage.CODE_SYSTEM__VERSION_NEEDED:
				setVersionNeeded((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.CODE_SYSTEM__CONTENT:
