...
import fhiRCore.resources.Subscription;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SubscriptionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubscriptionImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubscriptionImpl#getEnd <em>End</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubscriptionImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubscriptionImpl#getCriteria <em>Criteria</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubscriptionImpl#getError <em>Error</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubscriptionImpl#getChannel <em>Channel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubscriptionImpl extends DomainResourceImpl implements Subscription {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String reason;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String criteria;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String error;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getReason() {
		return reason;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetReason(fhiRCore.dataTypes.String newReason, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldReason = reason;
		reason = newReason;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setReason(fhiRCore.dataTypes.String newReason) {
		if (newReason != reason) {
			NotificationChain msgs = null;
			if (reason != null)
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getCriteria() {
		return criteria;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCriteria(fhiRCore.dataTypes.String newCriteria, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldCriteria = criteria;
	 ...
	 * @generated
	 */
	public void setCriteria(fhiRCore.dataTypes.String newCriteria) {
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getError() {
		return error;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetError(fhiRCore.dataTypes.String newError, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldError = error;
		error = newError;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setError(fhiRCore.dataTypes.String newError) {
		if (newError != error) {
			NotificationChain msgs = null;
			if (error != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.SUBSCRIPTION__END:
				...
				return;
			case ResourcesPackage.SUBSCRIPTION__REASON:
				setReason((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.SUBSCRIPTION__CRITERIA:
				setCriteria((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.SUBSCRIPTION__ERROR:
				setError((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.SUBSCRIPTION__CHANNEL:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.SUBSCRIPTION__END:
				...
				return;
			case ResourcesPackage.SUBSCRIPTION__REASON:
				setReason((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.SUBSCRIPTION__CRITERIA:
				setCriteria((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.SUBSCRIPTION__ERROR:
				setError((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.SUBSCRIPTION__CHANNEL:
