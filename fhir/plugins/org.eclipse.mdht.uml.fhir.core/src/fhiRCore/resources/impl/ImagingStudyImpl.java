...
import fhiRCore.resources.ImagingStudy;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getModalities <em>Modality</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getStarted <em>Started</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getReferrer <em>Referrer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getInterpreters <em>Interpreter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getEndpoints <em>Endpoint</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getNumberOfSeries <em>Number Of Series</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getNumberOfInstances <em>Number Of Instances</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getProcedureReference <em>Procedure Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getProcedureCodes <em>Procedure Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImagingStudyImpl#getSeries <em>Series</em>}</li>
 * </ul>
 *
 * @generated
 */
