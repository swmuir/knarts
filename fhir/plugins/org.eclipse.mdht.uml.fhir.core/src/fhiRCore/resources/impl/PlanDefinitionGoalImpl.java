 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionGoalImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionGoalImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionGoalImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionGoalImpl#getStart <em>Start</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionGoalImpl#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionGoalImpl#getDocumentations <em>Documentation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PlanDefinitionGoalImpl#getTargets <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
