 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialOrganismAuthorImpl#getAuthorType <em>Author Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceSourceMaterialOrganismAuthorImpl#getAuthorDescription <em>Author Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstanceSourceMaterialOrganismAuthorImpl extends BackboneElementImpl implements SubstanceSourceMaterialOrganismAuthor {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String authorDescription;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getAuthorDescription() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAuthorDescription(fhiRCore.dataTypes.String newAuthorDescription, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldAuthorDescription = authorDescription;
	 ...
	 * @generated
	 */
	public void setAuthorDescription(fhiRCore.dataTypes.String newAuthorDescription) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM_AUTHOR__AUTHOR_TYPE:
				...
				return;
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM_AUTHOR__AUTHOR_DESCRIPTION:
				setAuthorDescription((fhiRCore.dataTypes.String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM_AUTHOR__AUTHOR_TYPE:
				...
				return;
			case ResourcesPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM_AUTHOR__AUTHOR_DESCRIPTION:
				setAuthorDescription((fhiRCore.dataTypes.String)null);
				return;
		}
