...
import fhiRCore.resources.Contract;
import fhiRCore.resources.ContractComputableLanguage;
import fhiRCore.resources.ContractContentDefinition;
import fhiRCore.resources.ContractFriendlyLanguage;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getLegalState <em>Legal State</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getInstantiatesCanonical <em>Instantiates Canonical</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getInstantiatesUri <em>Instantiates Uri</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getContentDerivative <em>Content Derivative</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getApplies <em>Applies</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getExpirationType <em>Expiration Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getSubjects <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getAuthorities <em>Authority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getDomains <em>Domain</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getSites <em>Site</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getSubtitle <em>Subtitle</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getTopicx <em>Topicx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getSubTypes <em>Sub Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getContentDefinition <em>Content Definition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getTerms <em>Term</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getSupportingInfos <em>Supporting Info</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getRelevantHistories <em>Relevant History</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getSigners <em>Signer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getFriendlies <em>Friendly</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getLegals <em>Legal</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getRules <em>Rule</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractImpl#getLegallyBindingx <em>Legally Bindingx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractImpl extends DomainResourceImpl implements Contract {
	...
	public EList<fhiRCore.dataTypes.String> getAlias() {
		if (alias == null) {
			alias = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.CONTRACT__ALIAS);
		}
		return alias;
	}
