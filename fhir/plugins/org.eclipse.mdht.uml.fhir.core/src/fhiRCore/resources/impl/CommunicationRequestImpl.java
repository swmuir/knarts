...
import fhiRCore.resources.CommunicationRequest;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getReplaces <em>Replaces</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getGroupIdentifier <em>Group Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getStatusReason <em>Status Reason</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getDoNotPerform <em>Do Not Perform</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getMediums <em>Medium</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getAbouts <em>About</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getPayloads <em>Payload</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getOccurrencex <em>Occurrencex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getAuthoredOn <em>Authored On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getRequester <em>Requester</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getRecipients <em>Recipient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getSender <em>Sender</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationRequestImpl#getNotes <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
