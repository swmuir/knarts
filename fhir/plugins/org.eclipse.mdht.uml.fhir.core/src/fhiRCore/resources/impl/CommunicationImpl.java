...
import fhiRCore.resources.Communication;
import fhiRCore.resources.CommunicationPayload;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getInstantiatesCanonicals <em>Instantiates Canonical</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getInstantiatesUris <em>Instantiates Uri</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getPartOfs <em>Part Of</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getInResponseTos <em>In Response To</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getStatusReason <em>Status Reason</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getMediums <em>Medium</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getTopic <em>Topic</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getAbouts <em>About</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getSent <em>Sent</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getReceived <em>Received</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getRecipients <em>Recipient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getSender <em>Sender</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getPayloads <em>Payload</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CommunicationImpl#getNotes <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
