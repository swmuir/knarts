 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getSourcex <em>Sourcex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getTargetx <em>Targetx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ConceptMapImpl#getGroups <em>Group</em>}</li>
 * </ul>
 *
 * @generated
 */
