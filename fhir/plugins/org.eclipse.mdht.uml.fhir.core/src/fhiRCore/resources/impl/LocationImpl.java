...
import fhiRCore.resources.Location;
import fhiRCore.resources.LocationHoursOfOperation;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getOperationalStatus <em>Operational Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getTypes <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getTelecoms <em>Telecom</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getPhysicalType <em>Physical Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getPartOf <em>Part Of</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getHoursOfOperations <em>Hours Of Operation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getAvailabilityExceptions <em>Availability Exceptions</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.LocationImpl#getEndpoints <em>Endpoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocationImpl extends DomainResourceImpl implements Location {
	...
	public EList<fhiRCore.dataTypes.String> getAlias() {
		if (alias == null) {
			alias = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.LOCATION__ALIAS);
		}
		return alias;
	}
