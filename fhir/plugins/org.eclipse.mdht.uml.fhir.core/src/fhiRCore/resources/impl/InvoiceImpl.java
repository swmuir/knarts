...
import fhiRCore.resources.Invoice;
import fhiRCore.resources.InvoiceLineItem;
import fhiRCore.resources.InvoiceLineItemPriceComponent;
import fhiRCore.resources.InvoiceParticipant;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getCancelledReason <em>Cancelled Reason</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getRecipient <em>Recipient</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getParticipants <em>Participant</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getIssuer <em>Issuer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getLineItems <em>Line Item</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getTotalPriceComponents <em>Total Price Component</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getTotalNet <em>Total Net</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getTotalGross <em>Total Gross</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getPaymentTerms <em>Payment Terms</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.InvoiceImpl#getNotes <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InvoiceImpl extends DomainResourceImpl implements Invoice {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String cancelledReason;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getCancelledReason() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCancelledReason(fhiRCore.dataTypes.String newCancelledReason, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldCancelledReason = cancelledReason;
	 ...
	 * @generated
	 */
	public void setCancelledReason(fhiRCore.dataTypes.String newCancelledReason) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.INVOICE__STATUS:
				...
				return;
			case ResourcesPackage.INVOICE__CANCELLED_REASON:
				setCancelledReason((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.INVOICE__TYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.INVOICE__STATUS:
				...
				return;
			case ResourcesPackage.INVOICE__CANCELLED_REASON:
				setCancelledReason((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.INVOICE__TYPE:
