 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.BundleEntryRequestImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BundleEntryRequestImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BundleEntryRequestImpl#getIfNoneMatch <em>If None Match</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BundleEntryRequestImpl#getIfModifiedSince <em>If Modified Since</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BundleEntryRequestImpl#getIfMatch <em>If Match</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.BundleEntryRequestImpl#getIfNoneExist <em>If None Exist</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BundleEntryRequestImpl extends BackboneElementImpl implements BundleEntryRequest {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String ifNoneMatch;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String ifMatch;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String ifNoneExist;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getIfNoneMatch() {
		return ifNoneMatch;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIfNoneMatch(fhiRCore.dataTypes.String newIfNoneMatch, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldIfNoneMatch = ifNoneMatch;
	 ...
	 * @generated
	 */
	public void setIfNoneMatch(fhiRCore.dataTypes.String newIfNoneMatch) {
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getIfMatch() {
		return ifMatch;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIfMatch(fhiRCore.dataTypes.String newIfMatch, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldIfMatch = ifMatch;
		ifMatch = newIfMatch;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setIfMatch(fhiRCore.dataTypes.String newIfMatch) {
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getIfNoneExist() {
		return ifNoneExist;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIfNoneExist(fhiRCore.dataTypes.String newIfNoneExist, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldIfNoneExist = ifNoneExist;
	 ...
	 * @generated
	 */
	public void setIfNoneExist(fhiRCore.dataTypes.String newIfNoneExist) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__URL:
				...
				return;
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__IF_NONE_MATCH:
				setIfNoneMatch((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__IF_MODIFIED_SINCE:
				setIfModifiedSince((Instant)newValue);
				return;
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__IF_MATCH:
				setIfMatch((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__IF_NONE_EXIST:
				setIfNoneExist((fhiRCore.dataTypes.String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__URL:
				...
				return;
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__IF_NONE_MATCH:
				setIfNoneMatch((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__IF_MODIFIED_SINCE:
				setIfModifiedSince((Instant)null);
				return;
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__IF_MATCH:
				setIfMatch((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.BUNDLE_ENTRY_REQUEST__IF_NONE_EXIST:
				setIfNoneExist((fhiRCore.dataTypes.String)null);
				return;
		}
