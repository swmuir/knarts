...
import fhiRCore.resources.ChargeItemDefinitionPropertyGroup;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getDerivedFromUris <em>Derived From Uri</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getPartOfs <em>Part Of</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getReplaces <em>Replaces</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getUseContexts <em>Use Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getApprovalDate <em>Approval Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getLastReviewDate <em>Last Review Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getInstances <em>Instance</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getApplicabilities <em>Applicability</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ChargeItemDefinitionImpl#getPropertyGroups <em>Property Group</em>}</li>
 * </ul>
 *
 * @generated
 */
