...
import fhiRCore.resources.CareTeam;
import fhiRCore.resources.CareTeamParticipant;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getParticipants <em>Participant</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getManagingOrganizations <em>Managing Organization</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getTelecoms <em>Telecom</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CareTeamImpl#getNotes <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
