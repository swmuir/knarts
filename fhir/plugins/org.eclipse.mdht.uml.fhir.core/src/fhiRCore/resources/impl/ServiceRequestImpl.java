 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getInstantiatesCanonicals <em>Instantiates Canonical</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getInstantiatesUris <em>Instantiates Uri</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getReplaces <em>Replaces</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getRequisition <em>Requisition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getIntent <em>Intent</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getDoNotPerform <em>Do Not Perform</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getOrderDetails <em>Order Detail</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getQuantityx <em>Quantityx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getOccurrencex <em>Occurrencex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getAsNeededx <em>As Neededx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getAuthoredOn <em>Authored On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getRequester <em>Requester</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getPerformerType <em>Performer Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getLocationCodes <em>Location Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getLocationReferences <em>Location Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getInsurances <em>Insurance</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getSupportingInfos <em>Supporting Info</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getSpecimens <em>Specimen</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getBodySites <em>Body Site</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getPatientInstruction <em>Patient Instruction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ServiceRequestImpl#getRelevantHistories <em>Relevant History</em>}</li>
 * </ul>
 *
 * @generated
 */
