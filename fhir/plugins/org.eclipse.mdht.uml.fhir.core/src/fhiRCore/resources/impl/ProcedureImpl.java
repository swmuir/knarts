...
import fhiRCore.resources.Procedure;
import fhiRCore.resources.ProcedureFocalDevice;
import fhiRCore.resources.ProcedurePerformer;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getInstantiatesCanonicals <em>Instantiates Canonical</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getInstantiatesUris <em>Instantiates Uri</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getPartOfs <em>Part Of</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getStatusReason <em>Status Reason</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getPerformedx <em>Performedx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getRecorder <em>Recorder</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getAsserter <em>Asserter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getBodySites <em>Body Site</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getReports <em>Report</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getComplications <em>Complication</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getComplicationDetails <em>Complication Detail</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getFollowUps <em>Follow Up</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getFocalDevices <em>Focal Device</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getUsedReferences <em>Used Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ProcedureImpl#getUsedCodes <em>Used Code</em>}</li>
 * </ul>
 *
 * @generated
 */
