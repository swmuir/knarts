...
import fhiRCore.resources.MedicinalProduct;
import fhiRCore.resources.MedicinalProductContact;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getCombinedPharmaceuticalDoseForm <em>Combined Pharmaceutical Dose Form</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getIndication <em>Indication</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getLegalStatusOfSupply <em>Legal Status Of Supply</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getAdditionalMonitoringIndicator <em>Additional Monitoring Indicator</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getSpecialMeasures <em>Special Measures</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getPaediatricUseIndicator <em>Paediatric Use Indicator</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getProductClassifications <em>Product Classification</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getMarketingStati <em>Marketing Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getPharmaceuticalProducts <em>Pharmaceutical Product</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getPackagedMedicinalProducts <em>Packaged Medicinal Product</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getAttachedDocuments <em>Attached Document</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getMasterFiles <em>Master File</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getContacts <em>Contact</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getClinicalTrials <em>Clinical Trial</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getNames <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getCrossReferences <em>Cross Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getManufacturingBusinessOperations <em>Manufacturing Business Operation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.MedicinalProductImpl#getSpecialDesignations <em>Special Designation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicinalProductImpl extends DomainResourceImpl implements MedicinalProduct {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String indication;
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> specialMeasures;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getIndication() {
		return indication;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIndication(fhiRCore.dataTypes.String newIndication, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldIndication = indication;
	 ...
	 * @generated
	 */
	public void setIndication(fhiRCore.dataTypes.String newIndication) {
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getSpecialMeasures() {
		if (specialMeasures == null) {
			specialMeasures = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.MEDICINAL_PRODUCT__SPECIAL_MEASURES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.MEDICINAL_PRODUCT__COMBINED_PHARMACEUTICAL_DOSE_FORM:
				...
				return;
			case ResourcesPackage.MEDICINAL_PRODUCT__INDICATION:
				setIndication((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.MEDICINAL_PRODUCT__LEGAL_STATUS_OF_SUPPLY:
			...
			case ResourcesPackage.MEDICINAL_PRODUCT__SPECIAL_MEASURES:
				...
				getSpecialMeasures().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.MEDICINAL_PRODUCT__PAEDIATRIC_USE_INDICATOR:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.MEDICINAL_PRODUCT__COMBINED_PHARMACEUTICAL_DOSE_FORM:
				...
				return;
			case ResourcesPackage.MEDICINAL_PRODUCT__INDICATION:
				setIndication((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.MEDICINAL_PRODUCT__LEGAL_STATUS_OF_SUPPLY:
