 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getCareTeamSequences <em>Care Team Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getDiagnosisSequences <em>Diagnosis Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getProcedureSequences <em>Procedure Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getInformationSequences <em>Information Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getRevenue <em>Revenue</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getProductOrService <em>Product Or Service</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getModifiers <em>Modifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getProgramCodes <em>Program Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getServicedx <em>Servicedx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getLocationx <em>Locationx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getNet <em>Net</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getUdis <em>Udi</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getSubSites <em>Sub Site</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getEncounters <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getNoteNumbers <em>Note Number</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getAdjudications <em>Adjudication</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitItemImpl#getDetails <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
