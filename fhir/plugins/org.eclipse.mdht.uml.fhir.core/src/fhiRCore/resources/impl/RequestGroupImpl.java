 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getInstantiatesCanonicals <em>Instantiates Canonical</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getInstantiatesUris <em>Instantiates Uri</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getReplaces <em>Replaces</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getGroupIdentifier <em>Group Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getIntent <em>Intent</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getAuthoredOn <em>Authored On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getReasonCodes <em>Reason Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getReasonReferences <em>Reason Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupImpl#getActions <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
