 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.QuestionnaireItemAnswerOptionImpl#getValuex <em>Valuex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.QuestionnaireItemAnswerOptionImpl#getInitialSelected <em>Initial Selected</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QuestionnaireItemAnswerOptionImpl extends BackboneElementImpl implements QuestionnaireItemAnswerOption {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean initialSelected;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getInitialSelected() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInitialSelected(fhiRCore.dataTypes.Boolean newInitialSelected, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldInitialSelected = initialSelected;
	 ...
	 * @generated
	 */
	public void setInitialSelected(fhiRCore.dataTypes.Boolean newInitialSelected) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.QUESTIONNAIRE_ITEM_ANSWER_OPTION__VALUEX:
				...
				return;
			case ResourcesPackage.QUESTIONNAIRE_ITEM_ANSWER_OPTION__INITIAL_SELECTED:
				setInitialSelected((fhiRCore.dataTypes.Boolean)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.QUESTIONNAIRE_ITEM_ANSWER_OPTION__VALUEX:
				...
				return;
			case ResourcesPackage.QUESTIONNAIRE_ITEM_ANSWER_OPTION__INITIAL_SELECTED:
				setInitialSelected((fhiRCore.dataTypes.Boolean)null);
				return;
		}
