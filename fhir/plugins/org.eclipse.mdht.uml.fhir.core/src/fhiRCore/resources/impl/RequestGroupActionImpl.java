 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getTextEquivalent <em>Text Equivalent</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getCodes <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getDocumentations <em>Documentation</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getConditions <em>Condition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getRelatedActions <em>Related Action</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getTimingx <em>Timingx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getParticipants <em>Participant</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getGroupingBehavior <em>Grouping Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getSelectionBehavior <em>Selection Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getRequiredBehavior <em>Required Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getPrecheckBehavior <em>Precheck Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getCardinalityBehavior <em>Cardinality Behavior</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.RequestGroupActionImpl#getActions <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
