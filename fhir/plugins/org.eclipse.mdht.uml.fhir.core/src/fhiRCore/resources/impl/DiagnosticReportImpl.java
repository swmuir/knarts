 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getEffectivex <em>Effectivex</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getResultsInterpreters <em>Results Interpreter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getSpecimens <em>Specimen</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getResults <em>Result</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getImagingStudies <em>Imaging Study</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getMedias <em>Media</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getConclusion <em>Conclusion</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getConclusionCodes <em>Conclusion Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.DiagnosticReportImpl#getPresentedForms <em>Presented Form</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiagnosticReportImpl extends DomainResourceImpl implements DiagnosticReport {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String conclusion;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getConclusion() {
		return conclusion;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetConclusion(fhiRCore.dataTypes.String newConclusion, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldConclusion = conclusion;
	 ...
	 * @generated
	 */
	public void setConclusion(fhiRCore.dataTypes.String newConclusion) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.DIAGNOSTIC_REPORT__MEDIA:
				...
				return;
			case ResourcesPackage.DIAGNOSTIC_REPORT__CONCLUSION:
				setConclusion((fhiRCore.dataTypes.String)newValue);
				return;
			case ResourcesPackage.DIAGNOSTIC_REPORT__CONCLUSION_CODE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.DIAGNOSTIC_REPORT__MEDIA:
				...
				return;
			case ResourcesPackage.DIAGNOSTIC_REPORT__CONCLUSION:
				setConclusion((fhiRCore.dataTypes.String)null);
				return;
			case ResourcesPackage.DIAGNOSTIC_REPORT__CONCLUSION_CODE:
				getConclusionCodes().clear();
				return;
