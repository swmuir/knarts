...
import fhiRCore.resources.List;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getOrderedBy <em>Ordered By</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getEntries <em>Entry</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ListImpl#getEmptyReason <em>Empty Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
