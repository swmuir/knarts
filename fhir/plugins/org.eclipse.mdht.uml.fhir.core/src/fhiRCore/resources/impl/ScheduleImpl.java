...
import fhiRCore.resources.Schedule;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ScheduleImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ScheduleImpl#getActive <em>Active</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ScheduleImpl#getServiceCategories <em>Service Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ScheduleImpl#getServiceTypes <em>Service Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ScheduleImpl#getSpecialties <em>Specialty</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ScheduleImpl#getActors <em>Actor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ScheduleImpl#getPlanningHorizon <em>Planning Horizon</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ScheduleImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
