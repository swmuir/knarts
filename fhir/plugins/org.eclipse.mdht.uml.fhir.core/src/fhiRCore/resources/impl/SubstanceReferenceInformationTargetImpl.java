...
import fhiRCore.resources.SubstanceReferenceInformationTarget;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SubstanceReferenceInformationTargetImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceReferenceInformationTargetImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceReferenceInformationTargetImpl#getInteraction <em>Interaction</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceReferenceInformationTargetImpl#getOrganism <em>Organism</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceReferenceInformationTargetImpl#getOrganismType <em>Organism Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceReferenceInformationTargetImpl#getAmountx <em>Amountx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceReferenceInformationTargetImpl#getAmountType <em>Amount Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstanceReferenceInformationTargetImpl#getSources <em>Source</em>}</li>
 * </ul>
 *
 * @generated
 */
