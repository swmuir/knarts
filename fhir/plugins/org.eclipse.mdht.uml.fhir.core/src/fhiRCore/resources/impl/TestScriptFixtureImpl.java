 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.TestScriptFixtureImpl#getAutocreate <em>Autocreate</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.TestScriptFixtureImpl#getAutodelete <em>Autodelete</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.TestScriptFixtureImpl#getResource <em>Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestScriptFixtureImpl extends BackboneElementImpl implements TestScriptFixture {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean autocreate;
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean autodelete;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getAutocreate() {
		return autocreate;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAutocreate(fhiRCore.dataTypes.Boolean newAutocreate, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldAutocreate = autocreate;
	 ...
	 * @generated
	 */
	public void setAutocreate(fhiRCore.dataTypes.Boolean newAutocreate) {
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getAutodelete() {
		return autodelete;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAutodelete(fhiRCore.dataTypes.Boolean newAutodelete, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldAutodelete = autodelete;
	 ...
	 * @generated
	 */
	public void setAutodelete(fhiRCore.dataTypes.Boolean newAutodelete) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.TEST_SCRIPT_FIXTURE__AUTOCREATE:
				setAutocreate((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.TEST_SCRIPT_FIXTURE__AUTODELETE:
				setAutodelete((fhiRCore.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.TEST_SCRIPT_FIXTURE__RESOURCE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.TEST_SCRIPT_FIXTURE__AUTOCREATE:
				setAutocreate((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.TEST_SCRIPT_FIXTURE__AUTODELETE:
				setAutodelete((fhiRCore.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.TEST_SCRIPT_FIXTURE__RESOURCE:
