...
import fhiRCore.resources.ExplanationOfBenefitAddedItemAddedItemDetail;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getItemSequences <em>Item Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getDetailSequences <em>Detail Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getSubDetailSequences <em>Sub Detail Sequence</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getProviders <em>Provider</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getProductOrService <em>Product Or Service</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getModifiers <em>Modifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getProgramCodes <em>Program Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getServicedx <em>Servicedx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getLocationx <em>Locationx</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getNet <em>Net</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getSubSites <em>Sub Site</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getNoteNumbers <em>Note Number</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getAdjudications <em>Adjudication</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ExplanationOfBenefitAddedItemImpl#getDetails <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
