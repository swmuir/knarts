...
import fhiRCore.resources.Practitioner;
import fhiRCore.resources.PractitionerQualification;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getActive <em>Active</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getNames <em>Name</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getTelecoms <em>Telecom</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getAddresses <em>Address</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getPhotos <em>Photo</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getQualifications <em>Qualification</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerImpl#getCommunications <em>Communication</em>}</li>
 * </ul>
 *
 * @generated
 */
