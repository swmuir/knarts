...
import fhiRCore.resources.ContractTermContractAssetAssetContext;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getTypes <em>Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getTypeReferences <em>Type Reference</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getSubtypes <em>Subtype</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getRelationship <em>Relationship</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getContexts <em>Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getPeriodTypes <em>Period Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getPeriods <em>Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getUsePeriods <em>Use Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getText <em>Text</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getLinkIds <em>Link Id</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getAnswers <em>Answer</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getSecurityLabelNumbers <em>Security Label Number</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ContractTermContractAssetImpl#getValuedItems <em>Valued Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractTermContractAssetImpl extends BackboneElementImpl implements ContractTermContractAsset {
	...
	public EList<fhiRCore.dataTypes.String> getLinkIds() {
		if (linkIds == null) {
			linkIds = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.CONTRACT_TERM_CONTRACT_ASSET__LINK_ID);
		}
		return linkIds;
	}
