...
import fhiRCore.resources.SubstancePolymer;
import fhiRCore.resources.SubstancePolymerMonomerSet;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.SubstancePolymerImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstancePolymerImpl#getGeometry <em>Geometry</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstancePolymerImpl#getCopolymerConnectivities <em>Copolymer Connectivity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstancePolymerImpl#getModifications <em>Modification</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstancePolymerImpl#getMonomerSets <em>Monomer Set</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.SubstancePolymerImpl#getRepeats <em>Repeat</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstancePolymerImpl extends DomainResourceImpl implements SubstancePolymer {
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> modifications;
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getModifications() {
		if (modifications == null) {
			modifications = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, ResourcesPackage.SUBSTANCE_POLYMER__MODIFICATION);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.SUBSTANCE_POLYMER__MODIFICATION:
				...
				getModifications().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.SUBSTANCE_POLYMER__MONOMER_SET:
