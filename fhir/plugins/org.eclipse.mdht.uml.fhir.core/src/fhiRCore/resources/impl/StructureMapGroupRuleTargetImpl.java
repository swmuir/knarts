...
import fhiRCore.resources.StructureMapGroupRuleTargetParameter;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.StructureMapGroupRuleTargetImpl#getContext <em>Context</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapGroupRuleTargetImpl#getContextType <em>Context Type</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapGroupRuleTargetImpl#getElement <em>Element</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapGroupRuleTargetImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapGroupRuleTargetImpl#getListModes <em>List Mode</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapGroupRuleTargetImpl#getListRuleId <em>List Rule Id</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapGroupRuleTargetImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.StructureMapGroupRuleTargetImpl#getParameters <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
