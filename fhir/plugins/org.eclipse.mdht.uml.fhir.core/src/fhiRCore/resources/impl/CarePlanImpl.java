...
import fhiRCore.resources.CarePlan;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getInstantiatesCanonicals <em>Instantiates Canonical</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getInstantiatesUris <em>Instantiates Uri</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getReplaces <em>Replaces</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getPartOfs <em>Part Of</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getIntent <em>Intent</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getContributors <em>Contributor</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getCareTeams <em>Care Team</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getSupportingInfos <em>Supporting Info</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getGoals <em>Goal</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getActivities <em>Activity</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.CarePlanImpl#getNotes <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
