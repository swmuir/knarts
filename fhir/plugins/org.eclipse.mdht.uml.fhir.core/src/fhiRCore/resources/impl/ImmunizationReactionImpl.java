 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.ImmunizationReactionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImmunizationReactionImpl#getDetail <em>Detail</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.ImmunizationReactionImpl#getReported <em>Reported</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImmunizationReactionImpl extends BackboneElementImpl implements ImmunizationReaction {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.Boolean reported;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.Boolean getReported() {
		return reported;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetReported(fhiRCore.dataTypes.Boolean newReported, NotificationChain msgs) {
		fhiRCore.dataTypes.Boolean oldReported = reported;
	 ...
	 * @generated
	 */
	public void setReported(fhiRCore.dataTypes.Boolean newReported) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.IMMUNIZATION_REACTION__DETAIL:
				...
				return;
			case ResourcesPackage.IMMUNIZATION_REACTION__REPORTED:
				setReported((fhiRCore.dataTypes.Boolean)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.IMMUNIZATION_REACTION__DETAIL:
				...
				return;
			case ResourcesPackage.IMMUNIZATION_REACTION__REPORTED:
				setReported((fhiRCore.dataTypes.Boolean)null);
				return;
		}
