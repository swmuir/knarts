...
import fhiRCore.resources.PractitionerRole;
import fhiRCore.resources.PractitionerRoleAvailableTime;
 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getActive <em>Active</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getPractitioner <em>Practitioner</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getCodes <em>Code</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getSpecialties <em>Specialty</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getLocations <em>Location</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getHealthcareServices <em>Healthcare Service</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getTelecoms <em>Telecom</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getAvailableTimes <em>Available Time</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getNotAvailables <em>Not Available</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getAvailabilityExceptions <em>Availability Exceptions</em>}</li>
 *   <li>{@link fhiRCore.resources.impl.PractitionerRoleImpl#getEndpoints <em>Endpoint</em>}</li>
 * </ul>
 *
 * @generated
 */
