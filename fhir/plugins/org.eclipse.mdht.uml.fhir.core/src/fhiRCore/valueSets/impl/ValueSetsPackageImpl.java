...
import fhiRCore.valueSets.ValueSetsFactory;
...
public class ValueSetsPackageImpl extends EPackageImpl implements ValueSetsPackage {
	 ...
	 * @see fhiRCore.valueSets.ValueSetsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("fhiRCore.valueSets." + eClassifier.getName());
