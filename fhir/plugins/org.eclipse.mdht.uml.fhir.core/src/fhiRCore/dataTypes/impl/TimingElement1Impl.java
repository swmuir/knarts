 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getBoundsx <em>Boundsx</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getCount <em>Count</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getCountMax <em>Count Max</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getDuration <em>Duration</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getDurationMax <em>Duration Max</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getDurationUnit <em>Duration Unit</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getFrequencyMax <em>Frequency Max</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getPeriodMax <em>Period Max</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getPeriodUnit <em>Period Unit</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getDayOfWeeks <em>Day Of Week</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getTimeOfDaies <em>Time Of Day</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getWhens <em>When</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.TimingElement1Impl#getOffset <em>Offset</em>}</li>
 * </ul>
 *
 * @generated
 */
