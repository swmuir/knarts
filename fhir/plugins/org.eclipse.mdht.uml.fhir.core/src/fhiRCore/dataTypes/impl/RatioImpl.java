 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.dataTypes.impl.RatioImpl#getNumerator <em>Numerator</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.RatioImpl#getDenominator <em>Denominator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RatioImpl extends DataTypeImpl implements Ratio {
	...
	public NotificationChain basicSetNumerator(Quantity newNumerator, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataTypesPackage.RATIO__NUMERATOR, oldNumerator, newNumerator);
	...
	public void setNumerator(Quantity newNumerator) {
		if (newNumerator != numerator) {
			...
			if (numerator != null)
				msgs = ((InternalEObject)numerator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataTypesPackage.RATIO__NUMERATOR, null, msgs);
			if (newNumerator != null)
				msgs = ((InternalEObject)newNumerator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataTypesPackage.RATIO__NUMERATOR, null, msgs);
			msgs = basicSetNumerator(newNumerator, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataTypesPackage.RATIO__NUMERATOR, newNumerator, newNumerator));
	}
	...
	public NotificationChain basicSetDenominator(Quantity newDenominator, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataTypesPackage.RATIO__DENOMINATOR, oldDenominator, newDenominator);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDenominator(Quantity newDenominator) {
		if (newDenominator != denominator) {
			NotificationChain msgs = null;
			if (denominator != null)
				msgs = ((InternalEObject)denominator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataTypesPackage.RATIO__DENOMINATOR, null, msgs);
			if (newDenominator != null)
				msgs = ((InternalEObject)newDenominator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataTypesPackage.RATIO__DENOMINATOR, null, msgs);
			msgs = basicSetDenominator(newDenominator, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataTypesPackage.RATIO__DENOMINATOR, newDenominator, newDenominator));
	}
