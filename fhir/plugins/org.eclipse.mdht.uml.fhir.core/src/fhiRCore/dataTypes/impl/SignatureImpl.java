 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.dataTypes.impl.SignatureImpl#getTypes <em>Type</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.SignatureImpl#getWhen <em>When</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.SignatureImpl#getWho <em>Who</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.SignatureImpl#getOnBehalfOf <em>On Behalf Of</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.SignatureImpl#getTargetFormat <em>Target Format</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.SignatureImpl#getSigFormat <em>Sig Format</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.SignatureImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
