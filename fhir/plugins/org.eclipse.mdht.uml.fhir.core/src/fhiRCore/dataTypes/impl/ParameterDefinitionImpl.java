 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.dataTypes.impl.ParameterDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.ParameterDefinitionImpl#getUse <em>Use</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.ParameterDefinitionImpl#getMin <em>Min</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.ParameterDefinitionImpl#getMax <em>Max</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.ParameterDefinitionImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.ParameterDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.ParameterDefinitionImpl#getProfile <em>Profile</em>}</li>
 * </ul>
 *
 * @generated
 */
