 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.dataTypes.impl.AttachmentImpl#getContentType <em>Content Type</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.AttachmentImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.AttachmentImpl#getData <em>Data</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.AttachmentImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.AttachmentImpl#getSize <em>Size</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.AttachmentImpl#getHash <em>Hash</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.AttachmentImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.AttachmentImpl#getCreation <em>Creation</em>}</li>
 * </ul>
 *
 * @generated
 */
