 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.dataTypes.impl.HumanNameImpl#getUse <em>Use</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.HumanNameImpl#getText <em>Text</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.HumanNameImpl#getFamily <em>Family</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.HumanNameImpl#getGivens <em>Given</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.HumanNameImpl#getPrefixes <em>Prefix</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.HumanNameImpl#getSuffixes <em>Suffix</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.impl.HumanNameImpl#getPeriod <em>Period</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HumanNameImpl extends DataTypeImpl implements HumanName {
	 ...
	 * @ordered
	 */
	protected fhiRCore.dataTypes.String family;
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> givens;
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> prefixes;
	 ...
	 * @ordered
	 */
	protected EList<fhiRCore.dataTypes.String> suffixes;
	 ...
	 * @generated
	 */
	public fhiRCore.dataTypes.String getFamily() {
		return family;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetFamily(fhiRCore.dataTypes.String newFamily, NotificationChain msgs) {
		fhiRCore.dataTypes.String oldFamily = family;
		family = newFamily;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setFamily(fhiRCore.dataTypes.String newFamily) {
		if (newFamily != family) {
			NotificationChain msgs = null;
			if (family != null)
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getGivens() {
		if (givens == null) {
			givens = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, DataTypesPackage.HUMAN_NAME__GIVEN);
		}
		return givens;
	}
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getPrefixes() {
		if (prefixes == null) {
			prefixes = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, DataTypesPackage.HUMAN_NAME__PREFIX);
		}
		return prefixes;
	}
	 ...
	 * @generated
	 */
	public EList<fhiRCore.dataTypes.String> getSuffixes() {
		if (suffixes == null) {
			suffixes = new EObjectContainmentEList<fhiRCore.dataTypes.String>(fhiRCore.dataTypes.String.class, this, DataTypesPackage.HUMAN_NAME__SUFFIX);
		}
		return suffixes;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DataTypesPackage.HUMAN_NAME__TEXT:
				...
				return;
			case DataTypesPackage.HUMAN_NAME__FAMILY:
				setFamily((fhiRCore.dataTypes.String)newValue);
				return;
			case DataTypesPackage.HUMAN_NAME__GIVEN:
				getGivens().clear();
				getGivens().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case DataTypesPackage.HUMAN_NAME__PREFIX:
				getPrefixes().clear();
				getPrefixes().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case DataTypesPackage.HUMAN_NAME__SUFFIX:
				getSuffixes().clear();
				getSuffixes().addAll((Collection<? extends fhiRCore.dataTypes.String>)newValue);
				return;
			case DataTypesPackage.HUMAN_NAME__PERIOD:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case DataTypesPackage.HUMAN_NAME__TEXT:
				...
				return;
			case DataTypesPackage.HUMAN_NAME__FAMILY:
				setFamily((fhiRCore.dataTypes.String)null);
				return;
			case DataTypesPackage.HUMAN_NAME__GIVEN:
				getGivens().clear();
				return;
