 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.dataTypes.UsageContext#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.UsageContext#getValueCodeableConcept <em>Value Codeable Concept</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.UsageContext#getValueQuantity <em>Value Quantity</em>}</li>
 *   <li>{@link fhiRCore.dataTypes.UsageContext#getValueRange <em>Value Range</em>}</li>
 * </ul>
 *
 * @see fhiRCore.dataTypes.DataTypesPackage#getUsageContext()
 * @model
 * @generated
 */
public interface UsageContext extends DataType {
	 ...
	 * @see #setCode(Coding)
	 * @see fhiRCore.dataTypes.DataTypesPackage#getUsageContext_Code()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.dataTypes.UsageContext#getCode <em>Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.dataTypes.DataTypesPackage#getUsageContext_ValueCodeableConcept()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fhiRCore.dataTypes.UsageContext#getValueCodeableConcept <em>Value Codeable Concept</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.dataTypes.DataTypesPackage#getUsageContext_ValueQuantity()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fhiRCore.dataTypes.UsageContext#getValueQuantity <em>Value Quantity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.dataTypes.DataTypesPackage#getUsageContext_ValueRange()
	 * @model containment="true" required="true"
	 * @generated
	 */
	Range getValueRange();
	...
	/**
	 * Sets the value of the '{@link fhiRCore.dataTypes.UsageContext#getValueRange <em>Value Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
