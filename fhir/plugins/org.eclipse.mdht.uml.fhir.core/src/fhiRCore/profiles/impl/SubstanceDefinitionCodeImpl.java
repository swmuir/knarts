 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionCodeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionCodeImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionCodeImpl#getStatusDate <em>Status Date</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionCodeImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionCodeImpl#getSources <em>Source</em>}</li>
 * </ul>
 *
 * @generated
 */
