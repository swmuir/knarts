 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getSources <em>Source</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getMoieties <em>Moiety</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getProperties <em>Property</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getReferenceInformation <em>Reference Information</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getStructure <em>Structure</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getCodes <em>Code</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getNames <em>Name</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getMolecularWeights <em>Molecular Weight</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getRelationships <em>Relationship</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getNucleicAcid <em>Nucleic Acid</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getPolymer <em>Polymer</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getProtein <em>Protein</em>}</li>
 *   <li>{@link fhiRCore.profiles.impl.SubstanceDefinitionImpl#getSourceMaterial <em>Source Material</em>}</li>
 * </ul>
 *
 * @generated
 */
