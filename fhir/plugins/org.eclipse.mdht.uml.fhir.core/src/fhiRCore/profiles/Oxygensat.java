 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.Oxygensat#getValueQuantity <em>Value Quantity</em>}</li>
 * </ul>
 *
 * @see fhiRCore.profiles.ProfilesPackage#getOxygensat()
...
public interface Oxygensat extends Vitalsigns {
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getOxygensat_ValueQuantity()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.Oxygensat#getValueQuantity <em>Value Quantity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
