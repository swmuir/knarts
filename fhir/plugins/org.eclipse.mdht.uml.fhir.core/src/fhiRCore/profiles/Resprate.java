 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.Resprate#getValueQuantity <em>Value Quantity</em>}</li>
 * </ul>
 *
 * @see fhiRCore.profiles.ProfilesPackage#getResprate()
...
public interface Resprate extends Vitalsigns {
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getResprate_ValueQuantity()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.Resprate#getValueQuantity <em>Value Quantity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
