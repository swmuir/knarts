 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.Bp#getSystolicBp <em>Systolic Bp</em>}</li>
 *   <li>{@link fhiRCore.profiles.Bp#getDiastolicBp <em>Diastolic Bp</em>}</li>
 * </ul>
 *
 * @see fhiRCore.profiles.ProfilesPackage#getBp()
...
public interface Bp extends Vitalsigns {
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getBp_SystolicBp()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.Bp#getSystolicBp <em>Systolic Bp</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getBp_DiastolicBp()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.Bp#getDiastolicBp <em>Diastolic Bp</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
