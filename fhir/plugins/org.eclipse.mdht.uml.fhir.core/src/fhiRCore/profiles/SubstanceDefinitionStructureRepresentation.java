 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.SubstanceDefinitionStructureRepresentation#getType <em>Type</em>}</li>
 *   <li>{@link fhiRCore.profiles.SubstanceDefinitionStructureRepresentation#getRepresentation <em>Representation</em>}</li>
 *   <li>{@link fhiRCore.profiles.SubstanceDefinitionStructureRepresentation#getAttachment <em>Attachment</em>}</li>
 * </ul>
 *
 * @see fhiRCore.profiles.ProfilesPackage#getSubstanceDefinitionStructureRepresentation()
...
public interface SubstanceDefinitionStructureRepresentation extends BackboneElement {
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getSubstanceDefinitionStructureRepresentation_Type()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.SubstanceDefinitionStructureRepresentation#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getSubstanceDefinitionStructureRepresentation_Representation()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.SubstanceDefinitionStructureRepresentation#getRepresentation <em>Representation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getSubstanceDefinitionStructureRepresentation_Attachment()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.SubstanceDefinitionStructureRepresentation#getAttachment <em>Attachment</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
