 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.Lipidprofile#getCholesterol <em>Cholesterol</em>}</li>
 *   <li>{@link fhiRCore.profiles.Lipidprofile#getTriglyceride <em>Triglyceride</em>}</li>
 *   <li>{@link fhiRCore.profiles.Lipidprofile#getHdlCholesterol <em>Hdl Cholesterol</em>}</li>
 *   <li>{@link fhiRCore.profiles.Lipidprofile#getLdlCholesterol <em>Ldl Cholesterol</em>}</li>
 * </ul>
 *
 * @see fhiRCore.profiles.ProfilesPackage#getLipidprofile()
...
public interface Lipidprofile extends DiagnosticReport {
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getLipidprofile_Cholesterol()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.Lipidprofile#getCholesterol <em>Cholesterol</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getLipidprofile_Triglyceride()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.Lipidprofile#getTriglyceride <em>Triglyceride</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getLipidprofile_HdlCholesterol()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.Lipidprofile#getHdlCholesterol <em>Hdl Cholesterol</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getLipidprofile_LdlCholesterol()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.Lipidprofile#getLdlCholesterol <em>Ldl Cholesterol</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
