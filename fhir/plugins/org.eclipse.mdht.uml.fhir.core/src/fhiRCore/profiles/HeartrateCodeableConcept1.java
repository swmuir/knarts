 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.HeartrateCodeableConcept1#getHeartRateCode <em>Heart Rate Code</em>}</li>
 * </ul>
 *
 * @see fhiRCore.profiles.ProfilesPackage#getHeartrateCodeableConcept1()
...
public interface HeartrateCodeableConcept1 extends CodeableConcept {
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getHeartrateCodeableConcept1_HeartRateCode()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.HeartrateCodeableConcept1#getHeartRateCode <em>Heart Rate Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
