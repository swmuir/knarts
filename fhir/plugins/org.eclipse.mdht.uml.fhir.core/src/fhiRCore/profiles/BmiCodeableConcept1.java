 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.BmiCodeableConcept1#getBmiCode <em>Bmi Code</em>}</li>
 * </ul>
 *
 * @see fhiRCore.profiles.ProfilesPackage#getBmiCodeableConcept1()
...
public interface BmiCodeableConcept1 extends CodeableConcept {
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getBmiCodeableConcept1_BmiCode()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.BmiCodeableConcept1#getBmiCode <em>Bmi Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
