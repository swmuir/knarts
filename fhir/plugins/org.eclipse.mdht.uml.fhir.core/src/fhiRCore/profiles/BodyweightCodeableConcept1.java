 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.BodyweightCodeableConcept1#getBodyWeightCode <em>Body Weight Code</em>}</li>
 * </ul>
 *
 * @see fhiRCore.profiles.ProfilesPackage#getBodyweightCodeableConcept1()
...
public interface BodyweightCodeableConcept1 extends CodeableConcept {
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getBodyweightCodeableConcept1_BodyWeightCode()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.BodyweightCodeableConcept1#getBodyWeightCode <em>Body Weight Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
