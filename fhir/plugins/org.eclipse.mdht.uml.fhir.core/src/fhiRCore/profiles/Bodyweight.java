 ...
 * </p>
 * <ul>
 *   <li>{@link fhiRCore.profiles.Bodyweight#getValueQuantity <em>Value Quantity</em>}</li>
 * </ul>
 *
 * @see fhiRCore.profiles.ProfilesPackage#getBodyweight()
...
public interface Bodyweight extends Vitalsigns {
	 ...
	 * @see fhiRCore.profiles.ProfilesPackage#getBodyweight_ValueQuantity()
	...
	/**
	 * Sets the value of the '{@link fhiRCore.profiles.Bodyweight#getValueQuantity <em>Value Quantity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
