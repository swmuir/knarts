 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.InstantImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstantImpl extends DataTypeImpl implements Instant {
	...
	protected EClass eStaticClass() {
		return FhirDatatypePackage.Literals.INSTANT;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirDatatypePackage.INSTANT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirDatatypePackage.INSTANT__VALUE:
				return getValue();
		}
