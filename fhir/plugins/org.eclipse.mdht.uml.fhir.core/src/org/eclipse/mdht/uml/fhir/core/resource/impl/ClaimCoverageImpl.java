 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimCoverageImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimCoverageImpl#getFocal <em>Focal</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimCoverageImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimCoverageImpl#getBusinessArrangement <em>Business Arrangement</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimCoverageImpl#getRelationship <em>Relationship</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimCoverageImpl#getPreAuthRefs <em>Pre Auth Ref</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimCoverageImpl#getClaimResponse <em>Claim Response</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimCoverageImpl#getOriginalRuleset <em>Original Ruleset</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimCoverageImpl extends BackboneElementImpl implements ClaimCoverage {
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getClaimCoverage();
	}
		...
		if (sequence != null && sequence.eIsProxy()) {
			...
			if (sequence != oldSequence) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_COVERAGE__SEQUENCE, oldSequence, sequence));
			}
		}
		return sequence;
	}
	...
	public void setSequence(PositiveInt newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_COVERAGE__SEQUENCE, oldSequence, sequence));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.datatype.Boolean getFocal() {
		if (focal != null && focal.eIsProxy()) {
			...
			if (focal != oldFocal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_COVERAGE__FOCAL, oldFocal, focal));
			}
		}
		return focal;
	}
	...
	public void setFocal(org.eclipse.mdht.uml.fhir.core.datatype.Boolean newFocal) {
		...
		focal = newFocal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_COVERAGE__FOCAL, oldFocal, focal));
	}
	...
	public Coverage getCoverage() {
		if (coverage != null && coverage.eIsProxy()) {
			...
			if (coverage != oldCoverage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_COVERAGE__COVERAGE, oldCoverage, coverage));
			}
		}
		return coverage;
	}
	...
	public void setCoverage(Coverage newCoverage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_COVERAGE__COVERAGE, oldCoverage, coverage));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.datatype.String getBusinessArrangement() {
		if (businessArrangement != null && businessArrangement.eIsProxy()) {
			...
			if (businessArrangement != oldBusinessArrangement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_COVERAGE__BUSINESS_ARRANGEMENT, oldBusinessArrangement, businessArrangement));
			}
		}
	...
	public void setBusinessArrangement(org.eclipse.mdht.uml.fhir.core.datatype.String newBusinessArrangement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_COVERAGE__BUSINESS_ARRANGEMENT, oldBusinessArrangement, businessArrangement));
	}
	...
	public Coding getRelationship() {
		if (relationship != null && relationship.eIsProxy()) {
			...
			if (relationship != oldRelationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_COVERAGE__RELATIONSHIP, oldRelationship, relationship));
			}
		}
		return relationship;
	}
	...
	public void setRelationship(Coding newRelationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_COVERAGE__RELATIONSHIP, oldRelationship, relationship));
	}
	...
	public EList<org.eclipse.mdht.uml.fhir.core.datatype.String> getPreAuthRefs() {
		if (preAuthRefs == null) {
			preAuthRefs = new EObjectResolvingEList<org.eclipse.mdht.uml.fhir.core.datatype.String>(org.eclipse.mdht.uml.fhir.core.datatype.String.class, this, FhirResourcePackage.CLAIM_COVERAGE__PRE_AUTH_REF);
		}
		return preAuthRefs;
	}
	...
	public ClaimResponse getClaimResponse() {
		if (claimResponse != null && claimResponse.eIsProxy()) {
			...
			if (claimResponse != oldClaimResponse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_COVERAGE__CLAIM_RESPONSE, oldClaimResponse, claimResponse));
			}
		}
	...
	public void setClaimResponse(ClaimResponse newClaimResponse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_COVERAGE__CLAIM_RESPONSE, oldClaimResponse, claimResponse));
	}
	...
	public Coding getOriginalRuleset() {
		if (originalRuleset != null && originalRuleset.eIsProxy()) {
			...
			if (originalRuleset != oldOriginalRuleset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_COVERAGE__ORIGINAL_RULESET, oldOriginalRuleset, originalRuleset));
			}
		}
	...
	public void setOriginalRuleset(Coding newOriginalRuleset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_COVERAGE__ORIGINAL_RULESET, oldOriginalRuleset, originalRuleset));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.CLAIM_COVERAGE__SEQUENCE:
				if (resolve) return getSequence();
				return basicGetSequence();
			case FhirResourcePackage.CLAIM_COVERAGE__FOCAL:
				if (resolve) return getFocal();
				return basicGetFocal();
			case FhirResourcePackage.CLAIM_COVERAGE__COVERAGE:
				if (resolve) return getCoverage();
				return basicGetCoverage();
			case FhirResourcePackage.CLAIM_COVERAGE__BUSINESS_ARRANGEMENT:
				if (resolve) return getBusinessArrangement();
				return basicGetBusinessArrangement();
			case FhirResourcePackage.CLAIM_COVERAGE__RELATIONSHIP:
				if (resolve) return getRelationship();
				return basicGetRelationship();
			case FhirResourcePackage.CLAIM_COVERAGE__PRE_AUTH_REF:
				return getPreAuthRefs();
			case FhirResourcePackage.CLAIM_COVERAGE__CLAIM_RESPONSE:
				if (resolve) return getClaimResponse();
				return basicGetClaimResponse();
			case FhirResourcePackage.CLAIM_COVERAGE__ORIGINAL_RULESET:
