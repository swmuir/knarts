...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Device Use Request Status</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.mdht.uml.fhir.core.valueset.FhirValuesetPackage#getDeviceUseRequestStatus()
 * @model
 * @generated
 */
public enum DeviceUseRequestStatus implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Device Use Request Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DeviceUseRequestStatus[] VALUES_ARRAY =
		new DeviceUseRequestStatus[] {
			PROPOSED,
			PLANNED,
			REQUESTED,
			RECEIVED,
	...
	/**
	 * A public read-only list of all the '<em><b>Device Use Request Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DeviceUseRequestStatus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Device Use Request Status</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DeviceUseRequestStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DeviceUseRequestStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Device Use Request Status</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static DeviceUseRequestStatus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DeviceUseRequestStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Device Use Request Status</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DeviceUseRequestStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DeviceUseRequestStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
