 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.DecimalImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecimalImpl extends DataTypeImpl implements Decimal {
	...
	protected EClass eStaticClass() {
		return FhirDatatypePackage.Literals.DECIMAL;
	}
	...
	public void setValue(BigDecimal newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirDatatypePackage.DECIMAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirDatatypePackage.DECIMAL__VALUE:
				return getValue();
		}
