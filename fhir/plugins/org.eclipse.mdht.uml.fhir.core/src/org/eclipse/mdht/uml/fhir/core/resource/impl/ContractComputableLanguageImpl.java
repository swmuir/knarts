 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ContractComputableLanguageImpl#getContentx <em>Contentx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractComputableLanguageImpl extends BackboneElementImpl implements ContractComputableLanguage {
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getContractComputableLanguage();
	}
		...
		if (contentx != null && contentx.eIsProxy()) {
			...
			if (contentx != oldContentx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CONTRACT_COMPUTABLE_LANGUAGE__CONTENTX, oldContentx, contentx));
			}
		}
		return contentx;
	}
	...
	public void setContentx(Base newContentx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CONTRACT_COMPUTABLE_LANGUAGE__CONTENTX, oldContentx, contentx));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.CONTRACT_COMPUTABLE_LANGUAGE__CONTENTX:
