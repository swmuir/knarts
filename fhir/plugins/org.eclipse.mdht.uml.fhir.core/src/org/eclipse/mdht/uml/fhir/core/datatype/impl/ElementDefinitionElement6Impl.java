 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.ElementDefinitionElement6Impl#getIdentity <em>Identity</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.ElementDefinitionElement6Impl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.ElementDefinitionElement6Impl#getMap <em>Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementDefinitionElement6Impl extends ElementImpl implements ElementDefinitionElement6 {
	...
	protected EClass eStaticClass() {
		return FhirDatatypePackage.Literals.ELEMENT_DEFINITION_ELEMENT6;
	}
		...
		if (identity != null && identity.eIsProxy()) {
			...
			if (identity != oldIdentity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirDatatypePackage.ELEMENT_DEFINITION_ELEMENT6__IDENTITY, oldIdentity, identity));
			}
		}
		return identity;
	}
	...
	public void setIdentity(Id newIdentity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirDatatypePackage.ELEMENT_DEFINITION_ELEMENT6__IDENTITY, oldIdentity, identity));
	}
	...
	public Code getLanguage() {
		if (language != null && language.eIsProxy()) {
			...
			if (language != oldLanguage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirDatatypePackage.ELEMENT_DEFINITION_ELEMENT6__LANGUAGE, oldLanguage, language));
			}
		}
		return language;
	}
	...
	public void setLanguage(Code newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirDatatypePackage.ELEMENT_DEFINITION_ELEMENT6__LANGUAGE, oldLanguage, language));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.datatype.String getMap() {
		if (map != null && map.eIsProxy()) {
			...
			if (map != oldMap) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirDatatypePackage.ELEMENT_DEFINITION_ELEMENT6__MAP, oldMap, map));
			}
		}
		return map;
	}
	...
	public void setMap(org.eclipse.mdht.uml.fhir.core.datatype.String newMap) {
		...
		map = newMap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirDatatypePackage.ELEMENT_DEFINITION_ELEMENT6__MAP, oldMap, map));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirDatatypePackage.ELEMENT_DEFINITION_ELEMENT6__IDENTITY:
				if (resolve) return getIdentity();
				return basicGetIdentity();
			case FhirDatatypePackage.ELEMENT_DEFINITION_ELEMENT6__LANGUAGE:
				if (resolve) return getLanguage();
				return basicGetLanguage();
			case FhirDatatypePackage.ELEMENT_DEFINITION_ELEMENT6__MAP:
