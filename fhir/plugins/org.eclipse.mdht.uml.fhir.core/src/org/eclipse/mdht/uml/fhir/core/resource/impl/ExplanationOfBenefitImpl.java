 ...
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ExplanationOfBenefitImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ExplanationOfBenefitImpl#getOutcome <em>Outcome</em>}</li>
 ...
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ExplanationOfBenefitImpl#getRequestProvider <em>Request Provider</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ExplanationOfBenefitImpl#getRequestOrganization <em>Request Organization</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplanationOfBenefitImpl extends DomainResourceImpl implements ExplanationOfBenefit {
		...
		if (request != null && request.eIsProxy()) {
			...
			if (request != oldRequest) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.EXPLANATION_OF_BENEFIT__REQUEST, oldRequest, request));
			}
		}
		return request;
	}
	...
	public void setRequest(Claim newRequest) {
		...
		request = newRequest;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.EXPLANATION_OF_BENEFIT__REQUEST, oldRequest, request));
	}
	...
	public Code getOutcome() {
		if (outcome != null && outcome.eIsProxy()) {
			...
			if (outcome != oldOutcome) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.EXPLANATION_OF_BENEFIT__OUTCOME, oldOutcome, outcome));
			}
		}
		return outcome;
	}
	...
	public void setOutcome(Code newOutcome) {
		...
		outcome = newOutcome;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.EXPLANATION_OF_BENEFIT__OUTCOME, oldOutcome, outcome));
	}
	...
	public Practitioner getRequestProvider() {
		if (requestProvider != null && requestProvider.eIsProxy()) {
			...
			if (requestProvider != oldRequestProvider) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.EXPLANATION_OF_BENEFIT__REQUEST_PROVIDER, oldRequestProvider, requestProvider));
			}
		}
	...
	public void setRequestProvider(Practitioner newRequestProvider) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.EXPLANATION_OF_BENEFIT__REQUEST_PROVIDER, oldRequestProvider, requestProvider));
	}
	...
	public Organization getRequestOrganization() {
		if (requestOrganization != null && requestOrganization.eIsProxy()) {
			...
			if (requestOrganization != oldRequestOrganization) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.EXPLANATION_OF_BENEFIT__REQUEST_ORGANIZATION, oldRequestOrganization, requestOrganization));
			}
		}
	...
	public void setRequestOrganization(Organization newRequestOrganization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.EXPLANATION_OF_BENEFIT__REQUEST_ORGANIZATION, oldRequestOrganization, requestOrganization));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FhirResourcePackage.EXPLANATION_OF_BENEFIT__REQUEST:
				if (resolve) return getRequest();
				return basicGetRequest();
			case FhirResourcePackage.EXPLANATION_OF_BENEFIT__OUTCOME:
			...
			case FhirResourcePackage.EXPLANATION_OF_BENEFIT__REQUEST_PROVIDER:
				if (resolve) return getRequestProvider();
				return basicGetRequestProvider();
			case FhirResourcePackage.EXPLANATION_OF_BENEFIT__REQUEST_ORGANIZATION:
