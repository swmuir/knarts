...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Module Definition Data Code Filter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ModuleDefinitionDataCodeFilterImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ModuleDefinitionDataCodeFilterImpl#getValueSetx <em>Value Setx</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ModuleDefinitionDataCodeFilterImpl#getCodeableConcepts <em>Codeable Concept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleDefinitionDataCodeFilterImpl extends BackboneElementImpl implements ModuleDefinitionDataCodeFilter {
	/**
	 ...
	 * @generated
	 */
	protected ModuleDefinitionDataCodeFilterImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getModuleDefinitionDataCodeFilter();
	}
		...
		if (path != null && path.eIsProxy()) {
			...
			if (path != oldPath) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MODULE_DEFINITION_DATA_CODE_FILTER__PATH, oldPath, path));
			}
		}
		return path;
	}
	...
	public void setPath(org.eclipse.mdht.uml.fhir.core.datatype.String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MODULE_DEFINITION_DATA_CODE_FILTER__PATH, oldPath, path));
	}
	...
	public Base getValueSetx() {
		if (valueSetx != null && valueSetx.eIsProxy()) {
			...
			if (valueSetx != oldValueSetx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MODULE_DEFINITION_DATA_CODE_FILTER__VALUE_SETX, oldValueSetx, valueSetx));
			}
		}
		return valueSetx;
	}
	...
	public void setValueSetx(Base newValueSetx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MODULE_DEFINITION_DATA_CODE_FILTER__VALUE_SETX, oldValueSetx, valueSetx));
	}
	...
	public EList<CodeableConcept> getCodeableConcepts() {
		if (codeableConcepts == null) {
			codeableConcepts = new EObjectResolvingEList<CodeableConcept>(CodeableConcept.class, this, FhirResourcePackage.MODULE_DEFINITION_DATA_CODE_FILTER__CODEABLE_CONCEPT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.MODULE_DEFINITION_DATA_CODE_FILTER__PATH:
				if (resolve) return getPath();
				return basicGetPath();
			case FhirResourcePackage.MODULE_DEFINITION_DATA_CODE_FILTER__VALUE_SETX:
				if (resolve) return getValueSetx();
				return basicGetValueSetx();
			case FhirResourcePackage.MODULE_DEFINITION_DATA_CODE_FILTER__CODEABLE_CONCEPT:
...
} //ModuleDefinitionDataCodeFilterImpl
