...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Order Set Participant Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.mdht.uml.fhir.core.valueset.FhirValuesetPackage#getOrderSetParticipantType()
 * @model
 * @generated
 */
public enum OrderSetParticipantType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Order Set Participant Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final OrderSetParticipantType[] VALUES_ARRAY =
		new OrderSetParticipantType[] {
			PATIENT,
			PERSON,
			PRACTITIONER,
			RELATEDPERSON,
	...
	/**
	 * A public read-only list of all the '<em><b>Order Set Participant Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<OrderSetParticipantType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Order Set Participant Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static OrderSetParticipantType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			OrderSetParticipantType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Order Set Participant Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static OrderSetParticipantType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			OrderSetParticipantType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Order Set Participant Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static OrderSetParticipantType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private OrderSetParticipantType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
