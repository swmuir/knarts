 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimMissingTeethImpl#getTooth <em>Tooth</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimMissingTeethImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimMissingTeethImpl#getExtractionDate <em>Extraction Date</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimMissingTeethImpl extends BackboneElementImpl implements ClaimMissingTeeth {
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getClaimMissingTeeth();
	}
		...
		if (tooth != null && tooth.eIsProxy()) {
			...
			if (tooth != oldTooth) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_MISSING_TEETH__TOOTH, oldTooth, tooth));
			}
		}
		return tooth;
	}
	...
	public void setTooth(Coding newTooth) {
		...
		tooth = newTooth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_MISSING_TEETH__TOOTH, oldTooth, tooth));
	}
	...
	public Coding getReason() {
		if (reason != null && reason.eIsProxy()) {
			...
			if (reason != oldReason) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_MISSING_TEETH__REASON, oldReason, reason));
			}
		}
		return reason;
	}
	...
	public void setReason(Coding newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_MISSING_TEETH__REASON, oldReason, reason));
	}
	...
	public Date getExtractionDate() {
		if (extractionDate != null && extractionDate.eIsProxy()) {
			...
			if (extractionDate != oldExtractionDate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_MISSING_TEETH__EXTRACTION_DATE, oldExtractionDate, extractionDate));
			}
		}
	...
	public void setExtractionDate(Date newExtractionDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_MISSING_TEETH__EXTRACTION_DATE, oldExtractionDate, extractionDate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.CLAIM_MISSING_TEETH__TOOTH:
				if (resolve) return getTooth();
				return basicGetTooth();
			case FhirResourcePackage.CLAIM_MISSING_TEETH__REASON:
				if (resolve) return getReason();
				return basicGetReason();
			case FhirResourcePackage.CLAIM_MISSING_TEETH__EXTRACTION_DATE:
