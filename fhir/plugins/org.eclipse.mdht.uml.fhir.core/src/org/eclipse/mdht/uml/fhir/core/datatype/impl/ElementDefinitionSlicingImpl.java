 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.ElementDefinitionSlicingImpl#getDiscriminators <em>Discriminator</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.ElementDefinitionSlicingImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.ElementDefinitionSlicingImpl#getOrdered <em>Ordered</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.ElementDefinitionSlicingImpl#getRules <em>Rules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementDefinitionSlicingImpl extends BackboneElementImpl implements ElementDefinitionSlicing {
	...
	protected EClass eStaticClass() {
		return FhirDatatypePackage.Literals.ELEMENT_DEFINITION_SLICING;
	}
	...
	public EList<org.eclipse.mdht.uml.fhir.core.datatype.String> getDiscriminators() {
		if (discriminators == null) {
			discriminators = new EObjectResolvingEList<org.eclipse.mdht.uml.fhir.core.datatype.String>(org.eclipse.mdht.uml.fhir.core.datatype.String.class, this, FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__DISCRIMINATOR);
		}
		...
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(org.eclipse.mdht.uml.fhir.core.datatype.String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__DESCRIPTION, oldDescription, description));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.datatype.Boolean getOrdered() {
		if (ordered != null && ordered.eIsProxy()) {
			...
			if (ordered != oldOrdered) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__ORDERED, oldOrdered, ordered));
			}
		}
		return ordered;
	}
	...
	public void setOrdered(org.eclipse.mdht.uml.fhir.core.datatype.Boolean newOrdered) {
		...
		ordered = newOrdered;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__ORDERED, oldOrdered, ordered));
	}
	...
	public Code getRules() {
		if (rules != null && rules.eIsProxy()) {
			...
			if (rules != oldRules) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__RULES, oldRules, rules));
			}
		}
		return rules;
	}
	...
	public void setRules(Code newRules) {
		...
		rules = newRules;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__RULES, oldRules, rules));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__DISCRIMINATOR:
				return getDiscriminators();
			case FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__DESCRIPTION:
				if (resolve) return getDescription();
				return basicGetDescription();
			case FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__ORDERED:
				if (resolve) return getOrdered();
				return basicGetOrdered();
			case FhirDatatypePackage.ELEMENT_DEFINITION_SLICING__RULES:
