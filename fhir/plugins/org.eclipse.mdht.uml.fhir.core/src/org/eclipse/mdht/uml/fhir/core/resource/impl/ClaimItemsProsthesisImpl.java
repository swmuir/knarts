...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Claim Items Prosthesis</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimItemsProsthesisImpl#getInitial <em>Initial</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimItemsProsthesisImpl#getPriorDate <em>Prior Date</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ClaimItemsProsthesisImpl#getPriorMaterial <em>Prior Material</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimItemsProsthesisImpl extends BackboneElementImpl implements ClaimItemsProsthesis {
	/**
	 ...
	 * @generated
	 */
	protected ClaimItemsProsthesisImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getClaimItemsProsthesis();
	}
		...
		if (initial != null && initial.eIsProxy()) {
			...
			if (initial != oldInitial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_ITEMS_PROSTHESIS__INITIAL, oldInitial, initial));
			}
		}
		return initial;
	}
	...
	public void setInitial(org.eclipse.mdht.uml.fhir.core.datatype.Boolean newInitial) {
		...
		initial = newInitial;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_ITEMS_PROSTHESIS__INITIAL, oldInitial, initial));
	}
	...
	public Date getPriorDate() {
		if (priorDate != null && priorDate.eIsProxy()) {
			...
			if (priorDate != oldPriorDate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_ITEMS_PROSTHESIS__PRIOR_DATE, oldPriorDate, priorDate));
			}
		}
		return priorDate;
	}
	...
	public void setPriorDate(Date newPriorDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_ITEMS_PROSTHESIS__PRIOR_DATE, oldPriorDate, priorDate));
	}
	...
	public Coding getPriorMaterial() {
		if (priorMaterial != null && priorMaterial.eIsProxy()) {
			...
			if (priorMaterial != oldPriorMaterial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CLAIM_ITEMS_PROSTHESIS__PRIOR_MATERIAL, oldPriorMaterial, priorMaterial));
			}
		}
	...
	public void setPriorMaterial(Coding newPriorMaterial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CLAIM_ITEMS_PROSTHESIS__PRIOR_MATERIAL, oldPriorMaterial, priorMaterial));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.CLAIM_ITEMS_PROSTHESIS__INITIAL:
				if (resolve) return getInitial();
				return basicGetInitial();
			case FhirResourcePackage.CLAIM_ITEMS_PROSTHESIS__PRIOR_DATE:
				if (resolve) return getPriorDate();
				return basicGetPriorDate();
			case FhirResourcePackage.CLAIM_ITEMS_PROSTHESIS__PRIOR_MATERIAL:
