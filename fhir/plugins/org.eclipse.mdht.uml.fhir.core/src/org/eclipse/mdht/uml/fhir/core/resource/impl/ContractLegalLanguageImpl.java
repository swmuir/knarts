 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ContractLegalLanguageImpl#getContentx <em>Contentx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractLegalLanguageImpl extends BackboneElementImpl implements ContractLegalLanguage {
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getContractLegalLanguage();
	}
		...
		if (contentx != null && contentx.eIsProxy()) {
			...
			if (contentx != oldContentx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.CONTRACT_LEGAL_LANGUAGE__CONTENTX, oldContentx, contentx));
			}
		}
		return contentx;
	}
	...
	public void setContentx(Base newContentx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.CONTRACT_LEGAL_LANGUAGE__CONTENTX, oldContentx, contentx));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.CONTRACT_LEGAL_LANGUAGE__CONTENTX:
