 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getAdditionalInstructions <em>Additional Instructions</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getTiming <em>Timing</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getAsNeededx <em>As Neededx</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getSitex <em>Sitex</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getRoute <em>Route</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getDosex <em>Dosex</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getRatex <em>Ratex</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.MedicationOrderDosageInstructionImpl#getMaxDosePerPeriod <em>Max Dose Per Period</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicationOrderDosageInstructionImpl extends BackboneElementImpl implements MedicationOrderDosageInstruction {
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getMedicationOrderDosageInstruction();
	}
		...
		if (text != null && text.eIsProxy()) {
			...
			if (text != oldText) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__TEXT, oldText, text));
			}
		}
		return text;
	}
	...
	public void setText(org.eclipse.mdht.uml.fhir.core.datatype.String newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__TEXT, oldText, text));
	}
	...
	public CodeableConcept getAdditionalInstructions() {
		if (additionalInstructions != null && additionalInstructions.eIsProxy()) {
			...
			if (additionalInstructions != oldAdditionalInstructions) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__ADDITIONAL_INSTRUCTIONS, oldAdditionalInstructions, additionalInstructions));
			}
		}
	...
	public void setAdditionalInstructions(CodeableConcept newAdditionalInstructions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__ADDITIONAL_INSTRUCTIONS, oldAdditionalInstructions, additionalInstructions));
	}
	...
	public Timing getTiming() {
		if (timing != null && timing.eIsProxy()) {
			...
			if (timing != oldTiming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__TIMING, oldTiming, timing));
			}
		}
		return timing;
	}
	...
	public void setTiming(Timing newTiming) {
		...
		timing = newTiming;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__TIMING, oldTiming, timing));
	}
	...
	public DataType getAsNeededx() {
		if (asNeededx != null && asNeededx.eIsProxy()) {
			...
			if (asNeededx != oldAsNeededx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__AS_NEEDEDX, oldAsNeededx, asNeededx));
			}
		}
		return asNeededx;
	}
	...
	public void setAsNeededx(DataType newAsNeededx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__AS_NEEDEDX, oldAsNeededx, asNeededx));
	}
	...
	public Base getSitex() {
		if (sitex != null && sitex.eIsProxy()) {
			...
			if (sitex != oldSitex) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__SITEX, oldSitex, sitex));
			}
		}
		return sitex;
	}
	...
	public void setSitex(Base newSitex) {
		...
		sitex = newSitex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__SITEX, oldSitex, sitex));
	}
	...
	public CodeableConcept getRoute() {
		if (route != null && route.eIsProxy()) {
			...
			if (route != oldRoute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__ROUTE, oldRoute, route));
			}
		}
		return route;
	}
	...
	public void setRoute(CodeableConcept newRoute) {
		...
		route = newRoute;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__ROUTE, oldRoute, route));
	}
	...
	public CodeableConcept getMethod() {
		if (method != null && method.eIsProxy()) {
			...
			if (method != oldMethod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__METHOD, oldMethod, method));
			}
		}
		return method;
	}
	...
	public void setMethod(CodeableConcept newMethod) {
		...
		method = newMethod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__METHOD, oldMethod, method));
	}
	...
	public DataType getDosex() {
		if (dosex != null && dosex.eIsProxy()) {
			...
			if (dosex != oldDosex) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__DOSEX, oldDosex, dosex));
			}
		}
		return dosex;
	}
	...
	public void setDosex(DataType newDosex) {
		...
		dosex = newDosex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__DOSEX, oldDosex, dosex));
	}
	...
	public DataType getRatex() {
		if (ratex != null && ratex.eIsProxy()) {
			...
			if (ratex != oldRatex) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__RATEX, oldRatex, ratex));
			}
		}
		return ratex;
	}
	...
	public void setRatex(DataType newRatex) {
		...
		ratex = newRatex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__RATEX, oldRatex, ratex));
	}
	...
	public Ratio getMaxDosePerPeriod() {
		if (maxDosePerPeriod != null && maxDosePerPeriod.eIsProxy()) {
			...
			if (maxDosePerPeriod != oldMaxDosePerPeriod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__MAX_DOSE_PER_PERIOD, oldMaxDosePerPeriod, maxDosePerPeriod));
			}
		}
	...
	public void setMaxDosePerPeriod(Ratio newMaxDosePerPeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__MAX_DOSE_PER_PERIOD, oldMaxDosePerPeriod, maxDosePerPeriod));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__TEXT:
				if (resolve) return getText();
				return basicGetText();
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__ADDITIONAL_INSTRUCTIONS:
				if (resolve) return getAdditionalInstructions();
				return basicGetAdditionalInstructions();
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__TIMING:
				if (resolve) return getTiming();
				return basicGetTiming();
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__AS_NEEDEDX:
				if (resolve) return getAsNeededx();
				return basicGetAsNeededx();
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__SITEX:
				if (resolve) return getSitex();
				return basicGetSitex();
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__ROUTE:
				if (resolve) return getRoute();
				return basicGetRoute();
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__METHOD:
				if (resolve) return getMethod();
				return basicGetMethod();
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__DOSEX:
				if (resolve) return getDosex();
				return basicGetDosex();
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__RATEX:
				if (resolve) return getRatex();
				return basicGetRatex();
			case FhirResourcePackage.MEDICATION_ORDER_DOSAGE_INSTRUCTION__MAX_DOSE_PER_PERIOD:
