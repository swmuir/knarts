...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Relationship Codes</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.mdht.uml.fhir.core.valueset.FhirValuesetPackage#getRelationshipCodes()
 * @model annotation="http://www.eclipse.org/uml2/2.0.0/UML originalName='Relationship Codes'"
 * @generated
 */
public enum RelationshipCodes implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Relationship Codes</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RelationshipCodes[] VALUES_ARRAY =
		new RelationshipCodes[] {
			_1,
			_2,
			_3,
			_4,
	...
	/**
	 * A public read-only list of all the '<em><b>Relationship Codes</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RelationshipCodes> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Relationship Codes</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RelationshipCodes get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RelationshipCodes result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Relationship Codes</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static RelationshipCodes getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RelationshipCodes result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Relationship Codes</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RelationshipCodes get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private RelationshipCodes(int value, String name, String literal) {
		this.value = value;
		this.name = name;
