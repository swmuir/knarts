 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.DataElementMappingImpl#getIdentity <em>Identity</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.DataElementMappingImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.DataElementMappingImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.DataElementMappingImpl#getComments <em>Comments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataElementMappingImpl extends BackboneElementImpl implements DataElementMapping {
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getDataElementMapping();
	}
		...
		if (identity != null && identity.eIsProxy()) {
			...
			if (identity != oldIdentity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.DATA_ELEMENT_MAPPING__IDENTITY, oldIdentity, identity));
			}
		}
		return identity;
	}
	...
	public void setIdentity(Id newIdentity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.DATA_ELEMENT_MAPPING__IDENTITY, oldIdentity, identity));
	}
	...
	public Uri getUri() {
		if (uri != null && uri.eIsProxy()) {
			...
			if (uri != oldUri) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.DATA_ELEMENT_MAPPING__URI, oldUri, uri));
			}
		}
		return uri;
	}
	...
	public void setUri(Uri newUri) {
		...
		uri = newUri;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.DATA_ELEMENT_MAPPING__URI, oldUri, uri));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.datatype.String getName() {
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.DATA_ELEMENT_MAPPING__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public void setName(org.eclipse.mdht.uml.fhir.core.datatype.String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.DATA_ELEMENT_MAPPING__NAME, oldName, name));
	}
	...
	public org.eclipse.mdht.uml.fhir.core.datatype.String getComments() {
		if (comments != null && comments.eIsProxy()) {
			...
			if (comments != oldComments) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.DATA_ELEMENT_MAPPING__COMMENTS, oldComments, comments));
			}
		}
		return comments;
	}
	...
	public void setComments(org.eclipse.mdht.uml.fhir.core.datatype.String newComments) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.DATA_ELEMENT_MAPPING__COMMENTS, oldComments, comments));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.DATA_ELEMENT_MAPPING__IDENTITY:
				if (resolve) return getIdentity();
				return basicGetIdentity();
			case FhirResourcePackage.DATA_ELEMENT_MAPPING__URI:
				if (resolve) return getUri();
				return basicGetUri();
			case FhirResourcePackage.DATA_ELEMENT_MAPPING__NAME:
				if (resolve) return getName();
				return basicGetName();
			case FhirResourcePackage.DATA_ELEMENT_MAPPING__COMMENTS:
