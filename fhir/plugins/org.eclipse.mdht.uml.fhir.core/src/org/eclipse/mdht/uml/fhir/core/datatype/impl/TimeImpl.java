 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.datatype.impl.TimeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeImpl extends DataTypeImpl implements Time {
	...
	protected EClass eStaticClass() {
		return FhirDatatypePackage.Literals.TIME;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirDatatypePackage.TIME__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirDatatypePackage.TIME__VALUE:
				return getValue();
		}
