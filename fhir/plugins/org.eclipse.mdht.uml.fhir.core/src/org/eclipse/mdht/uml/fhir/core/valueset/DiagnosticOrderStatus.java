...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Diagnostic Order Status</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.mdht.uml.fhir.core.valueset.FhirValuesetPackage#getDiagnosticOrderStatus()
 * @model
 * @generated
 */
public enum DiagnosticOrderStatus implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	INPROGRESS(6, "inprogress", "inprogress"),
	 ...
	 * @ordered
	 */
	public static final int INPROGRESS_VALUE = 6;
	...
	/**
	 * An array of all the '<em><b>Diagnostic Order Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DiagnosticOrderStatus[] VALUES_ARRAY =
		new DiagnosticOrderStatus[] {
			PROPOSED,
			DRAFT,
			PLANNED,
			REQUESTED,
	...
	/**
	 * A public read-only list of all the '<em><b>Diagnostic Order Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DiagnosticOrderStatus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Diagnostic Order Status</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DiagnosticOrderStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DiagnosticOrderStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Diagnostic Order Status</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static DiagnosticOrderStatus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DiagnosticOrderStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Diagnostic Order Status</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DiagnosticOrderStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DiagnosticOrderStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
