 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.TestScriptDestinationImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.TestScriptDestinationImpl#getProfile <em>Profile</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestScriptDestinationImpl extends BackboneElementImpl implements TestScriptDestination {
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getTestScriptDestination();
	}
		...
		if (index != null && index.eIsProxy()) {
			...
			if (index != oldIndex) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.TEST_SCRIPT_DESTINATION__INDEX, oldIndex, index));
			}
		}
		return index;
	}
	...
	public void setIndex(org.eclipse.mdht.uml.fhir.core.datatype.Integer newIndex) {
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.TEST_SCRIPT_DESTINATION__INDEX, oldIndex, index));
	}
	...
	public Code getProfile() {
		if (profile != null && profile.eIsProxy()) {
			...
			if (profile != oldProfile) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.TEST_SCRIPT_DESTINATION__PROFILE, oldProfile, profile));
			}
		}
		return profile;
	}
	...
	public void setProfile(Code newProfile) {
		...
		profile = newProfile;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.TEST_SCRIPT_DESTINATION__PROFILE, oldProfile, profile));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.TEST_SCRIPT_DESTINATION__INDEX:
				if (resolve) return getIndex();
				return basicGetIndex();
			case FhirResourcePackage.TEST_SCRIPT_DESTINATION__PROFILE:
