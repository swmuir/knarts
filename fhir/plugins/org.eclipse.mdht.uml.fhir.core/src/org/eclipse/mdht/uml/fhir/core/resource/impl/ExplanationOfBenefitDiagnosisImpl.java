 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ExplanationOfBenefitDiagnosisImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.ExplanationOfBenefitDiagnosisImpl#getDiagnosis <em>Diagnosis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplanationOfBenefitDiagnosisImpl extends BackboneElementImpl implements ExplanationOfBenefitDiagnosis {
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getExplanationOfBenefitDiagnosis();
	}
		...
		if (sequence != null && sequence.eIsProxy()) {
			...
			if (sequence != oldSequence) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__SEQUENCE, oldSequence, sequence));
			}
		}
		return sequence;
	}
	...
	public void setSequence(PositiveInt newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__SEQUENCE, oldSequence, sequence));
	}
	...
	public Coding getDiagnosis() {
		if (diagnosis != null && diagnosis.eIsProxy()) {
			...
			if (diagnosis != oldDiagnosis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__DIAGNOSIS, oldDiagnosis, diagnosis));
			}
		}
		return diagnosis;
	}
	...
	public void setDiagnosis(Coding newDiagnosis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__DIAGNOSIS, oldDiagnosis, diagnosis));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__SEQUENCE:
				if (resolve) return getSequence();
				return basicGetSequence();
			case FhirResourcePackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__DIAGNOSIS:
