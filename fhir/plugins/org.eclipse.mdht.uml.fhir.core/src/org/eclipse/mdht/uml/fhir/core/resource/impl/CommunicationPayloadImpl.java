 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.fhir.core.resource.impl.CommunicationPayloadImpl#getContentx <em>Contentx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunicationPayloadImpl extends BackboneElementImpl implements CommunicationPayload {
	...
	protected EClass eStaticClass() {
		return FhirResourcePackage.eINSTANCE.getCommunicationPayload();
	}
		...
		if (contentx != null && contentx.eIsProxy()) {
			...
			if (contentx != oldContentx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FhirResourcePackage.COMMUNICATION_PAYLOAD__CONTENTX, oldContentx, contentx));
			}
		}
		return contentx;
	}
	...
	public void setContentx(Base newContentx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirResourcePackage.COMMUNICATION_PAYLOAD__CONTENTX, oldContentx, contentx));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirResourcePackage.COMMUNICATION_PAYLOAD__CONTENTX:
