...
import org.eclipse.mdht.hl7.fhir.resources.MolecularSequence;
...
import org.eclipse.mdht.hl7.fhir.resources.MolecularSequenceStructureVariant;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getCoordinateSystem <em>Coordinate System</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getSpecimen <em>Specimen</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getReferenceSeq <em>Reference Seq</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getVariants <em>Variant</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getObservedSeq <em>Observed Seq</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getQualities <em>Quality</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getReadCoverage <em>Read Coverage</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getRepositories <em>Repository</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getPointers <em>Pointer</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MolecularSequenceImpl#getStructureVariants <em>Structure Variant</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MolecularSequenceImpl extends DomainResourceImpl implements MolecularSequence {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Integer coordinateSystem;
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.String observedSeq;
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Integer readCoverage;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Integer getCoordinateSystem() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCoordinateSystem(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newCoordinateSystem, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Integer oldCoordinateSystem = coordinateSystem;
	 ...
	 */
	@Override
	public void setCoordinateSystem(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newCoordinateSystem) {
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.String getObservedSeq() {
		return observedSeq;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetObservedSeq(org.eclipse.mdht.hl7.fhir.dataTypes.String newObservedSeq, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.String oldObservedSeq = observedSeq;
	 ...
	 */
	@Override
	public void setObservedSeq(org.eclipse.mdht.hl7.fhir.dataTypes.String newObservedSeq) {
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Integer getReadCoverage() {
		return readCoverage;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetReadCoverage(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newReadCoverage, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Integer oldReadCoverage = readCoverage;
	 ...
	 */
	@Override
	public void setReadCoverage(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newReadCoverage) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.MOLECULAR_SEQUENCE__TYPE:
				...
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__COORDINATE_SYSTEM:
				setCoordinateSystem((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)newValue);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__PATIENT:
			...
			case ResourcesPackage.MOLECULAR_SEQUENCE__VARIANT:
				...
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__OBSERVED_SEQ:
				setObservedSeq((org.eclipse.mdht.hl7.fhir.dataTypes.String)newValue);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__QUALITY:
				getQualities().clear();
				...
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__READ_COVERAGE:
				setReadCoverage((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)newValue);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__REPOSITORY:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.MOLECULAR_SEQUENCE__TYPE:
				...
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__COORDINATE_SYSTEM:
				setCoordinateSystem((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)null);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__PATIENT:
			...
			case ResourcesPackage.MOLECULAR_SEQUENCE__VARIANT:
				...
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__OBSERVED_SEQ:
				setObservedSeq((org.eclipse.mdht.hl7.fhir.dataTypes.String)null);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__QUALITY:
				getQualities().clear();
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__READ_COVERAGE:
				setReadCoverage((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)null);
				return;
			case ResourcesPackage.MOLECULAR_SEQUENCE__REPOSITORY:
				getRepositories().clear();
				return;
