 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ElementDefinitionElement1Impl#getDiscriminators <em>Discriminator</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ElementDefinitionElement1Impl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ElementDefinitionElement1Impl#getOrdered <em>Ordered</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ElementDefinitionElement1Impl#getRules <em>Rules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementDefinitionElement1Impl extends ElementImpl implements ElementDefinitionElement1 {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Boolean ordered;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Boolean getOrdered() {
		return ordered;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOrdered(org.eclipse.mdht.hl7.fhir.dataTypes.Boolean newOrdered, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Boolean oldOrdered = ordered;
		ordered = newOrdered;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setOrdered(org.eclipse.mdht.hl7.fhir.dataTypes.Boolean newOrdered) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT1__DESCRIPTION:
				...
				return;
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT1__ORDERED:
				setOrdered((org.eclipse.mdht.hl7.fhir.dataTypes.Boolean)newValue);
				return;
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT1__RULES:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT1__DESCRIPTION:
				...
				return;
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT1__ORDERED:
				setOrdered((org.eclipse.mdht.hl7.fhir.dataTypes.Boolean)null);
				return;
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT1__RULES:
				setRules((Code)null);
				return;
