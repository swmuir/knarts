...
import org.eclipse.mdht.hl7.fhir.resources.OperationOutcomeIssue;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.OperationOutcomeIssueImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.OperationOutcomeIssueImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.OperationOutcomeIssueImpl#getDetails <em>Details</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.OperationOutcomeIssueImpl#getDiagnostics <em>Diagnostics</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.OperationOutcomeIssueImpl#getLocations <em>Location</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.OperationOutcomeIssueImpl#getExpressions <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationOutcomeIssueImpl extends BackboneElementImpl implements OperationOutcomeIssue {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.String diagnostics;
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> locations;
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> expressions;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.String getDiagnostics() {
		return diagnostics;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDiagnostics(org.eclipse.mdht.hl7.fhir.dataTypes.String newDiagnostics, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.String oldDiagnostics = diagnostics;
	 ...
	 */
	@Override
	public void setDiagnostics(org.eclipse.mdht.hl7.fhir.dataTypes.String newDiagnostics) {
	 ...
	 */
	@Override
	public EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> getLocations() {
		if (locations == null) {
			locations = new EObjectContainmentEList<org.eclipse.mdht.hl7.fhir.dataTypes.String>(org.eclipse.mdht.hl7.fhir.dataTypes.String.class, this, ResourcesPackage.OPERATION_OUTCOME_ISSUE__LOCATION);
		}
		return locations;
	}
	 ...
	 */
	@Override
	public EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<org.eclipse.mdht.hl7.fhir.dataTypes.String>(org.eclipse.mdht.hl7.fhir.dataTypes.String.class, this, ResourcesPackage.OPERATION_OUTCOME_ISSUE__EXPRESSION);
		}
		return expressions;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.OPERATION_OUTCOME_ISSUE__DETAILS:
				...
				return;
			case ResourcesPackage.OPERATION_OUTCOME_ISSUE__DIAGNOSTICS:
				setDiagnostics((org.eclipse.mdht.hl7.fhir.dataTypes.String)newValue);
				return;
			case ResourcesPackage.OPERATION_OUTCOME_ISSUE__LOCATION:
				getLocations().clear();
				getLocations().addAll((Collection<? extends org.eclipse.mdht.hl7.fhir.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.OPERATION_OUTCOME_ISSUE__EXPRESSION:
				getExpressions().clear();
				getExpressions().addAll((Collection<? extends org.eclipse.mdht.hl7.fhir.dataTypes.String>)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.OPERATION_OUTCOME_ISSUE__DETAILS:
				...
				return;
			case ResourcesPackage.OPERATION_OUTCOME_ISSUE__DIAGNOSTICS:
				setDiagnostics((org.eclipse.mdht.hl7.fhir.dataTypes.String)null);
				return;
			case ResourcesPackage.OPERATION_OUTCOME_ISSUE__LOCATION:
				getLocations().clear();
				return;
