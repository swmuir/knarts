...
import org.eclipse.mdht.hl7.fhir.resources.Goal;
import org.eclipse.mdht.hl7.fhir.resources.GoalTarget;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getLifecycleStatus <em>Lifecycle Status</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getAchievementStatus <em>Achievement Status</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getCategories <em>Category</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getStartx <em>Startx</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getTargets <em>Target</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getStatusDate <em>Status Date</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getStatusReason <em>Status Reason</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getExpressedBy <em>Expressed By</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getOutcomeCodes <em>Outcome Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.GoalImpl#getOutcomeReferences <em>Outcome Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GoalImpl extends DomainResourceImpl implements Goal {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.String statusReason;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.String getStatusReason() {
		return statusReason;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStatusReason(org.eclipse.mdht.hl7.fhir.dataTypes.String newStatusReason, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.String oldStatusReason = statusReason;
	 ...
	 */
	@Override
	public void setStatusReason(org.eclipse.mdht.hl7.fhir.dataTypes.String newStatusReason) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.GOAL__STATUS_DATE:
				...
				return;
			case ResourcesPackage.GOAL__STATUS_REASON:
				setStatusReason((org.eclipse.mdht.hl7.fhir.dataTypes.String)newValue);
				return;
			case ResourcesPackage.GOAL__EXPRESSED_BY:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.GOAL__STATUS_DATE:
				...
				return;
			case ResourcesPackage.GOAL__STATUS_REASON:
				setStatusReason((org.eclipse.mdht.hl7.fhir.dataTypes.String)null);
				return;
			case ResourcesPackage.GOAL__EXPRESSED_BY:
