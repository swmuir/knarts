...
import org.eclipse.mdht.hl7.fhir.resources.MedicationKnowledgeRegulatorySubstitution;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicationKnowledgeRegulatorySubstitutionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicationKnowledgeRegulatorySubstitutionImpl#getAllowed <em>Allowed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicationKnowledgeRegulatorySubstitutionImpl extends BackboneElementImpl implements MedicationKnowledgeRegulatorySubstitution {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Boolean allowed;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Boolean getAllowed() {
		return allowed;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAllowed(org.eclipse.mdht.hl7.fhir.dataTypes.Boolean newAllowed, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Boolean oldAllowed = allowed;
		allowed = newAllowed;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setAllowed(org.eclipse.mdht.hl7.fhir.dataTypes.Boolean newAllowed) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.MEDICATION_KNOWLEDGE_REGULATORY_SUBSTITUTION__TYPE:
				...
				return;
			case ResourcesPackage.MEDICATION_KNOWLEDGE_REGULATORY_SUBSTITUTION__ALLOWED:
				setAllowed((org.eclipse.mdht.hl7.fhir.dataTypes.Boolean)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.MEDICATION_KNOWLEDGE_REGULATORY_SUBSTITUTION__TYPE:
				...
				return;
			case ResourcesPackage.MEDICATION_KNOWLEDGE_REGULATORY_SUBSTITUTION__ALLOWED:
				setAllowed((org.eclipse.mdht.hl7.fhir.dataTypes.Boolean)null);
				return;
		}
