 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.CapabilityStatementRestSecurityImpl#getCors <em>Cors</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.CapabilityStatementRestSecurityImpl#getServices <em>Service</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.CapabilityStatementRestSecurityImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapabilityStatementRestSecurityImpl extends BackboneElementImpl implements CapabilityStatementRestSecurity {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Boolean cors;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Boolean getCors() {
		return cors;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCors(org.eclipse.mdht.hl7.fhir.dataTypes.Boolean newCors, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Boolean oldCors = cors;
		cors = newCors;
	 ...
	 */
	@Override
	public void setCors(org.eclipse.mdht.hl7.fhir.dataTypes.Boolean newCors) {
		if (newCors != cors) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.CAPABILITY_STATEMENT_REST_SECURITY__CORS:
				setCors((org.eclipse.mdht.hl7.fhir.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.CAPABILITY_STATEMENT_REST_SECURITY__SERVICE:
				getServices().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.CAPABILITY_STATEMENT_REST_SECURITY__CORS:
				setCors((org.eclipse.mdht.hl7.fhir.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.CAPABILITY_STATEMENT_REST_SECURITY__SERVICE:
				getServices().clear();
				return;
