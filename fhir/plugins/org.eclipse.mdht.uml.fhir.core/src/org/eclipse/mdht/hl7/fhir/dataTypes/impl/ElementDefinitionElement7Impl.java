 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ElementDefinitionElement7Impl#getIdentity <em>Identity</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ElementDefinitionElement7Impl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ElementDefinitionElement7Impl#getMap <em>Map</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ElementDefinitionElement7Impl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementDefinitionElement7Impl extends ElementImpl implements ElementDefinitionElement7 {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.String map;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.String getMap() {
		return map;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMap(org.eclipse.mdht.hl7.fhir.dataTypes.String newMap, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.String oldMap = map;
		map = newMap;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setMap(org.eclipse.mdht.hl7.fhir.dataTypes.String newMap) {
		if (newMap != map) {
			NotificationChain msgs = null;
			if (map != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT7__LANGUAGE:
				...
				return;
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT7__MAP:
				setMap((org.eclipse.mdht.hl7.fhir.dataTypes.String)newValue);
				return;
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT7__COMMENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT7__LANGUAGE:
				...
				return;
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT7__MAP:
				setMap((org.eclipse.mdht.hl7.fhir.dataTypes.String)null);
				return;
			case DataTypesPackage.ELEMENT_DEFINITION_ELEMENT7__COMMENT:
