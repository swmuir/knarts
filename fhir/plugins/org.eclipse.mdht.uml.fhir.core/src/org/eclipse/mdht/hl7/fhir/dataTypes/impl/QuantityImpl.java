 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.QuantityImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.QuantityImpl#getComparator <em>Comparator</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.QuantityImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.QuantityImpl#getSystem <em>System</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.QuantityImpl#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QuantityImpl extends DataTypeImpl implements Quantity {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.String unit;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.String getUnit() {
		return unit;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetUnit(org.eclipse.mdht.hl7.fhir.dataTypes.String newUnit, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.String oldUnit = unit;
		unit = newUnit;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setUnit(org.eclipse.mdht.hl7.fhir.dataTypes.String newUnit) {
		if (newUnit != unit) {
			NotificationChain msgs = null;
			if (unit != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DataTypesPackage.QUANTITY__COMPARATOR:
				...
				return;
			case DataTypesPackage.QUANTITY__UNIT:
				setUnit((org.eclipse.mdht.hl7.fhir.dataTypes.String)newValue);
				return;
			case DataTypesPackage.QUANTITY__SYSTEM:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case DataTypesPackage.QUANTITY__COMPARATOR:
				...
				return;
			case DataTypesPackage.QUANTITY__UNIT:
				setUnit((org.eclipse.mdht.hl7.fhir.dataTypes.String)null);
				return;
			case DataTypesPackage.QUANTITY__SYSTEM:
				setSystem((Uri)null);
				return;
