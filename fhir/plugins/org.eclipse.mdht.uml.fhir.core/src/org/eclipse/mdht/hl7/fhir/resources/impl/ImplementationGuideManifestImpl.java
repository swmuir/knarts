...
import org.eclipse.mdht.hl7.fhir.resources.ImplementationGuideManifestManifestPage;
import org.eclipse.mdht.hl7.fhir.resources.ImplementationGuideManifestManifestResource;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ImplementationGuideManifestImpl#getRendering <em>Rendering</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ImplementationGuideManifestImpl#getResources <em>Resource</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ImplementationGuideManifestImpl#getPages <em>Page</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ImplementationGuideManifestImpl#getImages <em>Image</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ImplementationGuideManifestImpl#getOthers <em>Other</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplementationGuideManifestImpl extends BackboneElementImpl implements ImplementationGuideManifest {
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> images;
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> others;
	 ...
	 */
	@Override
	public EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> getImages() {
		if (images == null) {
			images = new EObjectContainmentEList<org.eclipse.mdht.hl7.fhir.dataTypes.String>(org.eclipse.mdht.hl7.fhir.dataTypes.String.class, this, ResourcesPackage.IMPLEMENTATION_GUIDE_MANIFEST__IMAGE);
		}
		return images;
	}
	 ...
	 */
	@Override
	public EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> getOthers() {
		if (others == null) {
			others = new EObjectContainmentEList<org.eclipse.mdht.hl7.fhir.dataTypes.String>(org.eclipse.mdht.hl7.fhir.dataTypes.String.class, this, ResourcesPackage.IMPLEMENTATION_GUIDE_MANIFEST__OTHER);
		}
		return others;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.IMPLEMENTATION_GUIDE_MANIFEST__IMAGE:
				getImages().clear();
				getImages().addAll((Collection<? extends org.eclipse.mdht.hl7.fhir.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.IMPLEMENTATION_GUIDE_MANIFEST__OTHER:
				getOthers().clear();
				getOthers().addAll((Collection<? extends org.eclipse.mdht.hl7.fhir.dataTypes.String>)newValue);
				return;
		}
