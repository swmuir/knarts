...
import org.eclipse.mdht.hl7.fhir.resources.MedicinalProductAuthorization;
import org.eclipse.mdht.hl7.fhir.resources.MedicinalProductAuthorizationJurisdictionalAuthorization;
import org.eclipse.mdht.hl7.fhir.resources.MedicinalProductAuthorizationProcedure;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getCountries <em>Country</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getJurisdictions <em>Jurisdiction</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getStatusDate <em>Status Date</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getRestoreDate <em>Restore Date</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getValidityPeriod <em>Validity Period</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getDataExclusivityPeriod <em>Data Exclusivity Period</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getDateOfFirstAuthorization <em>Date Of First Authorization</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getInternationalBirthDate <em>International Birth Date</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getLegalBasis <em>Legal Basis</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getJurisdictionalAuthorizations <em>Jurisdictional Authorization</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getHolder <em>Holder</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getRegulator <em>Regulator</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductAuthorizationImpl#getProcedure <em>Procedure</em>}</li>
 * </ul>
 *
 * @generated
 */
