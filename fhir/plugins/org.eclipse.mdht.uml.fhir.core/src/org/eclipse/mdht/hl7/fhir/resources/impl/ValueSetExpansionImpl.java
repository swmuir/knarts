...
import org.eclipse.mdht.hl7.fhir.resources.ValueSetExpansionContains;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ValueSetExpansionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ValueSetExpansionImpl#getTimestamp <em>Timestamp</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ValueSetExpansionImpl#getTotal <em>Total</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ValueSetExpansionImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ValueSetExpansionImpl#getParameters <em>Parameter</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ValueSetExpansionImpl#getContains <em>Contains</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueSetExpansionImpl extends BackboneElementImpl implements ValueSetExpansion {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Integer total;
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Integer offset;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Integer getTotal() {
		return total;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTotal(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newTotal, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Integer oldTotal = total;
		total = newTotal;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setTotal(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newTotal) {
		if (newTotal != total) {
			NotificationChain msgs = null;
			if (total != null)
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Integer getOffset() {
		return offset;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOffset(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newOffset, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Integer oldOffset = offset;
		offset = newOffset;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setOffset(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newOffset) {
		if (newOffset != offset) {
			NotificationChain msgs = null;
			if (offset != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.VALUE_SET_EXPANSION__TIMESTAMP:
				...
				return;
			case ResourcesPackage.VALUE_SET_EXPANSION__TOTAL:
				setTotal((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)newValue);
				return;
			case ResourcesPackage.VALUE_SET_EXPANSION__OFFSET:
				setOffset((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)newValue);
				return;
			case ResourcesPackage.VALUE_SET_EXPANSION__PARAMETER:
				getParameters().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.VALUE_SET_EXPANSION__TIMESTAMP:
				...
				return;
			case ResourcesPackage.VALUE_SET_EXPANSION__TOTAL:
				setTotal((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)null);
				return;
			case ResourcesPackage.VALUE_SET_EXPANSION__OFFSET:
				setOffset((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)null);
				return;
			case ResourcesPackage.VALUE_SET_EXPANSION__PARAMETER:
				getParameters().clear();
				return;
