...
import org.eclipse.mdht.hl7.fhir.resources.Task;
import org.eclipse.mdht.hl7.fhir.resources.TaskOutput;
import org.eclipse.mdht.hl7.fhir.resources.TaskParameter;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getInstantiatesCanonical <em>Instantiates Canonical</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getInstantiatesUri <em>Instantiates Uri</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getBasedOns <em>Based On</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getGroupIdentifier <em>Group Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getPartOfs <em>Part Of</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getStatusReason <em>Status Reason</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getBusinessStatus <em>Business Status</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getIntent <em>Intent</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getFocus <em>Focus</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getFor <em>For</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getExecutionPeriod <em>Execution Period</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getAuthoredOn <em>Authored On</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getLastModified <em>Last Modified</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getRequester <em>Requester</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getPerformerTypes <em>Performer Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getReasonCode <em>Reason Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getReasonReference <em>Reason Reference</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getInsurances <em>Insurance</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getNotes <em>Note</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getRelevantHistories <em>Relevant History</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getRestriction <em>Restriction</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getInputs <em>Input</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.TaskImpl#getOutputs <em>Output</em>}</li>
 * </ul>
 *
 * @generated
 */
