 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.SubstancePolymerRepeatImpl#getNumberOfUnits <em>Number Of Units</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.SubstancePolymerRepeatImpl#getAverageMolecularFormula <em>Average Molecular Formula</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.SubstancePolymerRepeatImpl#getRepeatUnitAmountType <em>Repeat Unit Amount Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.SubstancePolymerRepeatImpl#getRepeatUnits <em>Repeat Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstancePolymerRepeatImpl extends BackboneElementImpl implements SubstancePolymerRepeat {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Integer numberOfUnits;
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.String averageMolecularFormula;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Integer getNumberOfUnits() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNumberOfUnits(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newNumberOfUnits, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Integer oldNumberOfUnits = numberOfUnits;
	 ...
	 */
	@Override
	public void setNumberOfUnits(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newNumberOfUnits) {
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.String getAverageMolecularFormula() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAverageMolecularFormula(org.eclipse.mdht.hl7.fhir.dataTypes.String newAverageMolecularFormula, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.String oldAverageMolecularFormula = averageMolecularFormula;
	 ...
	 */
	@Override
	public void setAverageMolecularFormula(org.eclipse.mdht.hl7.fhir.dataTypes.String newAverageMolecularFormula) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.SUBSTANCE_POLYMER_REPEAT__NUMBER_OF_UNITS:
				setNumberOfUnits((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)newValue);
				return;
			case ResourcesPackage.SUBSTANCE_POLYMER_REPEAT__AVERAGE_MOLECULAR_FORMULA:
				setAverageMolecularFormula((org.eclipse.mdht.hl7.fhir.dataTypes.String)newValue);
				return;
			case ResourcesPackage.SUBSTANCE_POLYMER_REPEAT__REPEAT_UNIT_AMOUNT_TYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.SUBSTANCE_POLYMER_REPEAT__NUMBER_OF_UNITS:
				setNumberOfUnits((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)null);
				return;
			case ResourcesPackage.SUBSTANCE_POLYMER_REPEAT__AVERAGE_MOLECULAR_FORMULA:
				setAverageMolecularFormula((org.eclipse.mdht.hl7.fhir.dataTypes.String)null);
				return;
			case ResourcesPackage.SUBSTANCE_POLYMER_REPEAT__REPEAT_UNIT_AMOUNT_TYPE:
