 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductNameNamePartImpl#getPart <em>Part</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.MedicinalProductNameNamePartImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicinalProductNameNamePartImpl extends BackboneElementImpl implements MedicinalProductNameNamePart {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.String part;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.String getPart() {
		return part;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPart(org.eclipse.mdht.hl7.fhir.dataTypes.String newPart, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.String oldPart = part;
		part = newPart;
	 ...
	 */
	@Override
	public void setPart(org.eclipse.mdht.hl7.fhir.dataTypes.String newPart) {
		if (newPart != part) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.MEDICINAL_PRODUCT_NAME_NAME_PART__PART:
				setPart((org.eclipse.mdht.hl7.fhir.dataTypes.String)newValue);
				return;
			case ResourcesPackage.MEDICINAL_PRODUCT_NAME_NAME_PART__TYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.MEDICINAL_PRODUCT_NAME_NAME_PART__PART:
				setPart((org.eclipse.mdht.hl7.fhir.dataTypes.String)null);
				return;
			case ResourcesPackage.MEDICINAL_PRODUCT_NAME_NAME_PART__TYPE:
				setType((Coding)null);
				return;
