 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getDepth <em>Depth</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getNominalVolume <em>Nominal Volume</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getExternalDiameter <em>External Diameter</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getShape <em>Shape</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getColors <em>Color</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getImprints <em>Imprint</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getImages <em>Image</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.ProdCharacteristicImpl#getScoring <em>Scoring</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProdCharacteristicImpl extends BackboneElementImpl implements ProdCharacteristic {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.String shape;
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> colors;
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> imprints;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.String getShape() {
		return shape;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetShape(org.eclipse.mdht.hl7.fhir.dataTypes.String newShape, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.String oldShape = shape;
		shape = newShape;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setShape(org.eclipse.mdht.hl7.fhir.dataTypes.String newShape) {
		if (newShape != shape) {
			NotificationChain msgs = null;
			if (shape != null)
	 ...
	 */
	@Override
	public EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> getColors() {
		if (colors == null) {
			colors = new EObjectContainmentEList<org.eclipse.mdht.hl7.fhir.dataTypes.String>(org.eclipse.mdht.hl7.fhir.dataTypes.String.class, this, DataTypesPackage.PROD_CHARACTERISTIC__COLOR);
		}
		return colors;
	}
	 ...
	 */
	@Override
	public EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> getImprints() {
		if (imprints == null) {
			imprints = new EObjectContainmentEList<org.eclipse.mdht.hl7.fhir.dataTypes.String>(org.eclipse.mdht.hl7.fhir.dataTypes.String.class, this, DataTypesPackage.PROD_CHARACTERISTIC__IMPRINT);
		}
		return imprints;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DataTypesPackage.PROD_CHARACTERISTIC__EXTERNAL_DIAMETER:
				...
				return;
			case DataTypesPackage.PROD_CHARACTERISTIC__SHAPE:
				setShape((org.eclipse.mdht.hl7.fhir.dataTypes.String)newValue);
				return;
			case DataTypesPackage.PROD_CHARACTERISTIC__COLOR:
				getColors().clear();
				getColors().addAll((Collection<? extends org.eclipse.mdht.hl7.fhir.dataTypes.String>)newValue);
				return;
			case DataTypesPackage.PROD_CHARACTERISTIC__IMPRINT:
				getImprints().clear();
				getImprints().addAll((Collection<? extends org.eclipse.mdht.hl7.fhir.dataTypes.String>)newValue);
				return;
			case DataTypesPackage.PROD_CHARACTERISTIC__IMAGE:
				getImages().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case DataTypesPackage.PROD_CHARACTERISTIC__EXTERNAL_DIAMETER:
				...
				return;
			case DataTypesPackage.PROD_CHARACTERISTIC__SHAPE:
				setShape((org.eclipse.mdht.hl7.fhir.dataTypes.String)null);
				return;
			case DataTypesPackage.PROD_CHARACTERISTIC__COLOR:
				getColors().clear();
				return;
