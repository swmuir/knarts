 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ClinicalImpressionFindingImpl#getItemCodeableConcept <em>Item Codeable Concept</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ClinicalImpressionFindingImpl#getItemReference <em>Item Reference</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ClinicalImpressionFindingImpl#getBasis <em>Basis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClinicalImpressionFindingImpl extends BackboneElementImpl implements ClinicalImpressionFinding {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.String basis;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.String getBasis() {
		return basis;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBasis(org.eclipse.mdht.hl7.fhir.dataTypes.String newBasis, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.String oldBasis = basis;
		basis = newBasis;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setBasis(org.eclipse.mdht.hl7.fhir.dataTypes.String newBasis) {
		if (newBasis != basis) {
			NotificationChain msgs = null;
			if (basis != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.CLINICAL_IMPRESSION_FINDING__ITEM_REFERENCE:
				...
				return;
			case ResourcesPackage.CLINICAL_IMPRESSION_FINDING__BASIS:
				setBasis((org.eclipse.mdht.hl7.fhir.dataTypes.String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.CLINICAL_IMPRESSION_FINDING__ITEM_REFERENCE:
				...
				return;
			case ResourcesPackage.CLINICAL_IMPRESSION_FINDING__BASIS:
				setBasis((org.eclipse.mdht.hl7.fhir.dataTypes.String)null);
				return;
		}
