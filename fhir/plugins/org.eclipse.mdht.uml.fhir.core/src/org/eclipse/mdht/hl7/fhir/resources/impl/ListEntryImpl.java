 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ListEntryImpl#getFlag <em>Flag</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ListEntryImpl#getDeleted <em>Deleted</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ListEntryImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.ListEntryImpl#getItem <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListEntryImpl extends BackboneElementImpl implements ListEntry {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Boolean deleted;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Boolean getDeleted() {
		return deleted;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDeleted(org.eclipse.mdht.hl7.fhir.dataTypes.Boolean newDeleted, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Boolean oldDeleted = deleted;
		deleted = newDeleted;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setDeleted(org.eclipse.mdht.hl7.fhir.dataTypes.Boolean newDeleted) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourcesPackage.LIST_ENTRY__FLAG:
				...
				return;
			case ResourcesPackage.LIST_ENTRY__DELETED:
				setDeleted((org.eclipse.mdht.hl7.fhir.dataTypes.Boolean)newValue);
				return;
			case ResourcesPackage.LIST_ENTRY__DATE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ResourcesPackage.LIST_ENTRY__FLAG:
				...
				return;
			case ResourcesPackage.LIST_ENTRY__DELETED:
				setDeleted((org.eclipse.mdht.hl7.fhir.dataTypes.Boolean)null);
				return;
			case ResourcesPackage.LIST_ENTRY__DATE:
