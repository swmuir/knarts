...
import org.eclipse.mdht.hl7.fhir.resources.BiologicallyDerivedProduct;
import org.eclipse.mdht.hl7.fhir.resources.BiologicallyDerivedProductCollection;
...
import org.eclipse.mdht.hl7.fhir.resources.BiologicallyDerivedProductStorage;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getIdentifiers <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getProductCategory <em>Product Category</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getProductCode <em>Product Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getRequests <em>Request</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getParents <em>Parent</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getProcessings <em>Processing</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getManipulation <em>Manipulation</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.BiologicallyDerivedProductImpl#getStorages <em>Storage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BiologicallyDerivedProductImpl extends DomainResourceImpl implements BiologicallyDerivedProduct {
	 ...
	 * @ordered
	 */
	protected org.eclipse.mdht.hl7.fhir.dataTypes.Integer quantity;
	 ...
	 */
	@Override
	public org.eclipse.mdht.hl7.fhir.dataTypes.Integer getQuantity() {
		return quantity;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetQuantity(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newQuantity, NotificationChain msgs) {
		org.eclipse.mdht.hl7.fhir.dataTypes.Integer oldQuantity = quantity;
	 ...
	 */
	@Override
	public void setQuantity(org.eclipse.mdht.hl7.fhir.dataTypes.Integer newQuantity) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.BIOLOGICALLY_DERIVED_PRODUCT__REQUEST:
				...
				return;
			case ResourcesPackage.BIOLOGICALLY_DERIVED_PRODUCT__QUANTITY:
				setQuantity((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)newValue);
				return;
			case ResourcesPackage.BIOLOGICALLY_DERIVED_PRODUCT__PARENT:
				getParents().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourcesPackage.BIOLOGICALLY_DERIVED_PRODUCT__REQUEST:
				...
				return;
			case ResourcesPackage.BIOLOGICALLY_DERIVED_PRODUCT__QUANTITY:
				setQuantity((org.eclipse.mdht.hl7.fhir.dataTypes.Integer)null);
				return;
			case ResourcesPackage.BIOLOGICALLY_DERIVED_PRODUCT__PARENT:
				getParents().clear();
				return;
