 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.DataRequirementImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.DataRequirementImpl#getProfiles <em>Profile</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.DataRequirementImpl#getSubjectx <em>Subjectx</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.DataRequirementImpl#getMustSupports <em>Must Support</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.DataRequirementImpl#getCodeFilters <em>Code Filter</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.DataRequirementImpl#getDateFilters <em>Date Filter</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.DataRequirementImpl#getLimit <em>Limit</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.dataTypes.impl.DataRequirementImpl#getSorts <em>Sort</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataRequirementImpl extends DataTypeImpl implements DataRequirement {
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> mustSupports;
	 ...
	 */
	@Override
	public EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> getMustSupports() {
		if (mustSupports == null) {
			mustSupports = new EObjectContainmentEList<org.eclipse.mdht.hl7.fhir.dataTypes.String>(org.eclipse.mdht.hl7.fhir.dataTypes.String.class, this, DataTypesPackage.DATA_REQUIREMENT__MUST_SUPPORT);
		}
		return mustSupports;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DataTypesPackage.DATA_REQUIREMENT__MUST_SUPPORT:
				...
				getMustSupports().addAll((Collection<? extends org.eclipse.mdht.hl7.fhir.dataTypes.String>)newValue);
				return;
			case DataTypesPackage.DATA_REQUIREMENT__CODE_FILTER:
