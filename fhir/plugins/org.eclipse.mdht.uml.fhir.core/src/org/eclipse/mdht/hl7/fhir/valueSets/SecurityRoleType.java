...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Security Role Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.mdht.hl7.fhir.valueSets.ValueSetsPackage#getSecurityRoleType()
 * @model
 * @generated
 */
public enum SecurityRoleType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Security Role Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final SecurityRoleType[] VALUES_ARRAY =
		new SecurityRoleType[] {
			AMENDER,
			COAUTH,
			CONT,
			EVTWIT,
	...
	/**
	 * A public read-only list of all the '<em><b>Security Role Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<SecurityRoleType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Security Role Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SecurityRoleType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SecurityRoleType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Security Role Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static SecurityRoleType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SecurityRoleType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Security Role Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SecurityRoleType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private SecurityRoleType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
