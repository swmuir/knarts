...
import org.eclipse.mdht.hl7.fhir.resources.SubstanceProtein;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.SubstanceProteinImpl#getSequenceType <em>Sequence Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.SubstanceProteinImpl#getNumberOfSubunits <em>Number Of Subunits</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.SubstanceProteinImpl#getDisulfideLinkages <em>Disulfide Linkage</em>}</li>
 *   <li>{@link org.eclipse.mdht.hl7.fhir.resources.impl.SubstanceProteinImpl#getSubunits <em>Subunit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstanceProteinImpl extends DomainResourceImpl implements SubstanceProtein {
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> disulfideLinkages;
	 ...
	 */
	@Override
	public EList<org.eclipse.mdht.hl7.fhir.dataTypes.String> getDisulfideLinkages() {
		if (disulfideLinkages == null) {
			disulfideLinkages = new EObjectContainmentEList<org.eclipse.mdht.hl7.fhir.dataTypes.String>(org.eclipse.mdht.hl7.fhir.dataTypes.String.class, this, ResourcesPackage.SUBSTANCE_PROTEIN__DISULFIDE_LINKAGE);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourcesPackage.SUBSTANCE_PROTEIN__DISULFIDE_LINKAGE:
				...
				getDisulfideLinkages().addAll((Collection<? extends org.eclipse.mdht.hl7.fhir.dataTypes.String>)newValue);
				return;
			case ResourcesPackage.SUBSTANCE_PROTEIN__SUBUNIT:
				getSubunits().clear();
