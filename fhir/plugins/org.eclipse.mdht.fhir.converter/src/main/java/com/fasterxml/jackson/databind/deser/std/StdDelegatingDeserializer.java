/*This is a copy of the original file, except the last method is added so deserializers can be cached which otherwise would result in a not-acceptable performance problems*/
...
//        Object delegateValue = _delegateDeserializer.deserializeWithType(p, ctxt, typeDeserializer);
    ...
    public boolean isCachable() {
    	return _delegateDeserializer.isCachable();
    }
}
