...
import org.eclipse.mdht.uml.fhir.provider.FHIREditPlugin;

import org.eclipse.mdht.uml.fhir.types.Contact;
import org.eclipse.mdht.uml.fhir.types.FHIRTypesPackage;

/**
 * This is the item provider adapter for a {@link org.eclipse.mdht.uml.fhir.types.Contact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContactItemProvider 
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_Contact_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_Contact_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}	
