...
public class CDATemplateImpl extends ClassValidationImpl implements CDATemplate {
		...
		if (eNotificationRequired()) {
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, CDAPackage.CDA_TEMPLATE__ASSIGNING_AUTHORITY_NAME,
	...
	public void setTemplateVersion(String newTemplateVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, CDAPackage.CDA_TEMPLATE__TEMPLATE_VERSION, oldTemplateVersion,
					templateVersion));
		}
	}
