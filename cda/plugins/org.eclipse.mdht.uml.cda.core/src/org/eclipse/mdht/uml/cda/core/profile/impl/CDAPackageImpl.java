...
public class CDAPackageImpl extends EPackageImpl implements CDAPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(
			getAssociationValidation_Base_Association(), theUMLPackage.getAssociation(), null, "base_Association", null,
			1, 1, AssociationValidation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
		...
		initEClass(
			...
			IS_GENERATED_INSTANCE_CLASS);
		initEReference(
			getActRelationship_Base_Association(), theUMLPackage.getAssociation(), null, "base_Association", null, 1, 1,
