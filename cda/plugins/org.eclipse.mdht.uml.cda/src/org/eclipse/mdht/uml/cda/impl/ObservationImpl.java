...
public class ObservationImpl extends ClinicalStatementImpl implements Observation {
		...
		if (newDerivationExpr != derivationExpr) {
			...
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, CDAPackage.OBSERVATION__DERIVATION_EXPR, newDerivationExpr,
					newDerivationExpr));
		}
	}
	...
	public void setEffectiveTime(IVL_TS newEffectiveTime) {
		if (newEffectiveTime != effectiveTime) {
			...
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, CDAPackage.OBSERVATION__EFFECTIVE_TIME, newEffectiveTime,
					newEffectiveTime));
		}
	}
	...
	public void setClassCode(ActClassObservation newClassCode) {
		...
		if (eNotificationRequired()) {
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, CDAPackage.OBSERVATION__CLASS_CODE, oldClassCode, classCode,
					!oldClassCodeESet));
		}
	}
	...
	public void setMoodCode(x_ActMoodDocumentObservation newMoodCode) {
		...
		if (eNotificationRequired()) {
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, CDAPackage.OBSERVATION__MOOD_CODE, oldMoodCode, moodCode,
					!oldMoodCodeESet));
		}
	}
	...
	public void unsetNegationInd() {
		...
		if (eNotificationRequired()) {
			eNotify(
				new ENotificationImpl(
					this, Notification.UNSET, CDAPackage.OBSERVATION__NEGATION_IND, oldNegationInd,
