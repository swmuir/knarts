...
public class RecordTargetImpl extends ParticipationImpl implements RecordTarget {
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired()) {
			eNotify(
				new ENotificationImpl(
					this, Notification.UNSET, CDAPackage.RECORD_TARGET__NULL_FLAVOR, oldNullFlavor,
	...
	public void setTypeCode(ParticipationType newTypeCode) {
		...
		if (eNotificationRequired()) {
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, CDAPackage.RECORD_TARGET__TYPE_CODE, oldTypeCode, typeCode,
					!oldTypeCodeESet));
		}
	}
