 ...
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#addEncounter(org.eclipse.mdht.uml.cda.Encounter) <em>Add Encounter</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#addObservation(org.eclipse.mdht.uml.cda.Observation) <em>Add Observation</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#addObservationMedia(org.eclipse.mdht.uml.cda.ObservationMedia) <em>Add Observation Media</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#addProcedure(org.eclipse.mdht.uml.cda.Procedure) <em>Add Procedure</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#addRegionOfInterest(org.eclipse.mdht.uml.cda.RegionOfInterest) <em>Add Region Of Interest</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#addSubstanceAdministration(org.eclipse.mdht.uml.cda.SubstanceAdministration) <em>Add Substance Administration</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#addSupply(org.eclipse.mdht.uml.cda.Supply) <em>Add Supply</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#getActs() <em>Get Acts</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#getEncounters() <em>Get Encounters</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#getObservations() <em>Get Observations</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#getObservationMedia() <em>Get Observation Media</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#getOrganizers() <em>Get Organizers</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#getProcedures() <em>Get Procedures</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#getRegionsOfInterest() <em>Get Regions Of Interest</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#getSubstanceAdministrations() <em>Get Substance Administrations</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.Organizer#getSupplies() <em>Get Supplies</em>}</li>
