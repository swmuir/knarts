...
public class ExternalActImpl extends ActImpl implements ExternalAct {
	...
	public void setClassCode(ActClassRoot newClassCode) {
		...
		if (eNotificationRequired()) {
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, CDAPackage.EXTERNAL_ACT__CLASS_CODE, oldClassCode, classCode,
					!oldClassCodeESet));
		}
	}
	...
	public void setMoodCode(ActMood newMoodCode) {
		...
		if (eNotificationRequired()) {
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, CDAPackage.EXTERNAL_ACT__MOOD_CODE, oldMoodCode, moodCode,
					!oldMoodCodeESet));
		}
	}
