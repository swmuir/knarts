...
import org.eclipse.mdht.api.schematron.InstanceGenerator;
...
public class Generate {
	...
	public static void main(String[] args) {
		...
		String cdaProfileLocation = org.eclipse.mdht.uml.cda.resources.util.CDAResource.CDA_PROFILE_URI + "#_cxOJEIEVEd6H8o-hO3-B4Q";
		...
		UMLPlugin.getEPackageNsURIToProfileLocationMap().put(org.eclipse.mdht.uml.cda.core.profile.CDAPackage.eNS_URI, URI.createURI(cdaProfileLocation));
